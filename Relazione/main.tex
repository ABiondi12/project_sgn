...
Si pu\`o osservare infatti che i segnali filtrati a media mobile siano costantemente in ritardo, ma molto pi\`u interessante \`e l'offset quasi costante che si ha in alcuni intervalli temporali. 
...
Possiamo subito notare nelle fig.~ che, per entrambe le tag, l'errore si distribuisce molto di più nei quadranti 2 e 3 (asse x negativo).
...
Anche qua si evidenzia un errore sistematico nell'angolo, sicuramente legato anche al fatto che, come si evidenzia in fig.\ref{fig: uwbvicon_heading}, il suo valore \`e inizializzato con con un offset significativo. 
