...
static void initialize_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void initialize_params_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void enable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void disable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void c140_update_debugger_state_c140_ICARO3_Onda_bipe_controllonostro
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void set_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance,
   const mxArray *c140_st);
static void finalize_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void sf_gateway_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void initSimStructsc140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
...
static uint8_T c140_e_emlrt_marshallIn
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance,
   const mxArray
   *c140_b_is_active_c140_ICARO3_Onda_bipe_controllonostro_mix_2201, const
  ...
  (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance)
{
  ...
  chartInstance->c140_is_active_c140_ICARO3_Onda_bipe_controllonostro_mix_2201 =
    0U;
}
   ...
   const mxArray *c140_st)
{
  ...
  chartInstance->c140_is_active_c140_ICARO3_Onda_bipe_controllonostro_mix_2201 =
    ...
    "is_active_c140_ICARO3_Onda_bipe_controllonostro_mix_2201");
   ...
   char_T *c140_identifier)
{
  ...
  c140_y = c140_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c140_b_is_active_c140_ICARO3_Onda_bipe_controllonostro_mix_2201),
    &c140_thisId);
  sf_mex_destroy
    (&c140_b_is_active_c140_ICARO3_Onda_bipe_controllonostro_mix_2201);
  return c140_y;
...
void sf_c140_ICARO3_Onda_bipe_controllonostro_mix_2201_get_check_sum(mxArray
  *plhs[])
{
...
mxArray *sf_c140_ICARO3_Onda_bipe_controllonostro_mix_2201_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c140_ICARO3_Onda_bipe_controllonostro_mix_2201\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c140_ICARO3_Onda_bipe_controllonostro_mix_2201_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
  initialize_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(void
  *chartInstanceVar)
{
  enable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  disable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  sf_gateway_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c140_ICARO3_Onda_bipe_controllonostro_mix_2201();/* state var info */
...
extern void
  sf_internal_set_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
}

static void
  sf_opaque_set_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(S, st);
}

static void sf_opaque_terminate_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
      ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc140_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c140_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(SimStruct *S)
{
  SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance =
    (SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *)utMalloc
    (sizeof(SFc140_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c140_ICARO3_Onda_bipe_controllonostro_mix_2201;
...
void c140_ICARO3_Onda_bipe_controllonostro_mix_2201_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c140_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c140_ICARO3_Onda_bipe_controllonostro_mix_2201_method_dispatcher.\n"
