...
static void initialize_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void initialize_params_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void enable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void disable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void c139_update_debugger_state_c139_ICARO3_Onda_bipe_controllonostro
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void set_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance,
   const mxArray *c139_st);
static void finalize_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void sf_gateway_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void initSimStructsc139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
...
static uint8_T c139_e_emlrt_marshallIn
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance,
   const mxArray
   *c139_b_is_active_c139_ICARO3_Onda_bipe_controllonostro_mix_2201, const
  ...
  (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance)
{
  ...
  chartInstance->c139_is_active_c139_ICARO3_Onda_bipe_controllonostro_mix_2201 =
    0U;
}
   ...
   const mxArray *c139_st)
{
  ...
  chartInstance->c139_is_active_c139_ICARO3_Onda_bipe_controllonostro_mix_2201 =
    ...
    "is_active_c139_ICARO3_Onda_bipe_controllonostro_mix_2201");
   ...
   char_T *c139_identifier)
{
  ...
  c139_y = c139_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c139_b_is_active_c139_ICARO3_Onda_bipe_controllonostro_mix_2201),
    &c139_thisId);
  sf_mex_destroy
    (&c139_b_is_active_c139_ICARO3_Onda_bipe_controllonostro_mix_2201);
  return c139_y;
...
void sf_c139_ICARO3_Onda_bipe_controllonostro_mix_2201_get_check_sum(mxArray
  *plhs[])
{
...
mxArray *sf_c139_ICARO3_Onda_bipe_controllonostro_mix_2201_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c139_ICARO3_Onda_bipe_controllonostro_mix_2201\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c139_ICARO3_Onda_bipe_controllonostro_mix_2201_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
  initialize_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(void
  *chartInstanceVar)
{
  enable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  disable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  sf_gateway_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c139_ICARO3_Onda_bipe_controllonostro_mix_2201();/* state var info */
...
extern void
  sf_internal_set_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
}

static void
  sf_opaque_set_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(S, st);
}

static void sf_opaque_terminate_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
      ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc139_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c139_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(SimStruct *S)
{
  SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance =
    (SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *)utMalloc
    (sizeof(SFc139_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c139_ICARO3_Onda_bipe_controllonostro_mix_2201;
...
void c139_ICARO3_Onda_bipe_controllonostro_mix_2201_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c139_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c139_ICARO3_Onda_bipe_controllonostro_mix_2201_method_dispatcher.\n"
