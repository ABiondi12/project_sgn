...
static void initialize_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void initialize_params_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void enable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void disable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void c134_update_debugger_state_c134_ICARO3_Onda_bipe_controllonostro
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void set_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance,
   const mxArray *c134_st);
static void finalize_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void sf_gateway_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
static void initSimStructsc134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance);
...
static uint8_T c134_e_emlrt_marshallIn
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance,
   const mxArray
   *c134_b_is_active_c134_ICARO3_Onda_bipe_controllonostro_mix_2201, const
  ...
  (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance)
{
  ...
  chartInstance->c134_is_active_c134_ICARO3_Onda_bipe_controllonostro_mix_2201 =
    0U;
}
   ...
   const mxArray *c134_st)
{
  ...
  chartInstance->c134_is_active_c134_ICARO3_Onda_bipe_controllonostro_mix_2201 =
    ...
    "is_active_c134_ICARO3_Onda_bipe_controllonostro_mix_2201");
   ...
   char_T *c134_identifier)
{
  ...
  c134_y = c134_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c134_b_is_active_c134_ICARO3_Onda_bipe_controllonostro_mix_2201),
    &c134_thisId);
  sf_mex_destroy
    (&c134_b_is_active_c134_ICARO3_Onda_bipe_controllonostro_mix_2201);
  return c134_y;
...
void sf_c134_ICARO3_Onda_bipe_controllonostro_mix_2201_get_check_sum(mxArray
  *plhs[])
{
...
mxArray *sf_c134_ICARO3_Onda_bipe_controllonostro_mix_2201_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c134_ICARO3_Onda_bipe_controllonostro_mix_2201\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c134_ICARO3_Onda_bipe_controllonostro_mix_2201_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
  initialize_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(void
  *chartInstanceVar)
{
  enable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  disable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  sf_gateway_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c134_ICARO3_Onda_bipe_controllonostro_mix_2201();/* state var info */
...
extern void
  sf_internal_set_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
}

static void
  sf_opaque_set_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(S, st);
}

static void sf_opaque_terminate_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
      ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc134_ICARO3_Onda_bipe_controllonostro_mix_2201
    ((SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c134_ICARO3_Onda_bipe_controllonostro_mix_2201
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(SimStruct *S)
{
  SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance =
    (SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct *)utMalloc
    (sizeof(SFc134_ICARO3_Onda_bipe_controllonostro_mix_2201InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c134_ICARO3_Onda_bipe_controllonostro_mix_2201;
...
void c134_ICARO3_Onda_bipe_controllonostro_mix_2201_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c134_ICARO3_Onda_bipe_controllonostro_mix_2201(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c134_ICARO3_Onda_bipe_controllonostro_mix_2201_method_dispatcher.\n"
