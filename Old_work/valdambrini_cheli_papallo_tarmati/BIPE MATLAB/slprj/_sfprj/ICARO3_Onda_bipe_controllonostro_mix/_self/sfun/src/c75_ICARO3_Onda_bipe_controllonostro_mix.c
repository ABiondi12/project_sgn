...
static void initialize_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initialize_params_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void enable_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void disable_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void c75_update_debugger_state_c75_ICARO3_Onda_bipe_controllonostro_m
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void set_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c75_st);
static void finalize_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void sf_gateway_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initSimStructsc75_ICARO3_Onda_bipe_controllonostro_mix
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
...
static uint8_T c75_d_emlrt_marshallIn
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c75_b_is_active_c75_ICARO3_Onda_bipe_controllonostro_mix,
  ...
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  chartInstance->c75_is_active_c75_ICARO3_Onda_bipe_controllonostro_mix = 0U;
}
  ...
  (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  c75_b_hoistedGlobal =
    chartInstance->c75_is_active_c75_ICARO3_Onda_bipe_controllonostro_mix;
   ...
   const mxArray *c75_st)
{
  ...
  *c75_go = c75_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c75_u,
  ...
  chartInstance->c75_is_active_c75_ICARO3_Onda_bipe_controllonostro_mix =
    ...
    "is_active_c75_ICARO3_Onda_bipe_controllonostro_mix");
  sf_mex_destroy(&c75_u);
  c75_update_debugger_state_c75_ICARO3_Onda_bipe_controllonostro_m(chartInstance);
  ...
  *c75_inData)
{
  ...
  const mxArray *c75_y = NULL;
  SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  chartInstance = (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c75_identifier)
{
  ...
  c75_y = c75_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c75_b_is_active_c75_ICARO3_Onda_bipe_controllonostro_mix), &c75_thisId);
  sf_mex_destroy(&c75_b_is_active_c75_ICARO3_Onda_bipe_controllonostro_mix);
  return c75_y;
}
...
void sf_c75_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1782596649U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1355133082U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1404653047U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3425438789U);
}

mxArray *sf_c75_ICARO3_Onda_bipe_controllonostro_mix_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("bqhasyhou3W7fyA4ykFrgG");
...
mxArray *sf_c75_ICARO3_Onda_bipe_controllonostro_mix_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c75_ICARO3_Onda_bipe_controllonostro_mix_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c75_ICARO3_Onda_bipe_controllonostro_mix(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"go\",},{M[8],M[0],T\"is_active_c75_ICARO3_Onda_bipe_controllonostro_mix\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c75_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(&mxChecksum);
...
{
  return "KqEiGESaFtGsBRThAvGWGG";
}

static void sf_opaque_initialize_c75_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
  initialize_c75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c75_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  enable_c75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c75_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  disable_c75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c75_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  sf_gateway_c75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c75_ICARO3_Onda_bipe_controllonostro_mix();/* state var info */
...
extern void sf_internal_set_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix(SimStruct* S)
{
  return sf_internal_get_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix(S);
}

static void sf_opaque_set_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix(S, st);
}

static void sf_opaque_terminate_c75_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c75_ICARO3_Onda_bipe_controllonostro_mix
      ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc75_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c75_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c75_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(3990279577U));
  ssSetChecksum1(S,(313459681U));
  ssSetChecksum2(S,(2268614277U));
  ssSetChecksum3(S,(864485204U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c75_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c75_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    utMalloc(sizeof(SFc75_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c75_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c75_ICARO3_Onda_bipe_controllonostro_mix;
...
void c75_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c75_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c75_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c75_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c75_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher.\n"
