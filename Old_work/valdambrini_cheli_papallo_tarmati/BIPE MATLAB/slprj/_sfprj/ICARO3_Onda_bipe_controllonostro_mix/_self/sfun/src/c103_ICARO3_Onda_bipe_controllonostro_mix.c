...
static void initialize_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initialize_params_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void enable_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void disable_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void c103_update_debugger_state_c103_ICARO3_Onda_bipe_controllonostro
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void set_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c103_st);
static void finalize_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void sf_gateway_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void c103_chartstep_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initSimStructsc103_ICARO3_Onda_bipe_controllonostro_mix
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
...
static uint8_T c103_g_emlrt_marshallIn
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c103_b_is_active_c103_ICARO3_Onda_bipe_controllonostro_mix,
  ...
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  chartInstance->c103_is_active_c103_ICARO3_Onda_bipe_controllonostro_mix = 0U;
}
  ...
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  c103_hoistedGlobal =
    chartInstance->c103_is_active_c103_ICARO3_Onda_bipe_controllonostro_mix;
   ...
   const mxArray *c103_st)
{
  ...
  chartInstance->c103_is_active_c103_ICARO3_Onda_bipe_controllonostro_mix =
    ...
    "is_active_c103_ICARO3_Onda_bipe_controllonostro_mix");
  ...
  (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  chartInstance->c103_sfEvent = CALL_EVENT;
  c103_chartstep_c103_ICARO3_Onda_bipe_controllonostro_mix(chartInstance);
  ...
  *c103_inData)
{
  ...
  const mxArray *c103_y = NULL;
  SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  chartInstance = (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c103_identifier)
{
  ...
  c103_y = c103_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c103_b_is_active_c103_ICARO3_Onda_bipe_controllonostro_mix), &c103_thisId);
  sf_mex_destroy(&c103_b_is_active_c103_ICARO3_Onda_bipe_controllonostro_mix);
  return c103_y;
}
...
void sf_c103_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c103_ICARO3_Onda_bipe_controllonostro_mix_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c103_ICARO3_Onda_bipe_controllonostro_mix_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c103_ICARO3_Onda_bipe_controllonostro_mix_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c103_ICARO3_Onda_bipe_controllonostro_mix(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[1],M[13],T\"w\",},{M[8],M[0],T\"is_active_c103_ICARO3_Onda_bipe_controllonostro_mix\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c103_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c103_ICARO3_Onda_bipe_controllonostro_mix(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
  initialize_c103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c103_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  enable_c103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c103_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  disable_c103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c103_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  sf_gateway_c103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c103_ICARO3_Onda_bipe_controllonostro_mix();/* state var info */
...
extern void sf_internal_set_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix(SimStruct* S)
{
  return sf_internal_get_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix(S);
}

static void sf_opaque_set_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix(S, st);
}

static void sf_opaque_terminate_c103_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c103_ICARO3_Onda_bipe_controllonostro_mix
      ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc103_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c103_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c103_ICARO3_Onda_bipe_controllonostro_mix(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c103_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c103_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    utMalloc(sizeof(SFc103_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c103_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c103_ICARO3_Onda_bipe_controllonostro_mix;
...
void c103_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c103_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c103_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c103_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c103_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher.\n"
