...
static void initialize_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initialize_params_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void enable_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void disable_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void c141_update_debugger_state_c141_ICARO3_Onda_bipe_controllonostro
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void set_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c141_st);
static void finalize_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void sf_gateway_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initSimStructsc141_ICARO3_Onda_bipe_controllonostro_mix
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
...
static uint8_T c141_e_emlrt_marshallIn
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c141_b_is_active_c141_ICARO3_Onda_bipe_controllonostro_mix,
  ...
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  chartInstance->c141_is_active_c141_ICARO3_Onda_bipe_controllonostro_mix = 0U;
}
  ...
  (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  c141_hoistedGlobal =
    chartInstance->c141_is_active_c141_ICARO3_Onda_bipe_controllonostro_mix;
   ...
   const mxArray *c141_st)
{
  ...
  chartInstance->c141_is_active_c141_ICARO3_Onda_bipe_controllonostro_mix =
    ...
    "is_active_c141_ICARO3_Onda_bipe_controllonostro_mix");
  ...
  *c141_inData)
{
  ...
  const mxArray *c141_y = NULL;
  SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  chartInstance = (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c141_identifier)
{
  ...
  c141_y = c141_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c141_b_is_active_c141_ICARO3_Onda_bipe_controllonostro_mix), &c141_thisId);
  sf_mex_destroy(&c141_b_is_active_c141_ICARO3_Onda_bipe_controllonostro_mix);
  return c141_y;
}
...
void sf_c141_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c141_ICARO3_Onda_bipe_controllonostro_mix_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c141_ICARO3_Onda_bipe_controllonostro_mix_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c141_ICARO3_Onda_bipe_controllonostro_mix_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c141_ICARO3_Onda_bipe_controllonostro_mix(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c141_ICARO3_Onda_bipe_controllonostro_mix\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c141_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c141_ICARO3_Onda_bipe_controllonostro_mix(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
  initialize_c141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c141_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  enable_c141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c141_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  disable_c141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c141_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  sf_gateway_c141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c141_ICARO3_Onda_bipe_controllonostro_mix();/* state var info */
...
extern void sf_internal_set_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix(SimStruct* S)
{
  return sf_internal_get_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix(S);
}

static void sf_opaque_set_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix(S, st);
}

static void sf_opaque_terminate_c141_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c141_ICARO3_Onda_bipe_controllonostro_mix
      ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc141_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c141_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c141_ICARO3_Onda_bipe_controllonostro_mix(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c141_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c141_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    utMalloc(sizeof(SFc141_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c141_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c141_ICARO3_Onda_bipe_controllonostro_mix;
...
void c141_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c141_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c141_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c141_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c141_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher.\n"
