...
static void initialize_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initialize_params_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void enable_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void disable_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void c129_update_debugger_state_c129_ICARO3_Onda_bipe_controllonostro
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void set_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c129_st);
static void finalize_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void sf_gateway_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
static void initSimStructsc129_ICARO3_Onda_bipe_controllonostro_mix
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance);
...
static const mxArray *c129_sf_marshallOut(void *chartInstanceVoid, void
  *c129_inData);
static uint16_T c129_emlrt_marshallIn
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c129_y, const char_T *c129_identifier);
static uint16_T c129_b_emlrt_marshallIn
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c129_u, const emlrtMsgIdentifier *c129_parentId);
...
static const mxArray *c129_c_sf_marshallOut(void *chartInstanceVoid, void
  *c129_inData);
static real_T c129_c_emlrt_marshallIn
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c129_u, const emlrtMsgIdentifier *c129_parentId);
...
static const mxArray *c129_d_sf_marshallOut(void *chartInstanceVoid, void
  *c129_inData);
static int32_T c129_d_emlrt_marshallIn
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c129_u, const emlrtMsgIdentifier *c129_parentId);
static void c129_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c129_mxArrayInData, const char_T *c129_varName, void *c129_outData);
static uint8_T c129_e_emlrt_marshallIn
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c129_b_is_active_c129_ICARO3_Onda_bipe_controllonostro_mix,
   const char_T *c129_identifier);
static uint8_T c129_f_emlrt_marshallIn
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance,
   const mxArray *c129_u, const emlrtMsgIdentifier *c129_parentId);
  ...
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  chartInstance->c129_is_active_c129_ICARO3_Onda_bipe_controllonostro_mix = 0U;
}
  ...
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  c129_b_hoistedGlobal =
    chartInstance->c129_is_active_c129_ICARO3_Onda_bipe_controllonostro_mix;
   ...
   const mxArray *c129_st)
{
  ...
  *c129_y = c129_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c129_u, 0)), "y");
  chartInstance->c129_is_active_c129_ICARO3_Onda_bipe_controllonostro_mix =
    c129_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c129_u, 1)),
    "is_active_c129_ICARO3_Onda_bipe_controllonostro_mix");
  sf_mex_destroy(&c129_u);
  c129_update_debugger_state_c129_ICARO3_Onda_bipe_controllonostro(chartInstance);
  ...
  (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 29U, chartInstance->c129_sfEvent);
  for (c129_i0 = 0; c129_i0 < 2; c129_i0++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*c129_b_u)[c129_i0], 0U);
  }

  chartInstance->c129_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 29U, chartInstance->c129_sfEvent);
  ...
  *c129_b_y = c129_y;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 29U, chartInstance->c129_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c129_inData)
{
  ...
  const mxArray *c129_y = NULL;
  SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  chartInstance = (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c129_identifier)
{
  ...
  c129_y = c129_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c129_b_is_active_c129_ICARO3_Onda_bipe_controllonostro_mix), &c129_thisId);
  sf_mex_destroy(&c129_b_is_active_c129_ICARO3_Onda_bipe_controllonostro_mix);
  return c129_y;
}
...
void sf_c129_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c129_ICARO3_Onda_bipe_controllonostro_mix_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c129_ICARO3_Onda_bipe_controllonostro_mix_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c129_ICARO3_Onda_bipe_controllonostro_mix_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c129_ICARO3_Onda_bipe_controllonostro_mix(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c129_ICARO3_Onda_bipe_controllonostro_mix\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c129_ICARO3_Onda_bipe_controllonostro_mix_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c129_ICARO3_Onda_bipe_controllonostro_mix(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
  initialize_c129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c129_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  enable_c129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c129_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  disable_c129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c129_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  sf_gateway_c129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c129_ICARO3_Onda_bipe_controllonostro_mix();/* state var info */
...
extern void sf_internal_set_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix(SimStruct* S)
{
  return sf_internal_get_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix(S);
}

static void sf_opaque_set_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix(S, st);
}

static void sf_opaque_terminate_c129_ICARO3_Onda_bipe_controllonostro_mix(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c129_ICARO3_Onda_bipe_controllonostro_mix
      ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc129_ICARO3_Onda_bipe_controllonostro_mix
    ((SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c129_ICARO3_Onda_bipe_controllonostro_mix
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c129_ICARO3_Onda_bipe_controllonostro_mix(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c129_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c129_ICARO3_Onda_bipe_controllonostro_mix(SimStruct *S)
{
  SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct *)
    utMalloc(sizeof(SFc129_ICARO3_Onda_bipe_controllonostro_mixInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c129_ICARO3_Onda_bipe_controllonostro_mix;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c129_ICARO3_Onda_bipe_controllonostro_mix;
...
void c129_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c129_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c129_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c129_ICARO3_Onda_bipe_controllonostro_mix(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c129_ICARO3_Onda_bipe_controllonostro_mix_method_dispatcher.\n"
