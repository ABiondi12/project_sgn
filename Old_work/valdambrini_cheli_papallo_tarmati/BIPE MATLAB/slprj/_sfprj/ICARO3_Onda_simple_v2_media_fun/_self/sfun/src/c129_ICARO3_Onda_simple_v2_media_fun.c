...
static void initialize_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initialize_params_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void enable_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void disable_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c129_update_debugger_state_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void set_sim_state_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c129_st);
static void finalize_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void sf_gateway_c129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initSimStructsc129_ICARO3_Onda_simple_v2_media_fun
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
...
static uint8_T c129_e_emlrt_marshallIn
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c129_b_is_active_c129_ICARO3_Onda_simple_v2_media_fun, const char_T *
   c129_identifier);
  ...
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c129_is_active_c129_ICARO3_Onda_simple_v2_media_fun = 0U;
}
  ...
  (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  c129_b_hoistedGlobal =
    chartInstance->c129_is_active_c129_ICARO3_Onda_simple_v2_media_fun;
   ...
   mxArray *c129_st)
{
  ...
  *c129_y = c129_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c129_is_active_c129_ICARO3_Onda_simple_v2_media_fun =
    ...
    "is_active_c129_ICARO3_Onda_simple_v2_media_fun");
  sf_mex_destroy(&c129_u);
  c129_update_debugger_state_c129_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  *c129_inData)
{
  ...
  const mxArray *c129_y = NULL;
  SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  chartInstance = (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c129_ICARO3_Onda_simple_v2_media_fun_get_eml_resolved_functions_info(void)
{
   ...
   c129_identifier)
{
  ...
  c129_y = c129_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c129_b_is_active_c129_ICARO3_Onda_simple_v2_media_fun), &c129_thisId);
  sf_mex_destroy(&c129_b_is_active_c129_ICARO3_Onda_simple_v2_media_fun);
  return c129_y;
}
...
void sf_c129_ICARO3_Onda_simple_v2_media_fun_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c129_ICARO3_Onda_simple_v2_media_fun_get_autoinheritance_info(void)
{
...
mxArray *sf_c129_ICARO3_Onda_simple_v2_media_fun_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c129_ICARO3_Onda_simple_v2_media_fun_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c129_ICARO3_Onda_simple_v2_media_fun
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c129_ICARO3_Onda_simple_v2_media_fun\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c129_ICARO3_Onda_simple_v2_media_fun_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c129_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
  initialize_c129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c129_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  enable_c129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c129_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  disable_c129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c129_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  sf_gateway_c129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c129_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c129_ICARO3_Onda_simple_v2_media_fun();/* state var info */
...
extern void sf_internal_set_sim_state_c129_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c129_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  return sf_internal_get_sim_state_c129_ICARO3_Onda_simple_v2_media_fun(S);
}

static void sf_opaque_set_sim_state_c129_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c129_ICARO3_Onda_simple_v2_media_fun(S, st);
}

static void sf_opaque_terminate_c129_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c129_ICARO3_Onda_simple_v2_media_fun
      ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc129_ICARO3_Onda_simple_v2_media_fun
    ((SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c129_ICARO3_Onda_simple_v2_media_fun(SimStruct *
  S)
{
  int i;
...
static void mdlSetWorkWidths_c129_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c129_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c129_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    utMalloc(sizeof(SFc129_ICARO3_Onda_simple_v2_media_funInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c129_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c129_ICARO3_Onda_simple_v2_media_fun;
...
void c129_ICARO3_Onda_simple_v2_media_fun_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c129_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c129_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c129_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c129_ICARO3_Onda_simple_v2_media_fun_method_dispatcher.\n"
