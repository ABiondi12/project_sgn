...
static void initialize_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initialize_params_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void enable_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void disable_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c98_update_debugger_state_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void set_sim_state_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c98_st);
static void finalize_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void sf_gateway_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c98_chartstep_c98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initSimStructsc98_ICARO3_Onda_simple_v2_media_fun
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
...
static real32_T c98_decomp(SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct
...
static uint8_T c98_h_emlrt_marshallIn
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c98_b_is_active_c98_ICARO3_Onda_simple_v2_media_fun, const char_T
   *c98_identifier);
  ...
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c98_is_active_c98_ICARO3_Onda_simple_v2_media_fun = 0U;
}
  ...
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  c98_b_hoistedGlobal =
    chartInstance->c98_is_active_c98_ICARO3_Onda_simple_v2_media_fun;
   ...
   mxArray *c98_st)
{
  ...
  *c98_t = c98_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c98_u,
  ...
  chartInstance->c98_is_active_c98_ICARO3_Onda_simple_v2_media_fun =
    ...
    "is_active_c98_ICARO3_Onda_simple_v2_media_fun");
  sf_mex_destroy(&c98_u);
  c98_update_debugger_state_c98_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c98_sfEvent = CALL_EVENT;
  c98_chartstep_c98_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  *c98_inData)
{
  ...
  const mxArray *c98_y = NULL;
  SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  chartInstance = (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c98_ICARO3_Onda_simple_v2_media_fun_get_eml_resolved_functions_info(void)
{
   ...
   *c98_identifier)
{
  ...
  c98_y = c98_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c98_b_is_active_c98_ICARO3_Onda_simple_v2_media_fun), &c98_thisId);
  sf_mex_destroy(&c98_b_is_active_c98_ICARO3_Onda_simple_v2_media_fun);
  return c98_y;
}
...
void sf_c98_ICARO3_Onda_simple_v2_media_fun_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c98_ICARO3_Onda_simple_v2_media_fun_get_autoinheritance_info(void)
{
...
mxArray *sf_c98_ICARO3_Onda_simple_v2_media_fun_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c98_ICARO3_Onda_simple_v2_media_fun_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c98_ICARO3_Onda_simple_v2_media_fun
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[1],M[15],T\"g\",},{M[1],M[14],T\"t\",},{M[8],M[0],T\"is_active_c98_ICARO3_Onda_simple_v2_media_fun\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c98_ICARO3_Onda_simple_v2_media_fun_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c98_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
  initialize_c98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c98_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  enable_c98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c98_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  disable_c98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c98_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  sf_gateway_c98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c98_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c98_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c98_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c98_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
  ...
  set_sim_state_c98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c98_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  return sf_internal_get_sim_state_c98_ICARO3_Onda_simple_v2_media_fun(S);
}

static void sf_opaque_set_sim_state_c98_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c98_ICARO3_Onda_simple_v2_media_fun(S, st);
}

static void sf_opaque_terminate_c98_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c98_ICARO3_Onda_simple_v2_media_fun
      ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc98_ICARO3_Onda_simple_v2_media_fun
    ((SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c98_ICARO3_Onda_simple_v2_media_fun(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c98_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c98_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c98_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    utMalloc(sizeof(SFc98_ICARO3_Onda_simple_v2_media_funInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c98_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c98_ICARO3_Onda_simple_v2_media_fun;
...
void c98_ICARO3_Onda_simple_v2_media_fun_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c98_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c98_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c98_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c98_ICARO3_Onda_simple_v2_media_fun_method_dispatcher.\n"
