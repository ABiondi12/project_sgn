...
static void initialize_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initialize_params_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void enable_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void disable_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c97_update_debugger_state_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void set_sim_state_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c97_st);
static void finalize_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void sf_gateway_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c97_chartstep_c97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initSimStructsc97_ICARO3_Onda_simple_v2_media_fun
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
...
static void c97_emlrt_marshallIn
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c97_a, const char_T *c97_identifier, real32_T c97_y[3]);
static void c97_b_emlrt_marshallIn
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c97_u, const emlrtMsgIdentifier *c97_parentId, real32_T c97_y[3]);
...
static real_T c97_c_emlrt_marshallIn
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c97_u, const emlrtMsgIdentifier *c97_parentId);
...
static real32_T c97_decomp(SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct
...
static uint8_T c97_g_emlrt_marshallIn
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c97_b_is_active_c97_ICARO3_Onda_simple_v2_media_fun, const char_T
   *c97_identifier);
  ...
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c97_is_active_c97_ICARO3_Onda_simple_v2_media_fun = 0U;
}
  ...
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  c97_hoistedGlobal =
    chartInstance->c97_is_active_c97_ICARO3_Onda_simple_v2_media_fun;
   ...
   mxArray *c97_st)
{
  ...
  chartInstance->c97_is_active_c97_ICARO3_Onda_simple_v2_media_fun =
    ...
    "is_active_c97_ICARO3_Onda_simple_v2_media_fun");
  sf_mex_destroy(&c97_u);
  c97_update_debugger_state_c97_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c97_sfEvent = CALL_EVENT;
  c97_chartstep_c97_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  *c97_inData)
{
  ...
  const mxArray *c97_y = NULL;
  SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  chartInstance = (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c97_ICARO3_Onda_simple_v2_media_fun_get_eml_resolved_functions_info(void)
{
   ...
   *c97_identifier)
{
  ...
  c97_y = c97_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c97_b_is_active_c97_ICARO3_Onda_simple_v2_media_fun), &c97_thisId);
  sf_mex_destroy(&c97_b_is_active_c97_ICARO3_Onda_simple_v2_media_fun);
  return c97_y;
}
...
void sf_c97_ICARO3_Onda_simple_v2_media_fun_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c97_ICARO3_Onda_simple_v2_media_fun_get_autoinheritance_info(void)
{
...
mxArray *sf_c97_ICARO3_Onda_simple_v2_media_fun_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c97_ICARO3_Onda_simple_v2_media_fun_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2_media_fun
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[8],M[0],T\"is_active_c97_ICARO3_Onda_simple_v2_media_fun\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c97_ICARO3_Onda_simple_v2_media_fun_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c97_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
  initialize_c97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c97_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  enable_c97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c97_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  disable_c97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c97_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  sf_gateway_c97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c97_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c97_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
  ...
  set_sim_state_c97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c97_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  return sf_internal_get_sim_state_c97_ICARO3_Onda_simple_v2_media_fun(S);
}

static void sf_opaque_set_sim_state_c97_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c97_ICARO3_Onda_simple_v2_media_fun(S, st);
}

static void sf_opaque_terminate_c97_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c97_ICARO3_Onda_simple_v2_media_fun
      ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc97_ICARO3_Onda_simple_v2_media_fun
    ((SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c97_ICARO3_Onda_simple_v2_media_fun(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c97_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c97_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c97_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    utMalloc(sizeof(SFc97_ICARO3_Onda_simple_v2_media_funInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c97_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c97_ICARO3_Onda_simple_v2_media_fun;
...
void c97_ICARO3_Onda_simple_v2_media_fun_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c97_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c97_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c97_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c97_ICARO3_Onda_simple_v2_media_fun_method_dispatcher.\n"
