...
static void initialize_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initialize_params_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void enable_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void disable_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c95_update_debugger_state_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void set_sim_state_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c95_st);
static void finalize_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void sf_gateway_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c95_chartstep_c95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initSimStructsc95_ICARO3_Onda_simple_v2_media_fun
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
...
static uint8_T c95_g_emlrt_marshallIn
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c95_b_is_active_c95_ICARO3_Onda_simple_v2_media_fun, const char_T
   *c95_identifier);
  ...
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c95_is_active_c95_ICARO3_Onda_simple_v2_media_fun = 0U;
}
  ...
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  c95_c_hoistedGlobal =
    chartInstance->c95_is_active_c95_ICARO3_Onda_simple_v2_media_fun;
   ...
   mxArray *c95_st)
{
  ...
  *c95_UT = c95_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c95_is_active_c95_ICARO3_Onda_simple_v2_media_fun =
    ...
    "is_active_c95_ICARO3_Onda_simple_v2_media_fun");
  sf_mex_destroy(&c95_u);
  c95_update_debugger_state_c95_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c95_sfEvent = CALL_EVENT;
  c95_chartstep_c95_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  *c95_inData)
{
  ...
  const mxArray *c95_y = NULL;
  SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  chartInstance = (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    chartInstanceVoid;
   ...
   *c95_identifier)
{
  ...
  c95_y = c95_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c95_b_is_active_c95_ICARO3_Onda_simple_v2_media_fun), &c95_thisId);
  sf_mex_destroy(&c95_b_is_active_c95_ICARO3_Onda_simple_v2_media_fun);
  return c95_y;
}
...
void sf_c95_ICARO3_Onda_simple_v2_media_fun_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c95_ICARO3_Onda_simple_v2_media_fun_get_autoinheritance_info(void)
{
...
mxArray *sf_c95_ICARO3_Onda_simple_v2_media_fun_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c95_ICARO3_Onda_simple_v2_media_fun_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c95_ICARO3_Onda_simple_v2_media_fun
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"UP\",},{M[1],M[5],T\"UT\",},{M[8],M[0],T\"is_active_c95_ICARO3_Onda_simple_v2_media_fun\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c95_ICARO3_Onda_simple_v2_media_fun_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c95_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
  initialize_c95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c95_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  enable_c95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c95_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  disable_c95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c95_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  sf_gateway_c95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c95_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c95_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c95_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c95_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
  ...
  set_sim_state_c95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c95_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  return sf_internal_get_sim_state_c95_ICARO3_Onda_simple_v2_media_fun(S);
}

static void sf_opaque_set_sim_state_c95_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c95_ICARO3_Onda_simple_v2_media_fun(S, st);
}

static void sf_opaque_terminate_c95_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c95_ICARO3_Onda_simple_v2_media_fun
      ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc95_ICARO3_Onda_simple_v2_media_fun
    ((SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c95_ICARO3_Onda_simple_v2_media_fun(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c95_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c95_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c95_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    utMalloc(sizeof(SFc95_ICARO3_Onda_simple_v2_media_funInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c95_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c95_ICARO3_Onda_simple_v2_media_fun;
...
void c95_ICARO3_Onda_simple_v2_media_fun_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c95_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c95_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c95_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c95_ICARO3_Onda_simple_v2_media_fun_method_dispatcher.\n"
