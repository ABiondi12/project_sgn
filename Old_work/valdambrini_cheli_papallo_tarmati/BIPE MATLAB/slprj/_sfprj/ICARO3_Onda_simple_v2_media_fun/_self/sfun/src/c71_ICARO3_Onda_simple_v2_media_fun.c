...
static void initialize_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initialize_params_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void enable_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void disable_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c71_update_debugger_state_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void set_sim_state_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c71_st);
static void finalize_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void sf_gateway_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c71_chartstep_c71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void initSimStructsc71_ICARO3_Onda_simple_v2_media_fun
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
...
static real32_T c71_norm(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T c71_x[3]);
static real32_T c71_eml_xnrm2
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, real32_T
   c71_x[3]);
static real32_T c71_abs(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T c71_x);
static void c71_qtriad(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T c71_acc[3], real32_T c71_mag[3], real32_T c71_q_out[4]);
static real32_T c71_mpower(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T c71_a);
static void c71_eml_scalar_eg
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static real32_T c71_sqrt(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T c71_x);
static void c71_eml_error(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance);
static void c71_cross(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
                      *chartInstance, real32_T c71_a[3], real32_T c71_b[3],
                      real32_T c71_c[3]);
static void c71_b_cross(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real_T c71_a[3], real32_T c71_b[3], real32_T c71_c[3]);
static void c71_eps(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
                    *chartInstance);
static void c71_b_eml_scalar_eg
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance);
static void c71_eml_xgemm(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T c71_A[9], real32_T c71_B[3], real32_T c71_C[3],
  real32_T c71_b_C[3]);
static void c71_c_cross(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T c71_a[3], real_T c71_b[3], real32_T c71_c[3]);
static real32_T c71_atan2(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
...
static uint8_T c71_k_emlrt_marshallIn
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c71_b_is_active_c71_ICARO3_Onda_simple_v2_media_fun, const char_T
   *c71_identifier);
static uint8_T c71_l_emlrt_marshallIn
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance, const
   mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId);
static void c71_b_sqrt(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct
  *chartInstance, real32_T *c71_x);
static void c71_b_eml_xgemm(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *
  chartInstance, real32_T c71_A[9], real32_T c71_B[3], real32_T c71_C[3]);
  ...
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c71_is_active_c71_ICARO3_Onda_simple_v2_media_fun = 0U;
}
  ...
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  c71_b_hoistedGlobal =
    chartInstance->c71_is_active_c71_ICARO3_Onda_simple_v2_media_fun;
   ...
   mxArray *c71_st)
{
  ...
  chartInstance->c71_is_active_c71_ICARO3_Onda_simple_v2_media_fun =
    ...
    "is_active_c71_ICARO3_Onda_simple_v2_media_fun");
  sf_mex_destroy(&c71_u);
  c71_update_debugger_state_c71_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance)
{
  ...
  chartInstance->c71_sfEvent = CALL_EVENT;
  c71_chartstep_c71_ICARO3_Onda_simple_v2_media_fun(chartInstance);
  ...
  *c71_inData)
{
  ...
  const mxArray *c71_y = NULL;
  SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  chartInstance = (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c71_ICARO3_Onda_simple_v2_media_fun_get_eml_resolved_functions_info(void)
{
   ...
   *c71_identifier)
{
  ...
  c71_y = c71_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c71_b_is_active_c71_ICARO3_Onda_simple_v2_media_fun), &c71_thisId);
  sf_mex_destroy(&c71_b_is_active_c71_ICARO3_Onda_simple_v2_media_fun);
  return c71_y;
}
...
void sf_c71_ICARO3_Onda_simple_v2_media_fun_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c71_ICARO3_Onda_simple_v2_media_fun_get_autoinheritance_info(void)
{
...
mxArray *sf_c71_ICARO3_Onda_simple_v2_media_fun_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c71_ICARO3_Onda_simple_v2_media_fun_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2_media_fun
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[20],T\"a_ned\",},{M[1],M[14],T\"biases\",},{M[1],M[13],T\"e_int_out_a\",},{M[1],M[23],T\"e_int_out_m\",},{M[1],M[24],T\"e_m\",},{M[1],M[19],T\"euler_out\",},{M[1],M[8],T\"q_out\",},{M[4],M[0],T\"ini\",S'l','i','p'{{M1x2[150 153],M[0],}}},{M[8],M[0],T\"is_active_c71_ICARO3_Onda_simple_v2_media_fun\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c71_ICARO3_Onda_simple_v2_media_fun_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c71_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
  initialize_c71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c71_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  enable_c71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c71_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  disable_c71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c71_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  sf_gateway_c71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c71_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c71_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2_media_fun
    ();                                /* state var info */
  ...
  set_sim_state_c71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c71_ICARO3_Onda_simple_v2_media_fun(SimStruct* S)
{
  return sf_internal_get_sim_state_c71_ICARO3_Onda_simple_v2_media_fun(S);
}

static void sf_opaque_set_sim_state_c71_ICARO3_Onda_simple_v2_media_fun
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c71_ICARO3_Onda_simple_v2_media_fun(S, st);
}

static void sf_opaque_terminate_c71_ICARO3_Onda_simple_v2_media_fun(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c71_ICARO3_Onda_simple_v2_media_fun
      ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc71_ICARO3_Onda_simple_v2_media_fun
    ((SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c71_ICARO3_Onda_simple_v2_media_fun(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c71_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
...
static void mdlRTW_c71_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c71_ICARO3_Onda_simple_v2_media_fun(SimStruct *S)
{
  SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct *)
    utMalloc(sizeof(SFc71_ICARO3_Onda_simple_v2_media_funInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c71_ICARO3_Onda_simple_v2_media_fun;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c71_ICARO3_Onda_simple_v2_media_fun;
...
void c71_ICARO3_Onda_simple_v2_media_fun_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c71_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c71_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c71_ICARO3_Onda_simple_v2_media_fun(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c71_ICARO3_Onda_simple_v2_media_fun_method_dispatcher.\n"
