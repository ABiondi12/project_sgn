...
static void initialize_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initialize_params_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void enable_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void disable_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void c71_update_debugger_state_c71_ICARO3_Onda_bipe_controllonostro40
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void set_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c71_st);
static void finalize_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void sf_gateway_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void c71_chartstep_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initSimStructsc71_ICARO3_Onda_bipe_controllonostro40cm
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
...
static real32_T c71_eml_xnrm2
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   real32_T c71_x[3]);
static real32_T c71_abs(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct
  *chartInstance, real32_T c71_x);
static void c71_qtriad(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *
...
static void c71_eml_error
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void c71_cross(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct
                      *chartInstance, real32_T c71_a[3], real32_T c71_b[3],
                      real32_T c71_c[3]);
static void c71_b_cross(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct
  *chartInstance, real_T c71_a[3], real32_T c71_b[3], real32_T c71_c[3]);
static void c71_eps(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct
                    *chartInstance);
...
static void c71_c_cross(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct
...
static uint8_T c71_k_emlrt_marshallIn
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c71_b_is_active_c71_ICARO3_Onda_bipe_controllonostro40cm,
   const char_T *c71_identifier);
static uint8_T c71_l_emlrt_marshallIn
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId);
static void c71_b_sqrt(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *
  chartInstance, real32_T *c71_x);
  ...
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c71_is_active_c71_ICARO3_Onda_bipe_controllonostro40cm = 0U;
}
  ...
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  c71_b_hoistedGlobal =
    chartInstance->c71_is_active_c71_ICARO3_Onda_bipe_controllonostro40cm;
   ...
   const mxArray *c71_st)
{
  ...
  chartInstance->c71_is_active_c71_ICARO3_Onda_bipe_controllonostro40cm =
    ...
    "is_active_c71_ICARO3_Onda_bipe_controllonostro40cm");
  sf_mex_destroy(&c71_u);
  c71_update_debugger_state_c71_ICARO3_Onda_bipe_controllonostro40(chartInstance);
  ...
  (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c71_sfEvent = CALL_EVENT;
  c71_chartstep_c71_ICARO3_Onda_bipe_controllonostro40cm(chartInstance);
  ...
  *c71_inData)
{
  ...
  const mxArray *c71_y = NULL;
  SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  chartInstance = (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c71_identifier)
{
  ...
  c71_y = c71_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c71_b_is_active_c71_ICARO3_Onda_bipe_controllonostro40cm), &c71_thisId);
  sf_mex_destroy(&c71_b_is_active_c71_ICARO3_Onda_bipe_controllonostro40cm);
  return c71_y;
}
...
void sf_c71_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c71_ICARO3_Onda_bipe_controllonostro40cm_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c71_ICARO3_Onda_bipe_controllonostro40cm_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c71_ICARO3_Onda_bipe_controllonostro40cm_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c71_ICARO3_Onda_bipe_controllonostro40cm(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[20],T\"a_ned\",},{M[1],M[14],T\"biases\",},{M[1],M[13],T\"e_int_out_a\",},{M[1],M[23],T\"e_int_out_m\",},{M[1],M[24],T\"e_m\",},{M[1],M[19],T\"euler_out\",},{M[1],M[8],T\"q_out\",},{M[4],M[0],T\"ini\",S'l','i','p'{{M1x2[150 153],M[0],}}},{M[8],M[0],T\"is_active_c71_ICARO3_Onda_bipe_controllonostro40cm\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c71_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c71_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
  initialize_c71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c71_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  enable_c71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c71_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  disable_c71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c71_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  sf_gateway_c71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c71_ICARO3_Onda_bipe_controllonostro40cm();/* state var info */
...
extern void sf_internal_set_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm(SimStruct* S)
{
  return sf_internal_get_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm(S);
}

static void sf_opaque_set_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm(S, st);
}

static void sf_opaque_terminate_c71_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c71_ICARO3_Onda_bipe_controllonostro40cm
      ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc71_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c71_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c71_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *
  S)
{
...
static void mdlRTW_c71_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c71_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    utMalloc(sizeof(SFc71_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c71_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c71_ICARO3_Onda_bipe_controllonostro40cm;
...
void c71_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c71_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c71_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c71_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c71_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher.\n"
