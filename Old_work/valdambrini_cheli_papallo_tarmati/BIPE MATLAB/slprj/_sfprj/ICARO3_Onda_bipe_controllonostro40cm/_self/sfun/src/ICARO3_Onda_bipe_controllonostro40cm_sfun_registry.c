...
{
  extern unsigned int
    sf_ICARO3_Onda_bipe_controllonostro40cm_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ICARO3_Onda_bipe_controllonostro40cm_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_ICARO3_Onda_bipe_controllonostro40cm_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "ICARO3_Onda_bipe_controllonostro40cm") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ICARO3_Onda_bipe_controllonostro40cm_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_ICARO3_Onda_bipe_controllonostro40cm_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "ICARO3_Onda_bipe_controllonostro40cm") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ICARO3_Onda_bipe_controllonostro40cm_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_ICARO3_Onda_bipe_controllonostro40cm_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "ICARO3_Onda_bipe_controllonostro40cm") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ICARO3_Onda_bipe_controllonostro40cm_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "ICARO3_Onda_bipe_controllonostro40cm") == 0) {
    ...
    newRhs[1] = prhs[2];
    return
      sf_ICARO3_Onda_bipe_controllonostro40cm_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ICARO3_Onda_bipe_controllonostro40cm")) {
    return(sf_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher
...
extern void ICARO3_Onda_bipe_controllonostro40cm_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    ICARO3_Onda_bipe_controllonostro40cm_terminator();
...
extern void ICARO3_Onda_bipe_controllonostro40cm_initializer(void);
extern void ICARO3_Onda_bipe_controllonostro40cm_register_exported_symbols
  (SimStruct* S);
extern void ICARO3_Onda_bipe_controllonostro40cm_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ICARO3_Onda_bipe_controllonostro40cm_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ICARO3_Onda_bipe_controllonostro40cm_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    ICARO3_Onda_bipe_controllonostro40cm_initializer();
  }
