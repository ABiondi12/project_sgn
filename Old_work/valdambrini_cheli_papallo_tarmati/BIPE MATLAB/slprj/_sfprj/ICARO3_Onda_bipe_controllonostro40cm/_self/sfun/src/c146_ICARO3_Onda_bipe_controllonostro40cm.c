...
static void initialize_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initialize_params_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void enable_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void disable_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void c146_update_debugger_state_c146_ICARO3_Onda_bipe_controllonostro
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void set_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c146_st);
static void finalize_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void sf_gateway_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initSimStructsc146_ICARO3_Onda_bipe_controllonostro40cm
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
...
static const mxArray *c146_sf_marshallOut(void *chartInstanceVoid, void
  *c146_inData);
static void c146_emlrt_marshallIn
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c146_y, const char_T *c146_identifier, uint8_T c146_b_y[8]);
static void c146_b_emlrt_marshallIn
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c146_u, const emlrtMsgIdentifier *c146_parentId, uint8_T
   c146_y[8]);
...
static const mxArray *c146_c_sf_marshallOut(void *chartInstanceVoid, void
  *c146_inData);
static real_T c146_c_emlrt_marshallIn
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c146_u, const emlrtMsgIdentifier *c146_parentId);
...
static const mxArray *c146_d_sf_marshallOut(void *chartInstanceVoid, void
  *c146_inData);
static int32_T c146_d_emlrt_marshallIn
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c146_u, const emlrtMsgIdentifier *c146_parentId);
static void c146_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c146_mxArrayInData, const char_T *c146_varName, void *c146_outData);
static uint8_T c146_e_emlrt_marshallIn
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c146_b_is_active_c146_ICARO3_Onda_bipe_controllonostro40cm,
   const char_T *c146_identifier);
static uint8_T c146_f_emlrt_marshallIn
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c146_u, const emlrtMsgIdentifier *c146_parentId);
  ...
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c146_is_active_c146_ICARO3_Onda_bipe_controllonostro40cm = 0U;
}
  ...
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  c146_hoistedGlobal =
    chartInstance->c146_is_active_c146_ICARO3_Onda_bipe_controllonostro40cm;
   ...
   const mxArray *c146_st)
{
  ...
  chartInstance->c146_is_active_c146_ICARO3_Onda_bipe_controllonostro40cm =
    c146_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c146_u, 1)),
    "is_active_c146_ICARO3_Onda_bipe_controllonostro40cm");
  sf_mex_destroy(&c146_u);
  c146_update_debugger_state_c146_ICARO3_Onda_bipe_controllonostro(chartInstance);
  ...
  (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 46U, chartInstance->c146_sfEvent);
  for (c146_i2 = 0; c146_i2 < 8; c146_i2++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*c146_b_u)[c146_i2], 0U);
  }

  chartInstance->c146_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 46U, chartInstance->c146_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 46U, chartInstance->c146_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c146_inData)
{
  ...
  const mxArray *c146_y = NULL;
  SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  chartInstance = (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c146_identifier)
{
  ...
  c146_y = c146_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c146_b_is_active_c146_ICARO3_Onda_bipe_controllonostro40cm), &c146_thisId);
  sf_mex_destroy(&c146_b_is_active_c146_ICARO3_Onda_bipe_controllonostro40cm);
  return c146_y;
}
...
void sf_c146_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c146_ICARO3_Onda_bipe_controllonostro40cm_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c146_ICARO3_Onda_bipe_controllonostro40cm_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c146_ICARO3_Onda_bipe_controllonostro40cm_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c146_ICARO3_Onda_bipe_controllonostro40cm(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c146_ICARO3_Onda_bipe_controllonostro40cm\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c146_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c146_ICARO3_Onda_bipe_controllonostro40cm(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
  initialize_c146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c146_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  enable_c146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c146_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  disable_c146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c146_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  sf_gateway_c146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c146_ICARO3_Onda_bipe_controllonostro40cm();/* state var info */
...
extern void sf_internal_set_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm(SimStruct* S)
{
  return sf_internal_get_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm(S);
}

static void sf_opaque_set_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm(S, st);
}

static void sf_opaque_terminate_c146_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c146_ICARO3_Onda_bipe_controllonostro40cm
      ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc146_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c146_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c146_ICARO3_Onda_bipe_controllonostro40cm(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c146_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c146_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    utMalloc(sizeof(SFc146_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c146_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c146_ICARO3_Onda_bipe_controllonostro40cm;
...
void c146_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c146_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c146_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c146_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c146_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher.\n"
