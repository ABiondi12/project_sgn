...
static void initialize_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initialize_params_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void enable_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void disable_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void c126_update_debugger_state_c126_ICARO3_Onda_bipe_controllonostro
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void set_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c126_st);
static void finalize_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void sf_gateway_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initSimStructsc126_ICARO3_Onda_bipe_controllonostro40cm
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
...
static uint8_T c126_e_emlrt_marshallIn
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c126_b_is_active_c126_ICARO3_Onda_bipe_controllonostro40cm,
  ...
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c126_is_active_c126_ICARO3_Onda_bipe_controllonostro40cm = 0U;
}
  ...
  (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  c126_b_hoistedGlobal =
    chartInstance->c126_is_active_c126_ICARO3_Onda_bipe_controllonostro40cm;
   ...
   const mxArray *c126_st)
{
  ...
  *c126_y = c126_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c126_is_active_c126_ICARO3_Onda_bipe_controllonostro40cm =
    ...
    "is_active_c126_ICARO3_Onda_bipe_controllonostro40cm");
  ...
  *c126_inData)
{
  ...
  const mxArray *c126_y = NULL;
  SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  chartInstance = (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c126_identifier)
{
  ...
  c126_y = c126_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c126_b_is_active_c126_ICARO3_Onda_bipe_controllonostro40cm), &c126_thisId);
  sf_mex_destroy(&c126_b_is_active_c126_ICARO3_Onda_bipe_controllonostro40cm);
  return c126_y;
}
...
void sf_c126_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c126_ICARO3_Onda_bipe_controllonostro40cm_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c126_ICARO3_Onda_bipe_controllonostro40cm_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c126_ICARO3_Onda_bipe_controllonostro40cm_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c126_ICARO3_Onda_bipe_controllonostro40cm(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c126_ICARO3_Onda_bipe_controllonostro40cm\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c126_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c126_ICARO3_Onda_bipe_controllonostro40cm(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
  initialize_c126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c126_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  enable_c126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c126_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  disable_c126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c126_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  sf_gateway_c126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c126_ICARO3_Onda_bipe_controllonostro40cm();/* state var info */
...
extern void sf_internal_set_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm(SimStruct* S)
{
  return sf_internal_get_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm(S);
}

static void sf_opaque_set_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm(S, st);
}

static void sf_opaque_terminate_c126_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c126_ICARO3_Onda_bipe_controllonostro40cm
      ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc126_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c126_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c126_ICARO3_Onda_bipe_controllonostro40cm(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c126_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c126_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    utMalloc(sizeof(SFc126_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c126_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c126_ICARO3_Onda_bipe_controllonostro40cm;
...
void c126_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c126_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c126_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c126_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c126_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher.\n"
