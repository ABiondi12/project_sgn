...
static void initialize_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initialize_params_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void enable_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void disable_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void c133_update_debugger_state_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void set_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c133_st);
static void finalize_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void sf_gateway_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
static void initSimStructsc133_ICARO3_Onda_bipe_controllonostro40cm
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance);
...
static void c133_emlrt_marshallIn
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c133_y, const char_T *c133_identifier, uint8_T c133_b_y[2]);
static void c133_b_emlrt_marshallIn
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c133_u, const emlrtMsgIdentifier *c133_parentId, uint8_T
   c133_y[2]);
...
static real_T c133_c_emlrt_marshallIn
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c133_u, const emlrtMsgIdentifier *c133_parentId);
...
static uint8_T c133_e_emlrt_marshallIn
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance,
   const mxArray *c133_b_is_active_c133_ICARO3_Onda_bipe_controllonostro40cm,
  ...
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c133_is_active_c133_ICARO3_Onda_bipe_controllonostro40cm = 0U;
}
  ...
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  c133_hoistedGlobal =
    chartInstance->c133_is_active_c133_ICARO3_Onda_bipe_controllonostro40cm;
   ...
   const mxArray *c133_st)
{
  ...
  chartInstance->c133_is_active_c133_ICARO3_Onda_bipe_controllonostro40cm =
    ...
    "is_active_c133_ICARO3_Onda_bipe_controllonostro40cm");
  sf_mex_destroy(&c133_u);
  c133_update_debugger_state_c133_ICARO3_Onda_bipe_controllonostro(chartInstance);
  ...
  (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 33U, chartInstance->c133_sfEvent);
  _SFD_DATA_RANGE_CHECK((real_T)*c133_b_u, 0U);
  chartInstance->c133_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 33U, chartInstance->c133_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 33U, chartInstance->c133_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c133_inData)
{
  ...
  const mxArray *c133_y = NULL;
  SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  chartInstance = (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c133_identifier)
{
  ...
  c133_y = c133_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c133_b_is_active_c133_ICARO3_Onda_bipe_controllonostro40cm), &c133_thisId);
  sf_mex_destroy(&c133_b_is_active_c133_ICARO3_Onda_bipe_controllonostro40cm);
  return c133_y;
}
...
void sf_c133_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c133_ICARO3_Onda_bipe_controllonostro40cm_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c133_ICARO3_Onda_bipe_controllonostro40cm_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c133_ICARO3_Onda_bipe_controllonostro40cm_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c133_ICARO3_Onda_bipe_controllonostro40cm(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c133_ICARO3_Onda_bipe_controllonostro40cm\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c133_ICARO3_Onda_bipe_controllonostro40cm_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c133_ICARO3_Onda_bipe_controllonostro40cm(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
  initialize_c133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c133_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  enable_c133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c133_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  disable_c133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c133_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  sf_gateway_c133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c133_ICARO3_Onda_bipe_controllonostro40cm();/* state var info */
...
extern void sf_internal_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm(SimStruct* S)
{
  return sf_internal_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm(S);
}

static void sf_opaque_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm(S, st);
}

static void sf_opaque_terminate_c133_ICARO3_Onda_bipe_controllonostro40cm(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c133_ICARO3_Onda_bipe_controllonostro40cm
      ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc133_ICARO3_Onda_bipe_controllonostro40cm
    ((SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c133_ICARO3_Onda_bipe_controllonostro40cm
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c133_ICARO3_Onda_bipe_controllonostro40cm(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c133_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c133_ICARO3_Onda_bipe_controllonostro40cm(SimStruct *S)
{
  SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct *)
    utMalloc(sizeof(SFc133_ICARO3_Onda_bipe_controllonostro40cmInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c133_ICARO3_Onda_bipe_controllonostro40cm;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c133_ICARO3_Onda_bipe_controllonostro40cm;
...
void c133_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c133_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c133_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c133_ICARO3_Onda_bipe_controllonostro40cm(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c133_ICARO3_Onda_bipe_controllonostro40cm_method_dispatcher.\n"
