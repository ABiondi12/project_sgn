...
static void initialize_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initialize_params_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void enable_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void disable_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void c134_update_debugger_state_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void set_sim_state_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c134_st);
static void finalize_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void sf_gateway_c134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initSimStructsc134_ICARO3_Onda_simple_v2
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
...
static const mxArray *c134_sf_marshallOut(void *chartInstanceVoid, void
  *c134_inData);
static void c134_emlrt_marshallIn(SFc134_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c134_y, const char_T *c134_identifier, uint8_T
  c134_b_y[2]);
static void c134_b_emlrt_marshallIn(SFc134_ICARO3_Onda_simple_v2InstanceStruct
...
static const mxArray *c134_c_sf_marshallOut(void *chartInstanceVoid, void
  *c134_inData);
static real_T c134_c_emlrt_marshallIn(SFc134_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c134_u, const emlrtMsgIdentifier *c134_parentId);
...
static int32_T c134_d_emlrt_marshallIn
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c134_u, const emlrtMsgIdentifier *c134_parentId);
static void c134_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c134_mxArrayInData, const char_T *c134_varName, void *c134_outData);
static uint8_T c134_e_emlrt_marshallIn
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c134_b_is_active_c134_ICARO3_Onda_simple_v2, const char_T *c134_identifier);
static uint8_T c134_f_emlrt_marshallIn
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c134_u, const emlrtMsgIdentifier *c134_parentId);
static void init_dsm_address_info(SFc134_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance);
  ...
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c134_is_active_c134_ICARO3_Onda_simple_v2 = 0U;
}
  ...
  (SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  c134_hoistedGlobal = chartInstance->c134_is_active_c134_ICARO3_Onda_simple_v2;
   ...
   *c134_st)
{
  ...
  chartInstance->c134_is_active_c134_ICARO3_Onda_simple_v2 =
    c134_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c134_u, 1)),
    "is_active_c134_ICARO3_Onda_simple_v2");
  sf_mex_destroy(&c134_u);
  c134_update_debugger_state_c134_ICARO3_Onda_simple_v2(chartInstance);
  ...
  *c134_inData)
{
  ...
  const mxArray *c134_y = NULL;
  SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  chartInstance = (SFc134_ICARO3_Onda_simple_v2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c134_ICARO3_Onda_simple_v2_get_eml_resolved_functions_info
  (void)
{
   ...
   *c134_b_is_active_c134_ICARO3_Onda_simple_v2, const char_T *c134_identifier)
{
  ...
  c134_y = c134_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c134_b_is_active_c134_ICARO3_Onda_simple_v2), &c134_thisId);
  sf_mex_destroy(&c134_b_is_active_c134_ICARO3_Onda_simple_v2);
  return c134_y;
}
...
void sf_c134_ICARO3_Onda_simple_v2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c134_ICARO3_Onda_simple_v2_get_autoinheritance_info(void)
{
...
mxArray *sf_c134_ICARO3_Onda_simple_v2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c134_ICARO3_Onda_simple_v2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c134_ICARO3_Onda_simple_v2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c134_ICARO3_Onda_simple_v2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c134_ICARO3_Onda_simple_v2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c134_ICARO3_Onda_simple_v2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc134_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c134_ICARO3_Onda_simple_v2
    ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
  initialize_c134_ICARO3_Onda_simple_v2
    ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c134_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  enable_c134_ICARO3_Onda_simple_v2((SFc134_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c134_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  disable_c134_ICARO3_Onda_simple_v2((SFc134_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c134_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  sf_gateway_c134_ICARO3_Onda_simple_v2
    ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c134_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c134_ICARO3_Onda_simple_v2
    ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c134_ICARO3_Onda_simple_v2();/* state var info */
...
extern void sf_internal_set_sim_state_c134_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c134_ICARO3_Onda_simple_v2();/* state var info */
  ...
  set_sim_state_c134_ICARO3_Onda_simple_v2
    ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c134_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c134_ICARO3_Onda_simple_v2(S);
}

static void sf_opaque_set_sim_state_c134_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c134_ICARO3_Onda_simple_v2(S, st);
}

static void sf_opaque_terminate_c134_ICARO3_Onda_simple_v2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c134_ICARO3_Onda_simple_v2
      ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc134_ICARO3_Onda_simple_v2
    ((SFc134_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c134_ICARO3_Onda_simple_v2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c134_ICARO3_Onda_simple_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c134_ICARO3_Onda_simple_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c134_ICARO3_Onda_simple_v2(SimStruct *S)
{
  SFc134_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc134_ICARO3_Onda_simple_v2InstanceStruct *)utMalloc(sizeof
    (SFc134_ICARO3_Onda_simple_v2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc134_ICARO3_Onda_simple_v2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlStart = mdlStart_c134_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c134_ICARO3_Onda_simple_v2;
...
void c134_ICARO3_Onda_simple_v2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c134_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c134_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c134_ICARO3_Onda_simple_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c134_ICARO3_Onda_simple_v2_method_dispatcher.\n"
