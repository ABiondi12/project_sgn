...
static void initialize_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initialize_params_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void enable_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void disable_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void c97_update_debugger_state_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void set_sim_state_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c97_st);
static void finalize_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void sf_gateway_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void c97_chartstep_c97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initSimStructsc97_ICARO3_Onda_simple_v2
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
...
static const mxArray *c97_sf_marshallOut(void *chartInstanceVoid, void
  *c97_inData);
static void c97_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c97_a, const char_T *c97_identifier, real32_T
  c97_y[3]);
static void c97_b_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct
...
static const mxArray *c97_d_sf_marshallOut(void *chartInstanceVoid, void
  *c97_inData);
static real_T c97_c_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c97_u, const emlrtMsgIdentifier *c97_parentId);
...
static const mxArray *c97_e_sf_marshallOut(void *chartInstanceVoid, void
  *c97_inData);
static real32_T c97_d_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c97_u, const emlrtMsgIdentifier *c97_parentId);
...
static const mxArray *c97_f_sf_marshallOut(void *chartInstanceVoid, void
  *c97_inData);
static uint16_T c97_e_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c97_u, const emlrtMsgIdentifier *c97_parentId);
...
static real32_T c97_decomp(SFc97_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, uint16_T c97_u);
static const mxArray *c97_g_sf_marshallOut(void *chartInstanceVoid, void
  *c97_inData);
static int32_T c97_f_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct *
  chartInstance, const mxArray *c97_u, const emlrtMsgIdentifier *c97_parentId);
static void c97_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c97_mxArrayInData, const char_T *c97_varName, void *c97_outData);
static uint8_T c97_g_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct *
  chartInstance, const mxArray *c97_b_is_active_c97_ICARO3_Onda_simple_v2, const
  char_T *c97_identifier);
static uint8_T c97_h_emlrt_marshallIn(SFc97_ICARO3_Onda_simple_v2InstanceStruct *
  chartInstance, const mxArray *c97_u, const emlrtMsgIdentifier *c97_parentId);
static void init_dsm_address_info(SFc97_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance);
  ...
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c97_is_active_c97_ICARO3_Onda_simple_v2 = 0U;
}
  ...
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  c97_hoistedGlobal = chartInstance->c97_is_active_c97_ICARO3_Onda_simple_v2;
   ...
   *c97_st)
{
  ...
  chartInstance->c97_is_active_c97_ICARO3_Onda_simple_v2 =
    c97_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c97_u, 1)),
    "is_active_c97_ICARO3_Onda_simple_v2");
  sf_mex_destroy(&c97_u);
  c97_update_debugger_state_c97_ICARO3_Onda_simple_v2(chartInstance);
  ...
  (SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c97_sfEvent = CALL_EVENT;
  c97_chartstep_c97_ICARO3_Onda_simple_v2(chartInstance);
  ...
  *c97_inData)
{
  ...
  const mxArray *c97_y = NULL;
  SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  chartInstance = (SFc97_ICARO3_Onda_simple_v2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c97_ICARO3_Onda_simple_v2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c97_identifier)
{
  ...
  c97_y = c97_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c97_b_is_active_c97_ICARO3_Onda_simple_v2), &c97_thisId);
  sf_mex_destroy(&c97_b_is_active_c97_ICARO3_Onda_simple_v2);
  return c97_y;
}
...
void sf_c97_ICARO3_Onda_simple_v2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c97_ICARO3_Onda_simple_v2_get_autoinheritance_info(void)
{
...
mxArray *sf_c97_ICARO3_Onda_simple_v2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c97_ICARO3_Onda_simple_v2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[8],M[0],T\"is_active_c97_ICARO3_Onda_simple_v2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c97_ICARO3_Onda_simple_v2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc97_ICARO3_Onda_simple_v2InstanceStruct *)
...
static void sf_opaque_initialize_c97_ICARO3_Onda_simple_v2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc97_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c97_ICARO3_Onda_simple_v2
    ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
  initialize_c97_ICARO3_Onda_simple_v2
    ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c97_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  enable_c97_ICARO3_Onda_simple_v2((SFc97_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c97_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  disable_c97_ICARO3_Onda_simple_v2((SFc97_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c97_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  sf_gateway_c97_ICARO3_Onda_simple_v2
    ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c97_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c97_ICARO3_Onda_simple_v2
    ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2();/* state var info */
...
extern void sf_internal_set_sim_state_c97_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2();/* state var info */
  ...
  set_sim_state_c97_ICARO3_Onda_simple_v2
    ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c97_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c97_ICARO3_Onda_simple_v2(S);
}

static void sf_opaque_set_sim_state_c97_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c97_ICARO3_Onda_simple_v2(S, st);
}

static void sf_opaque_terminate_c97_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c97_ICARO3_Onda_simple_v2
      ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc97_ICARO3_Onda_simple_v2
    ((SFc97_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c97_ICARO3_Onda_simple_v2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c97_ICARO3_Onda_simple_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c97_ICARO3_Onda_simple_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c97_ICARO3_Onda_simple_v2(SimStruct *S)
{
  SFc97_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc97_ICARO3_Onda_simple_v2InstanceStruct *)utMalloc(sizeof
    (SFc97_ICARO3_Onda_simple_v2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc97_ICARO3_Onda_simple_v2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlStart = mdlStart_c97_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c97_ICARO3_Onda_simple_v2;
...
void c97_ICARO3_Onda_simple_v2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c97_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c97_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c97_ICARO3_Onda_simple_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c97_ICARO3_Onda_simple_v2_method_dispatcher.\n"
