...
static void initialize_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initialize_params_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void enable_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void disable_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void c130_update_debugger_state_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void set_sim_state_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c130_st);
static void finalize_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void sf_gateway_c130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initSimStructsc130_ICARO3_Onda_simple_v2
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
...
static const mxArray *c130_sf_marshallOut(void *chartInstanceVoid, void
  *c130_inData);
static real32_T c130_emlrt_marshallIn(SFc130_ICARO3_Onda_simple_v2InstanceStruct
...
static const mxArray *c130_c_sf_marshallOut(void *chartInstanceVoid, void
  *c130_inData);
static real_T c130_c_emlrt_marshallIn(SFc130_ICARO3_Onda_simple_v2InstanceStruct
...
static uint8_T c130_e_emlrt_marshallIn
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c130_b_is_active_c130_ICARO3_Onda_simple_v2, const char_T *c130_identifier);
static uint8_T c130_f_emlrt_marshallIn
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c130_u, const emlrtMsgIdentifier *c130_parentId);
static void init_dsm_address_info(SFc130_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance);
  ...
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c130_is_active_c130_ICARO3_Onda_simple_v2 = 0U;
}
  ...
  (SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  c130_b_hoistedGlobal =
    chartInstance->c130_is_active_c130_ICARO3_Onda_simple_v2;
   ...
   *c130_st)
{
  ...
  *c130_y = c130_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c130_is_active_c130_ICARO3_Onda_simple_v2 =
    ...
    "is_active_c130_ICARO3_Onda_simple_v2");
  sf_mex_destroy(&c130_u);
  c130_update_debugger_state_c130_ICARO3_Onda_simple_v2(chartInstance);
  ...
  *c130_inData)
{
  ...
  const mxArray *c130_y = NULL;
  SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  chartInstance = (SFc130_ICARO3_Onda_simple_v2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c130_ICARO3_Onda_simple_v2_get_eml_resolved_functions_info
  (void)
{
   ...
   *c130_b_is_active_c130_ICARO3_Onda_simple_v2, const char_T *c130_identifier)
{
  ...
  c130_y = c130_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c130_b_is_active_c130_ICARO3_Onda_simple_v2), &c130_thisId);
  sf_mex_destroy(&c130_b_is_active_c130_ICARO3_Onda_simple_v2);
  return c130_y;
}
...
void sf_c130_ICARO3_Onda_simple_v2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c130_ICARO3_Onda_simple_v2_get_autoinheritance_info(void)
{
...
mxArray *sf_c130_ICARO3_Onda_simple_v2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c130_ICARO3_Onda_simple_v2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c130_ICARO3_Onda_simple_v2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c130_ICARO3_Onda_simple_v2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c130_ICARO3_Onda_simple_v2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c130_ICARO3_Onda_simple_v2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc130_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c130_ICARO3_Onda_simple_v2
    ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
  initialize_c130_ICARO3_Onda_simple_v2
    ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c130_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  enable_c130_ICARO3_Onda_simple_v2((SFc130_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c130_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  disable_c130_ICARO3_Onda_simple_v2((SFc130_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c130_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  sf_gateway_c130_ICARO3_Onda_simple_v2
    ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c130_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c130_ICARO3_Onda_simple_v2
    ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c130_ICARO3_Onda_simple_v2();/* state var info */
...
extern void sf_internal_set_sim_state_c130_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c130_ICARO3_Onda_simple_v2();/* state var info */
  ...
  set_sim_state_c130_ICARO3_Onda_simple_v2
    ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c130_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c130_ICARO3_Onda_simple_v2(S);
}

static void sf_opaque_set_sim_state_c130_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c130_ICARO3_Onda_simple_v2(S, st);
}

static void sf_opaque_terminate_c130_ICARO3_Onda_simple_v2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c130_ICARO3_Onda_simple_v2
      ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc130_ICARO3_Onda_simple_v2
    ((SFc130_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c130_ICARO3_Onda_simple_v2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c130_ICARO3_Onda_simple_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c130_ICARO3_Onda_simple_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c130_ICARO3_Onda_simple_v2(SimStruct *S)
{
  SFc130_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc130_ICARO3_Onda_simple_v2InstanceStruct *)utMalloc(sizeof
    (SFc130_ICARO3_Onda_simple_v2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc130_ICARO3_Onda_simple_v2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlStart = mdlStart_c130_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c130_ICARO3_Onda_simple_v2;
...
void c130_ICARO3_Onda_simple_v2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c130_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c130_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c130_ICARO3_Onda_simple_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c130_ICARO3_Onda_simple_v2_method_dispatcher.\n"
