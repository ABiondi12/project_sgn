...
static void initialize_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initialize_params_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void enable_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void disable_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void c71_update_debugger_state_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void set_sim_state_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance, const mxArray
   *c71_st);
static void finalize_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void sf_gateway_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void c71_chartstep_c71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void initSimStructsc71_ICARO3_Onda_simple_v2
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
...
static const mxArray *c71_sf_marshallOut(void *chartInstanceVoid, void
  *c71_inData);
static real_T c71_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_b_ini, const char_T *c71_identifier);
static real_T c71_b_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
...
static const mxArray *c71_b_sf_marshallOut(void *chartInstanceVoid, void
  *c71_inData);
static void c71_c_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_e_m, const char_T *c71_identifier, real32_T
  c71_y[3]);
static void c71_d_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId,
  real32_T c71_y[3]);
...
static const mxArray *c71_c_sf_marshallOut(void *chartInstanceVoid, void
  *c71_inData);
static void c71_e_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_q_out, const char_T *c71_identifier,
  real32_T c71_y[4]);
static void c71_f_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId,
  real32_T c71_y[4]);
...
static const mxArray *c71_d_sf_marshallOut(void *chartInstanceVoid, void
  *c71_inData);
static real32_T c71_g_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId);
...
static const mxArray *c71_e_sf_marshallOut(void *chartInstanceVoid, void
  *c71_inData);
static real_T c71_h_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId);
...
static const mxArray *c71_f_sf_marshallOut(void *chartInstanceVoid, void
  *c71_inData);
static void c71_i_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId,
  real32_T c71_y[9]);
...
static real32_T c71_norm(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, real32_T c71_x[3]);
static real32_T c71_eml_xnrm2(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, real32_T c71_x[3]);
static real32_T c71_abs(SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance,
  real32_T c71_x);
static void c71_qtriad(SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance,
  real32_T c71_acc[3], real32_T c71_mag[3], real32_T c71_q_out[4]);
static real32_T c71_mpower(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, real32_T c71_a);
static void c71_eml_scalar_eg(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance);
static real32_T c71_sqrt(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, real32_T c71_x);
static void c71_eml_error(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance);
static void c71_cross(SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance,
                      real32_T c71_a[3], real32_T c71_b[3], real32_T c71_c[3]);
static void c71_b_cross(SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance,
  real_T c71_a[3], real32_T c71_b[3], real32_T c71_c[3]);
static void c71_eps(SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance);
static void c71_b_eml_scalar_eg(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance);
static void c71_eml_xgemm(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, real32_T c71_A[9], real32_T c71_B[3], real32_T c71_C[3],
  real32_T c71_b_C[3]);
static void c71_c_cross(SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance,
  real32_T c71_a[3], real_T c71_b[3], real32_T c71_c[3]);
static real32_T c71_atan2(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, real32_T c71_y, real32_T c71_x);
static const mxArray *c71_h_sf_marshallOut(void *chartInstanceVoid, void
  *c71_inData);
static int32_T c71_j_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct *
  chartInstance, const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId);
static void c71_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c71_mxArrayInData, const char_T *c71_varName, void *c71_outData);
static uint8_T c71_k_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct *
  chartInstance, const mxArray *c71_b_is_active_c71_ICARO3_Onda_simple_v2, const
  char_T *c71_identifier);
static uint8_T c71_l_emlrt_marshallIn(SFc71_ICARO3_Onda_simple_v2InstanceStruct *
  chartInstance, const mxArray *c71_u, const emlrtMsgIdentifier *c71_parentId);
static void c71_b_sqrt(SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance,
  real32_T *c71_x);
static void c71_b_eml_xgemm(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance, real32_T c71_A[9], real32_T c71_B[3], real32_T c71_C[3]);
static void init_dsm_address_info(SFc71_ICARO3_Onda_simple_v2InstanceStruct
  *chartInstance);
  ...
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c71_is_active_c71_ICARO3_Onda_simple_v2 = 0U;
}
  ...
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  c71_b_hoistedGlobal = chartInstance->c71_is_active_c71_ICARO3_Onda_simple_v2;
   ...
   *c71_st)
{
  ...
  chartInstance->c71_is_active_c71_ICARO3_Onda_simple_v2 =
    c71_k_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c71_u, 8)),
    "is_active_c71_ICARO3_Onda_simple_v2");
  sf_mex_destroy(&c71_u);
  c71_update_debugger_state_c71_ICARO3_Onda_simple_v2(chartInstance);
  ...
  (SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c71_sfEvent = CALL_EVENT;
  c71_chartstep_c71_ICARO3_Onda_simple_v2(chartInstance);
  ...
  *c71_inData)
{
  ...
  const mxArray *c71_y = NULL;
  SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  chartInstance = (SFc71_ICARO3_Onda_simple_v2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c71_ICARO3_Onda_simple_v2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c71_identifier)
{
  ...
  c71_y = c71_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c71_b_is_active_c71_ICARO3_Onda_simple_v2), &c71_thisId);
  sf_mex_destroy(&c71_b_is_active_c71_ICARO3_Onda_simple_v2);
  return c71_y;
}
...
void sf_c71_ICARO3_Onda_simple_v2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c71_ICARO3_Onda_simple_v2_get_autoinheritance_info(void)
{
...
mxArray *sf_c71_ICARO3_Onda_simple_v2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c71_ICARO3_Onda_simple_v2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[20],T\"a_ned\",},{M[1],M[14],T\"biases\",},{M[1],M[13],T\"e_int_out_a\",},{M[1],M[23],T\"e_int_out_m\",},{M[1],M[24],T\"e_m\",},{M[1],M[19],T\"euler_out\",},{M[1],M[8],T\"q_out\",},{M[4],M[0],T\"ini\",S'l','i','p'{{M1x2[150 153],M[0],}}},{M[8],M[0],T\"is_active_c71_ICARO3_Onda_simple_v2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c71_ICARO3_Onda_simple_v2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc71_ICARO3_Onda_simple_v2InstanceStruct *)
...
static void sf_opaque_initialize_c71_ICARO3_Onda_simple_v2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc71_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c71_ICARO3_Onda_simple_v2
    ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
  initialize_c71_ICARO3_Onda_simple_v2
    ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c71_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  enable_c71_ICARO3_Onda_simple_v2((SFc71_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c71_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  disable_c71_ICARO3_Onda_simple_v2((SFc71_ICARO3_Onda_simple_v2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c71_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  sf_gateway_c71_ICARO3_Onda_simple_v2
    ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c71_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c71_ICARO3_Onda_simple_v2
    ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2();/* state var info */
...
extern void sf_internal_set_sim_state_c71_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2();/* state var info */
  ...
  set_sim_state_c71_ICARO3_Onda_simple_v2
    ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c71_ICARO3_Onda_simple_v2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c71_ICARO3_Onda_simple_v2(S);
}

static void sf_opaque_set_sim_state_c71_ICARO3_Onda_simple_v2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c71_ICARO3_Onda_simple_v2(S, st);
}

static void sf_opaque_terminate_c71_ICARO3_Onda_simple_v2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c71_ICARO3_Onda_simple_v2
      ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc71_ICARO3_Onda_simple_v2
    ((SFc71_ICARO3_Onda_simple_v2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c71_ICARO3_Onda_simple_v2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c71_ICARO3_Onda_simple_v2(SimStruct *S)
{
...
static void mdlRTW_c71_ICARO3_Onda_simple_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c71_ICARO3_Onda_simple_v2(SimStruct *S)
{
  SFc71_ICARO3_Onda_simple_v2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc71_ICARO3_Onda_simple_v2InstanceStruct *)utMalloc(sizeof
    (SFc71_ICARO3_Onda_simple_v2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc71_ICARO3_Onda_simple_v2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlStart = mdlStart_c71_ICARO3_Onda_simple_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c71_ICARO3_Onda_simple_v2;
...
void c71_ICARO3_Onda_simple_v2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c71_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c71_ICARO3_Onda_simple_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c71_ICARO3_Onda_simple_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c71_ICARO3_Onda_simple_v2_method_dispatcher.\n"
