...
static void initialize_c102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void initialize_params_c102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void enable_c102_ICARO3_Onda_bipe(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void disable_c102_ICARO3_Onda_bipe(SFc102_ICARO3_Onda_bipeInstanceStruct *
  chartInstance);
static void c102_update_debugger_state_c102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void set_sim_state_c102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c102_st);
static void finalize_c102_ICARO3_Onda_bipe(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void sf_gateway_c102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void c102_chartstep_c102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void initSimStructsc102_ICARO3_Onda_bipe
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance);
...
static const mxArray *c102_sf_marshallOut(void *chartInstanceVoid, void
  *c102_inData);
static void c102_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_params, const char_T *c102_identifier,
  real32_T c102_y[11]);
static void c102_b_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_u, const emlrtMsgIdentifier *c102_parentId,
  real32_T c102_y[11]);
...
static const mxArray *c102_c_sf_marshallOut(void *chartInstanceVoid, void
  *c102_inData);
static real_T c102_c_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_u, const emlrtMsgIdentifier *c102_parentId);
...
static const mxArray *c102_d_sf_marshallOut(void *chartInstanceVoid, void
  *c102_inData);
static real32_T c102_d_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_u, const emlrtMsgIdentifier *c102_parentId);
...
static const mxArray *c102_e_sf_marshallOut(void *chartInstanceVoid, void
  *c102_inData);
static uint16_T c102_e_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_u, const emlrtMsgIdentifier *c102_parentId);
...
static real32_T c102_decomp(SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance,
  uint16_T c102_u);
static const mxArray *c102_f_sf_marshallOut(void *chartInstanceVoid, void
  *c102_inData);
static int32_T c102_f_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_u, const emlrtMsgIdentifier *c102_parentId);
static void c102_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c102_mxArrayInData, const char_T *c102_varName, void *c102_outData);
static uint8_T c102_g_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_b_is_active_c102_ICARO3_Onda_bipe, const
  char_T *c102_identifier);
static uint8_T c102_h_emlrt_marshallIn(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c102_u, const emlrtMsgIdentifier *c102_parentId);
static void init_dsm_address_info(SFc102_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
  ...
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c102_is_active_c102_ICARO3_Onda_bipe = 0U;
}
  ...
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  c102_hoistedGlobal = chartInstance->c102_is_active_c102_ICARO3_Onda_bipe;
  ...
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c102_st)
{
  ...
  chartInstance->c102_is_active_c102_ICARO3_Onda_bipe = c102_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c102_u, 1)),
     "is_active_c102_ICARO3_Onda_bipe");
  sf_mex_destroy(&c102_u);
  c102_update_debugger_state_c102_ICARO3_Onda_bipe(chartInstance);
  ...
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 19U, chartInstance->c102_sfEvent);
  for (c102_i2 = 0; c102_i2 < 22; c102_i2++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*c102_bytes)[c102_i2], 0U);
  }

  chartInstance->c102_sfEvent = CALL_EVENT;
  c102_chartstep_c102_ICARO3_Onda_bipe(chartInstance);
  ...
  (SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 19U, chartInstance->c102_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 19U, chartInstance->c102_sfEvent);
}
  ...
  *c102_inData)
{
  ...
  const mxArray *c102_y = NULL;
  SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  chartInstance = (SFc102_ICARO3_Onda_bipeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c102_ICARO3_Onda_bipe_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c102_identifier)
{
  ...
  c102_y = c102_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c102_b_is_active_c102_ICARO3_Onda_bipe), &c102_thisId);
  sf_mex_destroy(&c102_b_is_active_c102_ICARO3_Onda_bipe);
  return c102_y;
}
...
void sf_c102_ICARO3_Onda_bipe_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c102_ICARO3_Onda_bipe_get_autoinheritance_info(void)
{
...
mxArray *sf_c102_ICARO3_Onda_bipe_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c102_ICARO3_Onda_bipe_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c102_ICARO3_Onda_bipe(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"params\",},{M[8],M[0],T\"is_active_c102_ICARO3_Onda_bipe\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c102_ICARO3_Onda_bipe_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc102_ICARO3_Onda_bipeInstanceStruct *)
...
static void sf_opaque_initialize_c102_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
  initialize_c102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c102_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  enable_c102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c102_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  disable_c102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c102_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  sf_gateway_c102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c102_ICARO3_Onda_bipe(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c102_ICARO3_Onda_bipe
    ((SFc102_ICARO3_Onda_bipeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c102_ICARO3_Onda_bipe();/* state var info */
...
extern void sf_internal_set_sim_state_c102_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c102_ICARO3_Onda_bipe();/* state var info */
  ...
  set_sim_state_c102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c102_ICARO3_Onda_bipe(SimStruct* S)
{
  return sf_internal_get_sim_state_c102_ICARO3_Onda_bipe(S);
}

static void sf_opaque_set_sim_state_c102_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c102_ICARO3_Onda_bipe(S, st);
}

static void sf_opaque_terminate_c102_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc102_ICARO3_Onda_bipeInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc102_ICARO3_Onda_bipe((SFc102_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c102_ICARO3_Onda_bipe(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c102_ICARO3_Onda_bipe
      ((SFc102_ICARO3_Onda_bipeInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c102_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c102_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c102_ICARO3_Onda_bipe(SimStruct *S)
{
  SFc102_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc102_ICARO3_Onda_bipeInstanceStruct *)utMalloc(sizeof
    (SFc102_ICARO3_Onda_bipeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc102_ICARO3_Onda_bipeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlStart = mdlStart_c102_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c102_ICARO3_Onda_bipe;
...
void c102_ICARO3_Onda_bipe_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c102_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c102_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c102_ICARO3_Onda_bipe(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c102_ICARO3_Onda_bipe_method_dispatcher.\n"
