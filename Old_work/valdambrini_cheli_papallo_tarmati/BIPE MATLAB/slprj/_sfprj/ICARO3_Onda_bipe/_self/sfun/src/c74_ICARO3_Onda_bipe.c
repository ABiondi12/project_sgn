...
static void initialize_c74_ICARO3_Onda_bipe(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void initialize_params_c74_ICARO3_Onda_bipe
  (SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void enable_c74_ICARO3_Onda_bipe(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void disable_c74_ICARO3_Onda_bipe(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void c74_update_debugger_state_c74_ICARO3_Onda_bipe
  (SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c74_ICARO3_Onda_bipe
  (SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void set_sim_state_c74_ICARO3_Onda_bipe
  (SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c74_st);
static void finalize_c74_ICARO3_Onda_bipe(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void sf_gateway_c74_ICARO3_Onda_bipe(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void initSimStructsc74_ICARO3_Onda_bipe
  (SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance);
...
static const mxArray *c74_sf_marshallOut(void *chartInstanceVoid, void
  *c74_inData);
static real_T c74_emlrt_marshallIn(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c74_theta, const char_T *c74_identifier);
static real_T c74_b_emlrt_marshallIn(SFc74_ICARO3_Onda_bipeInstanceStruct
...
static const mxArray *c74_c_sf_marshallOut(void *chartInstanceVoid, void
  *c74_inData);
static int32_T c74_c_emlrt_marshallIn(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c74_u, const emlrtMsgIdentifier *c74_parentId);
static void c74_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c74_mxArrayInData, const char_T *c74_varName, void *c74_outData);
static uint8_T c74_d_emlrt_marshallIn(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c74_b_is_active_c74_ICARO3_Onda_bipe, const
  char_T *c74_identifier);
static uint8_T c74_e_emlrt_marshallIn(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c74_u, const emlrtMsgIdentifier *c74_parentId);
static void init_dsm_address_info(SFc74_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c74_is_active_c74_ICARO3_Onda_bipe = 0U;
}
  ...
  (SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  c74_b_hoistedGlobal = chartInstance->c74_is_active_c74_ICARO3_Onda_bipe;
  ...
  (SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c74_st)
{
  ...
  *c74_theta = c74_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c74_u, 0)), "theta");
  chartInstance->c74_is_active_c74_ICARO3_Onda_bipe = c74_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c74_u, 1)),
     "is_active_c74_ICARO3_Onda_bipe");
  sf_mex_destroy(&c74_u);
  c74_update_debugger_state_c74_ICARO3_Onda_bipe(chartInstance);
  ...
  *c74_inData)
{
  ...
  const mxArray *c74_y = NULL;
  SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  chartInstance = (SFc74_ICARO3_Onda_bipeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c74_ICARO3_Onda_bipe_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c74_identifier)
{
  ...
  c74_y = c74_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c74_b_is_active_c74_ICARO3_Onda_bipe), &c74_thisId);
  sf_mex_destroy(&c74_b_is_active_c74_ICARO3_Onda_bipe);
  return c74_y;
}
...
void sf_c74_ICARO3_Onda_bipe_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c74_ICARO3_Onda_bipe_get_autoinheritance_info(void)
{
...
mxArray *sf_c74_ICARO3_Onda_bipe_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c74_ICARO3_Onda_bipe_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c74_ICARO3_Onda_bipe(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"theta\",},{M[8],M[0],T\"is_active_c74_ICARO3_Onda_bipe\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c74_ICARO3_Onda_bipe_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc74_ICARO3_Onda_bipeInstanceStruct *)
...
static void sf_opaque_initialize_c74_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
  initialize_c74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c74_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  enable_c74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c74_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  disable_c74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c74_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  sf_gateway_c74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c74_ICARO3_Onda_bipe(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c74_ICARO3_Onda_bipe
    ((SFc74_ICARO3_Onda_bipeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c74_ICARO3_Onda_bipe();/* state var info */
...
extern void sf_internal_set_sim_state_c74_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c74_ICARO3_Onda_bipe();/* state var info */
  ...
  set_sim_state_c74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c74_ICARO3_Onda_bipe(SimStruct* S)
{
  return sf_internal_get_sim_state_c74_ICARO3_Onda_bipe(S);
}

static void sf_opaque_set_sim_state_c74_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c74_ICARO3_Onda_bipe(S, st);
}

static void sf_opaque_terminate_c74_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc74_ICARO3_Onda_bipeInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc74_ICARO3_Onda_bipe((SFc74_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c74_ICARO3_Onda_bipe(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c74_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c74_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c74_ICARO3_Onda_bipe(SimStruct *S)
{
  SFc74_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc74_ICARO3_Onda_bipeInstanceStruct *)utMalloc(sizeof
    (SFc74_ICARO3_Onda_bipeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc74_ICARO3_Onda_bipeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlStart = mdlStart_c74_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c74_ICARO3_Onda_bipe;
...
void c74_ICARO3_Onda_bipe_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c74_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c74_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c74_ICARO3_Onda_bipe(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c74_ICARO3_Onda_bipe_method_dispatcher.\n"
