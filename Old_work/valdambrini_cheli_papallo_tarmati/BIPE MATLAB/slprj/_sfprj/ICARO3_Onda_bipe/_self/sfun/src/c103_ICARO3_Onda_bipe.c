...
static void initialize_c103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void initialize_params_c103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void enable_c103_ICARO3_Onda_bipe(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void disable_c103_ICARO3_Onda_bipe(SFc103_ICARO3_Onda_bipeInstanceStruct *
  chartInstance);
static void c103_update_debugger_state_c103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void set_sim_state_c103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c103_st);
static void finalize_c103_ICARO3_Onda_bipe(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void sf_gateway_c103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void c103_chartstep_c103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void initSimStructsc103_ICARO3_Onda_bipe
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance);
...
static const mxArray *c103_sf_marshallOut(void *chartInstanceVoid, void
  *c103_inData);
static void c103_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_w, const char_T *c103_identifier, real32_T
  c103_y[3]);
static void c103_b_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_u, const emlrtMsgIdentifier *c103_parentId,
  real32_T c103_y[3]);
...
static const mxArray *c103_c_sf_marshallOut(void *chartInstanceVoid, void
  *c103_inData);
static real_T c103_c_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_u, const emlrtMsgIdentifier *c103_parentId);
...
static const mxArray *c103_d_sf_marshallOut(void *chartInstanceVoid, void
  *c103_inData);
static real32_T c103_d_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_u, const emlrtMsgIdentifier *c103_parentId);
...
static const mxArray *c103_e_sf_marshallOut(void *chartInstanceVoid, void
  *c103_inData);
static uint16_T c103_e_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_u, const emlrtMsgIdentifier *c103_parentId);
...
static real32_T c103_decomp(SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance,
  uint16_T c103_u);
static void c103_eml_scalar_eg(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static const mxArray *c103_f_sf_marshallOut(void *chartInstanceVoid, void
  *c103_inData);
static int32_T c103_f_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_u, const emlrtMsgIdentifier *c103_parentId);
static void c103_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c103_mxArrayInData, const char_T *c103_varName, void *c103_outData);
static uint8_T c103_g_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_b_is_active_c103_ICARO3_Onda_bipe, const
  char_T *c103_identifier);
static uint8_T c103_h_emlrt_marshallIn(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c103_u, const emlrtMsgIdentifier *c103_parentId);
static void init_dsm_address_info(SFc103_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
  ...
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c103_is_active_c103_ICARO3_Onda_bipe = 0U;
}
  ...
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  c103_hoistedGlobal = chartInstance->c103_is_active_c103_ICARO3_Onda_bipe;
  ...
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c103_st)
{
  ...
  chartInstance->c103_is_active_c103_ICARO3_Onda_bipe = c103_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c103_u, 2)),
     "is_active_c103_ICARO3_Onda_bipe");
  sf_mex_destroy(&c103_u);
  c103_update_debugger_state_c103_ICARO3_Onda_bipe(chartInstance);
  ...
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 20U, chartInstance->c103_sfEvent);
  for (c103_i4 = 0; c103_i4 < 6; c103_i4++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*c103_u)[c103_i4], 0U);
  }

  chartInstance->c103_sfEvent = CALL_EVENT;
  c103_chartstep_c103_ICARO3_Onda_bipe(chartInstance);
  ...
  (SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 20U, chartInstance->c103_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 20U, chartInstance->c103_sfEvent);
}
  ...
  *c103_inData)
{
  ...
  const mxArray *c103_y = NULL;
  SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  chartInstance = (SFc103_ICARO3_Onda_bipeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c103_ICARO3_Onda_bipe_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c103_identifier)
{
  ...
  c103_y = c103_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c103_b_is_active_c103_ICARO3_Onda_bipe), &c103_thisId);
  sf_mex_destroy(&c103_b_is_active_c103_ICARO3_Onda_bipe);
  return c103_y;
}
...
void sf_c103_ICARO3_Onda_bipe_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c103_ICARO3_Onda_bipe_get_autoinheritance_info(void)
{
...
mxArray *sf_c103_ICARO3_Onda_bipe_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c103_ICARO3_Onda_bipe_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c103_ICARO3_Onda_bipe(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[1],M[13],T\"w\",},{M[8],M[0],T\"is_active_c103_ICARO3_Onda_bipe\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c103_ICARO3_Onda_bipe_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc103_ICARO3_Onda_bipeInstanceStruct *)
...
static void sf_opaque_initialize_c103_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
  initialize_c103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c103_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  enable_c103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c103_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  disable_c103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c103_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  sf_gateway_c103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c103_ICARO3_Onda_bipe(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c103_ICARO3_Onda_bipe
    ((SFc103_ICARO3_Onda_bipeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c103_ICARO3_Onda_bipe();/* state var info */
...
extern void sf_internal_set_sim_state_c103_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c103_ICARO3_Onda_bipe();/* state var info */
  ...
  set_sim_state_c103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c103_ICARO3_Onda_bipe(SimStruct* S)
{
  return sf_internal_get_sim_state_c103_ICARO3_Onda_bipe(S);
}

static void sf_opaque_set_sim_state_c103_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c103_ICARO3_Onda_bipe(S, st);
}

static void sf_opaque_terminate_c103_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc103_ICARO3_Onda_bipeInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc103_ICARO3_Onda_bipe((SFc103_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c103_ICARO3_Onda_bipe(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c103_ICARO3_Onda_bipe
      ((SFc103_ICARO3_Onda_bipeInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c103_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c103_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c103_ICARO3_Onda_bipe(SimStruct *S)
{
  SFc103_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc103_ICARO3_Onda_bipeInstanceStruct *)utMalloc(sizeof
    (SFc103_ICARO3_Onda_bipeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc103_ICARO3_Onda_bipeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlStart = mdlStart_c103_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c103_ICARO3_Onda_bipe;
...
void c103_ICARO3_Onda_bipe_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c103_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c103_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c103_ICARO3_Onda_bipe(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c103_ICARO3_Onda_bipe_method_dispatcher.\n"
