...
static void initialize_c135_ICARO3_Onda_bipe
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void initialize_params_c135_ICARO3_Onda_bipe
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void enable_c135_ICARO3_Onda_bipe(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void disable_c135_ICARO3_Onda_bipe(SFc135_ICARO3_Onda_bipeInstanceStruct *
  chartInstance);
static void c135_update_debugger_state_c135_ICARO3_Onda_bipe
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c135_ICARO3_Onda_bipe
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void set_sim_state_c135_ICARO3_Onda_bipe
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c135_st);
static void finalize_c135_ICARO3_Onda_bipe(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void sf_gateway_c135_ICARO3_Onda_bipe
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void initSimStructsc135_ICARO3_Onda_bipe
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance);
...
static const mxArray *c135_sf_marshallOut(void *chartInstanceVoid, void
  *c135_inData);
static void c135_emlrt_marshallIn(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c135_y, const char_T *c135_identifier, uint8_T
  c135_b_y[2]);
static void c135_b_emlrt_marshallIn(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c135_u, const emlrtMsgIdentifier *c135_parentId,
  uint8_T c135_y[2]);
...
static const mxArray *c135_c_sf_marshallOut(void *chartInstanceVoid, void
  *c135_inData);
static real_T c135_c_emlrt_marshallIn(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c135_u, const emlrtMsgIdentifier *c135_parentId);
...
static const mxArray *c135_d_sf_marshallOut(void *chartInstanceVoid, void
  *c135_inData);
static int32_T c135_d_emlrt_marshallIn(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c135_u, const emlrtMsgIdentifier *c135_parentId);
static void c135_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c135_mxArrayInData, const char_T *c135_varName, void *c135_outData);
static uint8_T c135_e_emlrt_marshallIn(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c135_b_is_active_c135_ICARO3_Onda_bipe, const
  char_T *c135_identifier);
static uint8_T c135_f_emlrt_marshallIn(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c135_u, const emlrtMsgIdentifier *c135_parentId);
static void init_dsm_address_info(SFc135_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
  ...
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c135_is_active_c135_ICARO3_Onda_bipe = 0U;
}
  ...
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  c135_hoistedGlobal = chartInstance->c135_is_active_c135_ICARO3_Onda_bipe;
  ...
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c135_st)
{
  ...
  chartInstance->c135_is_active_c135_ICARO3_Onda_bipe = c135_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c135_u, 1)),
     "is_active_c135_ICARO3_Onda_bipe");
  sf_mex_destroy(&c135_u);
  c135_update_debugger_state_c135_ICARO3_Onda_bipe(chartInstance);
  ...
  (SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 36U, chartInstance->c135_sfEvent);
  _SFD_DATA_RANGE_CHECK((real_T)*c135_b_u, 0U);
  chartInstance->c135_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 36U, chartInstance->c135_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 36U, chartInstance->c135_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c135_inData)
{
  ...
  const mxArray *c135_y = NULL;
  SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  chartInstance = (SFc135_ICARO3_Onda_bipeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c135_ICARO3_Onda_bipe_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c135_identifier)
{
  ...
  c135_y = c135_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c135_b_is_active_c135_ICARO3_Onda_bipe), &c135_thisId);
  sf_mex_destroy(&c135_b_is_active_c135_ICARO3_Onda_bipe);
  return c135_y;
}
...
void sf_c135_ICARO3_Onda_bipe_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c135_ICARO3_Onda_bipe_get_autoinheritance_info(void)
{
...
mxArray *sf_c135_ICARO3_Onda_bipe_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c135_ICARO3_Onda_bipe_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c135_ICARO3_Onda_bipe(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c135_ICARO3_Onda_bipe\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c135_ICARO3_Onda_bipe_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc135_ICARO3_Onda_bipeInstanceStruct *)
...
static void sf_opaque_initialize_c135_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
  initialize_c135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c135_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  enable_c135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c135_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  disable_c135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c135_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  sf_gateway_c135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c135_ICARO3_Onda_bipe(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c135_ICARO3_Onda_bipe
    ((SFc135_ICARO3_Onda_bipeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c135_ICARO3_Onda_bipe();/* state var info */
...
extern void sf_internal_set_sim_state_c135_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c135_ICARO3_Onda_bipe();/* state var info */
  ...
  set_sim_state_c135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c135_ICARO3_Onda_bipe(SimStruct* S)
{
  return sf_internal_get_sim_state_c135_ICARO3_Onda_bipe(S);
}

static void sf_opaque_set_sim_state_c135_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c135_ICARO3_Onda_bipe(S, st);
}

static void sf_opaque_terminate_c135_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc135_ICARO3_Onda_bipeInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc135_ICARO3_Onda_bipe((SFc135_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c135_ICARO3_Onda_bipe(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c135_ICARO3_Onda_bipe
      ((SFc135_ICARO3_Onda_bipeInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c135_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c135_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c135_ICARO3_Onda_bipe(SimStruct *S)
{
  SFc135_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc135_ICARO3_Onda_bipeInstanceStruct *)utMalloc(sizeof
    (SFc135_ICARO3_Onda_bipeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc135_ICARO3_Onda_bipeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlStart = mdlStart_c135_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c135_ICARO3_Onda_bipe;
...
void c135_ICARO3_Onda_bipe_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c135_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c135_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c135_ICARO3_Onda_bipe(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c135_ICARO3_Onda_bipe_method_dispatcher.\n"
