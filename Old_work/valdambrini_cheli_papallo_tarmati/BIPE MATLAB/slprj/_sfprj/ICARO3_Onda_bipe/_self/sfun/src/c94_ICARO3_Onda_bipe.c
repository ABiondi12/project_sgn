...
static void initialize_c94_ICARO3_Onda_bipe(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void initialize_params_c94_ICARO3_Onda_bipe
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void enable_c94_ICARO3_Onda_bipe(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void disable_c94_ICARO3_Onda_bipe(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void c94_update_debugger_state_c94_ICARO3_Onda_bipe
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c94_ICARO3_Onda_bipe
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void set_sim_state_c94_ICARO3_Onda_bipe
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c94_st);
static void finalize_c94_ICARO3_Onda_bipe(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void sf_gateway_c94_ICARO3_Onda_bipe(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void c94_chartstep_c94_ICARO3_Onda_bipe
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void initSimStructsc94_ICARO3_Onda_bipe
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance);
...
static const mxArray *c94_sf_marshallOut(void *chartInstanceVoid, void
  *c94_inData);
static real32_T c94_emlrt_marshallIn(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c94_h, const char_T *c94_identifier);
static real32_T c94_b_emlrt_marshallIn(SFc94_ICARO3_Onda_bipeInstanceStruct
...
static const mxArray *c94_d_sf_marshallOut(void *chartInstanceVoid, void
  *c94_inData);
static real_T c94_c_emlrt_marshallIn(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c94_u, const emlrtMsgIdentifier *c94_parentId);
...
static real32_T c94_mpower(SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance,
  real_T c94_a, real32_T c94_b);
static void c94_eml_scalar_eg(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static void c94_eml_error(SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance);
static void c94_b_eml_scalar_eg(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
static const mxArray *c94_e_sf_marshallOut(void *chartInstanceVoid, void
  *c94_inData);
static int32_T c94_d_emlrt_marshallIn(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c94_u, const emlrtMsgIdentifier *c94_parentId);
static void c94_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c94_mxArrayInData, const char_T *c94_varName, void *c94_outData);
static uint8_T c94_e_emlrt_marshallIn(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c94_b_is_active_c94_ICARO3_Onda_bipe, const
  char_T *c94_identifier);
static uint8_T c94_f_emlrt_marshallIn(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance, const mxArray *c94_u, const emlrtMsgIdentifier *c94_parentId);
static void init_dsm_address_info(SFc94_ICARO3_Onda_bipeInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c94_is_active_c94_ICARO3_Onda_bipe = 0U;
}
  ...
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance)
{
  ...
  c94_c_hoistedGlobal = chartInstance->c94_is_active_c94_ICARO3_Onda_bipe;
  ...
  (SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance, const mxArray *c94_st)
{
  ...
  *c94_h = c94_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c94_u,
    1)), "h");
  chartInstance->c94_is_active_c94_ICARO3_Onda_bipe = c94_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c94_u, 2)),
     "is_active_c94_ICARO3_Onda_bipe");
  sf_mex_destroy(&c94_u);
  c94_update_debugger_state_c94_ICARO3_Onda_bipe(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c94_sfEvent = CALL_EVENT;
  c94_chartstep_c94_ICARO3_Onda_bipe(chartInstance);
  ...
  *c94_inData)
{
  ...
  const mxArray *c94_y = NULL;
  SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  chartInstance = (SFc94_ICARO3_Onda_bipeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c94_ICARO3_Onda_bipe_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c94_identifier)
{
  ...
  c94_y = c94_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c94_b_is_active_c94_ICARO3_Onda_bipe), &c94_thisId);
  sf_mex_destroy(&c94_b_is_active_c94_ICARO3_Onda_bipe);
  return c94_y;
}
...
void sf_c94_ICARO3_Onda_bipe_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c94_ICARO3_Onda_bipe_get_autoinheritance_info(void)
{
...
mxArray *sf_c94_ICARO3_Onda_bipe_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c94_ICARO3_Onda_bipe_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c94_ICARO3_Onda_bipe(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"T\",},{M[1],M[8],T\"h\",},{M[8],M[0],T\"is_active_c94_ICARO3_Onda_bipe\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c94_ICARO3_Onda_bipe_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc94_ICARO3_Onda_bipeInstanceStruct *)
...
static void sf_opaque_initialize_c94_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
  initialize_c94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c94_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  enable_c94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c94_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  disable_c94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c94_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  sf_gateway_c94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c94_ICARO3_Onda_bipe(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c94_ICARO3_Onda_bipe
    ((SFc94_ICARO3_Onda_bipeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c94_ICARO3_Onda_bipe();/* state var info */
...
extern void sf_internal_set_sim_state_c94_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c94_ICARO3_Onda_bipe();/* state var info */
  ...
  set_sim_state_c94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c94_ICARO3_Onda_bipe(SimStruct* S)
{
  return sf_internal_get_sim_state_c94_ICARO3_Onda_bipe(S);
}

static void sf_opaque_set_sim_state_c94_ICARO3_Onda_bipe(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c94_ICARO3_Onda_bipe(S, st);
}

static void sf_opaque_terminate_c94_ICARO3_Onda_bipe(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc94_ICARO3_Onda_bipeInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc94_ICARO3_Onda_bipe((SFc94_ICARO3_Onda_bipeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c94_ICARO3_Onda_bipe(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c94_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c94_ICARO3_Onda_bipe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c94_ICARO3_Onda_bipe(SimStruct *S)
{
  SFc94_ICARO3_Onda_bipeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc94_ICARO3_Onda_bipeInstanceStruct *)utMalloc(sizeof
    (SFc94_ICARO3_Onda_bipeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc94_ICARO3_Onda_bipeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlStart = mdlStart_c94_ICARO3_Onda_bipe;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c94_ICARO3_Onda_bipe;
...
void c94_ICARO3_Onda_bipe_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c94_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c94_ICARO3_Onda_bipe(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c94_ICARO3_Onda_bipe(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c94_ICARO3_Onda_bipe_method_dispatcher.\n"
