...
static void initialize_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void initialize_params_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void enable_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void disable_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void c72_update_debugger_state_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void set_sim_state_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance, const mxArray
   *c72_st);
static void finalize_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void sf_gateway_c72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void initSimStructsc72_ICARO3_Onda_bipe_yaw
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
...
static const mxArray *c72_sf_marshallOut(void *chartInstanceVoid, void
  *c72_inData);
static real_T c72_emlrt_marshallIn(SFc72_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c72_theta_out, const char_T *c72_identifier);
static real_T c72_b_emlrt_marshallIn(SFc72_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c72_u, const emlrtMsgIdentifier *c72_parentId);
...
static void c72_eml_scalar_eg(SFc72_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance);
static const mxArray *c72_b_sf_marshallOut(void *chartInstanceVoid, void
  *c72_inData);
static int32_T c72_c_emlrt_marshallIn(SFc72_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c72_u, const emlrtMsgIdentifier *c72_parentId);
static void c72_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c72_mxArrayInData, const char_T *c72_varName, void *c72_outData);
static uint8_T c72_d_emlrt_marshallIn(SFc72_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c72_b_is_active_c72_ICARO3_Onda_bipe_yaw, const
  char_T *c72_identifier);
static uint8_T c72_e_emlrt_marshallIn(SFc72_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c72_u, const emlrtMsgIdentifier *c72_parentId);
static void init_dsm_address_info(SFc72_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance);
  ...
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance)
{
  ...
  chartInstance->c72_is_active_c72_ICARO3_Onda_bipe_yaw = 0U;
}
  ...
  (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance)
{
  ...
  c72_b_hoistedGlobal = chartInstance->c72_is_active_c72_ICARO3_Onda_bipe_yaw;
   ...
   *c72_st)
{
  ...
  *c72_theta_out = c72_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c72_u, 0)), "theta_out");
  chartInstance->c72_is_active_c72_ICARO3_Onda_bipe_yaw = c72_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c72_u, 1)),
     "is_active_c72_ICARO3_Onda_bipe_yaw");
  sf_mex_destroy(&c72_u);
  c72_update_debugger_state_c72_ICARO3_Onda_bipe_yaw(chartInstance);
  ...
  *c72_inData)
{
  ...
  const mxArray *c72_y = NULL;
  SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance;
  chartInstance = (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c72_ICARO3_Onda_bipe_yaw_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c72_identifier)
{
  ...
  c72_y = c72_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c72_b_is_active_c72_ICARO3_Onda_bipe_yaw), &c72_thisId);
  sf_mex_destroy(&c72_b_is_active_c72_ICARO3_Onda_bipe_yaw);
  return c72_y;
}
...
void sf_c72_ICARO3_Onda_bipe_yaw_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c72_ICARO3_Onda_bipe_yaw_get_autoinheritance_info(void)
{
...
mxArray *sf_c72_ICARO3_Onda_bipe_yaw_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c72_ICARO3_Onda_bipe_yaw_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c72_ICARO3_Onda_bipe_yaw(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"theta_out\",},{M[8],M[0],T\"is_active_c72_ICARO3_Onda_bipe_yaw\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c72_ICARO3_Onda_bipe_yaw_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *)
...
static void sf_opaque_initialize_c72_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c72_ICARO3_Onda_bipe_yaw
    ((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
  initialize_c72_ICARO3_Onda_bipe_yaw((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c72_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  enable_c72_ICARO3_Onda_bipe_yaw((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c72_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  disable_c72_ICARO3_Onda_bipe_yaw((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c72_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  sf_gateway_c72_ICARO3_Onda_bipe_yaw((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c72_ICARO3_Onda_bipe_yaw
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c72_ICARO3_Onda_bipe_yaw
    ((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c72_ICARO3_Onda_bipe_yaw();/* state var info */
...
extern void sf_internal_set_sim_state_c72_ICARO3_Onda_bipe_yaw(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c72_ICARO3_Onda_bipe_yaw();/* state var info */
  ...
  set_sim_state_c72_ICARO3_Onda_bipe_yaw
    ((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c72_ICARO3_Onda_bipe_yaw(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c72_ICARO3_Onda_bipe_yaw(S);
}

static void sf_opaque_set_sim_state_c72_ICARO3_Onda_bipe_yaw(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c72_ICARO3_Onda_bipe_yaw(S, st);
}

static void sf_opaque_terminate_c72_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c72_ICARO3_Onda_bipe_yaw((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc72_ICARO3_Onda_bipe_yaw
    ((SFc72_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c72_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c72_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c72_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c72_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  SFc72_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc72_ICARO3_Onda_bipe_yawInstanceStruct *)utMalloc(sizeof
    (SFc72_ICARO3_Onda_bipe_yawInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc72_ICARO3_Onda_bipe_yawInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.mdlStart = mdlStart_c72_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c72_ICARO3_Onda_bipe_yaw;
...
void c72_ICARO3_Onda_bipe_yaw_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c72_ICARO3_Onda_bipe_yaw(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c72_ICARO3_Onda_bipe_yaw(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c72_ICARO3_Onda_bipe_yaw(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c72_ICARO3_Onda_bipe_yaw_method_dispatcher.\n"
