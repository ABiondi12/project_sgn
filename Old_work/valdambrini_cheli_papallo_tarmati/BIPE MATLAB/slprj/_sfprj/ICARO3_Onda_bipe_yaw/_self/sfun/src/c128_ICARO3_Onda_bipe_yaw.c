...
static void initialize_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void initialize_params_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void enable_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void disable_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void c128_update_debugger_state_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void set_sim_state_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance, const mxArray
   *c128_st);
static void finalize_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void sf_gateway_c128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void initSimStructsc128_ICARO3_Onda_bipe_yaw
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
...
static const mxArray *c128_sf_marshallOut(void *chartInstanceVoid, void
  *c128_inData);
static uint16_T c128_emlrt_marshallIn(SFc128_ICARO3_Onda_bipe_yawInstanceStruct *
  chartInstance, const mxArray *c128_y, const char_T *c128_identifier);
static uint16_T c128_b_emlrt_marshallIn
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance, const mxArray
   *c128_u, const emlrtMsgIdentifier *c128_parentId);
...
static const mxArray *c128_c_sf_marshallOut(void *chartInstanceVoid, void
  *c128_inData);
static real_T c128_c_emlrt_marshallIn(SFc128_ICARO3_Onda_bipe_yawInstanceStruct *
...
static const mxArray *c128_d_sf_marshallOut(void *chartInstanceVoid, void
  *c128_inData);
static int32_T c128_d_emlrt_marshallIn(SFc128_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c128_u, const emlrtMsgIdentifier *c128_parentId);
static void c128_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c128_mxArrayInData, const char_T *c128_varName, void *c128_outData);
static uint8_T c128_e_emlrt_marshallIn(SFc128_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c128_b_is_active_c128_ICARO3_Onda_bipe_yaw,
  const char_T *c128_identifier);
static uint8_T c128_f_emlrt_marshallIn(SFc128_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c128_u, const emlrtMsgIdentifier *c128_parentId);
static void init_dsm_address_info(SFc128_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance);
  ...
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance)
{
  ...
  chartInstance->c128_is_active_c128_ICARO3_Onda_bipe_yaw = 0U;
}
  ...
  (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance)
{
  ...
  c128_b_hoistedGlobal = chartInstance->c128_is_active_c128_ICARO3_Onda_bipe_yaw;
   ...
   *c128_st)
{
  ...
  *c128_y = c128_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c128_u, 0)), "y");
  chartInstance->c128_is_active_c128_ICARO3_Onda_bipe_yaw =
    c128_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c128_u, 1)),
    "is_active_c128_ICARO3_Onda_bipe_yaw");
  sf_mex_destroy(&c128_u);
  c128_update_debugger_state_c128_ICARO3_Onda_bipe_yaw(chartInstance);
  ...
  *c128_inData)
{
  ...
  const mxArray *c128_y = NULL;
  SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance;
  chartInstance = (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c128_ICARO3_Onda_bipe_yaw_get_eml_resolved_functions_info(void)
{
  ...
  const char_T *c128_identifier)
{
  ...
  c128_y = c128_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c128_b_is_active_c128_ICARO3_Onda_bipe_yaw), &c128_thisId);
  sf_mex_destroy(&c128_b_is_active_c128_ICARO3_Onda_bipe_yaw);
  return c128_y;
}
...
void sf_c128_ICARO3_Onda_bipe_yaw_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c128_ICARO3_Onda_bipe_yaw_get_autoinheritance_info(void)
{
...
mxArray *sf_c128_ICARO3_Onda_bipe_yaw_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c128_ICARO3_Onda_bipe_yaw_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c128_ICARO3_Onda_bipe_yaw(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c128_ICARO3_Onda_bipe_yaw\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c128_ICARO3_Onda_bipe_yaw_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *)
...
static void sf_opaque_initialize_c128_ICARO3_Onda_bipe_yaw(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c128_ICARO3_Onda_bipe_yaw
    ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
  initialize_c128_ICARO3_Onda_bipe_yaw
    ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c128_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  enable_c128_ICARO3_Onda_bipe_yaw((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c128_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  disable_c128_ICARO3_Onda_bipe_yaw((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c128_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  sf_gateway_c128_ICARO3_Onda_bipe_yaw
    ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c128_ICARO3_Onda_bipe_yaw
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c128_ICARO3_Onda_bipe_yaw
    ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c128_ICARO3_Onda_bipe_yaw();/* state var info */
...
extern void sf_internal_set_sim_state_c128_ICARO3_Onda_bipe_yaw(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c128_ICARO3_Onda_bipe_yaw();/* state var info */
  ...
  set_sim_state_c128_ICARO3_Onda_bipe_yaw
    ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c128_ICARO3_Onda_bipe_yaw
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c128_ICARO3_Onda_bipe_yaw(S);
}

static void sf_opaque_set_sim_state_c128_ICARO3_Onda_bipe_yaw(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c128_ICARO3_Onda_bipe_yaw(S, st);
}

static void sf_opaque_terminate_c128_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c128_ICARO3_Onda_bipe_yaw
      ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc128_ICARO3_Onda_bipe_yaw
    ((SFc128_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c128_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c128_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c128_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c128_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  SFc128_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc128_ICARO3_Onda_bipe_yawInstanceStruct *)utMalloc(sizeof
    (SFc128_ICARO3_Onda_bipe_yawInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc128_ICARO3_Onda_bipe_yawInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.mdlStart = mdlStart_c128_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c128_ICARO3_Onda_bipe_yaw;
...
void c128_ICARO3_Onda_bipe_yaw_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c128_ICARO3_Onda_bipe_yaw(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c128_ICARO3_Onda_bipe_yaw(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c128_ICARO3_Onda_bipe_yaw(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c128_ICARO3_Onda_bipe_yaw_method_dispatcher.\n"
