...
static void initialize_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void initialize_params_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void enable_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void disable_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void c73_update_debugger_state_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void set_sim_state_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance, const mxArray
   *c73_st);
static void finalize_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void sf_gateway_c73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
static void initSimStructsc73_ICARO3_Onda_bipe_yaw
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance);
...
static const mxArray *c73_sf_marshallOut(void *chartInstanceVoid, void
  *c73_inData);
static real_T c73_emlrt_marshallIn(SFc73_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c73_y, const char_T *c73_identifier);
static real_T c73_b_emlrt_marshallIn(SFc73_ICARO3_Onda_bipe_yawInstanceStruct
...
static real_T c73_eml_xnrm2(SFc73_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, real_T c73_x[2]);
static const mxArray *c73_c_sf_marshallOut(void *chartInstanceVoid, void
  *c73_inData);
static int32_T c73_c_emlrt_marshallIn(SFc73_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c73_u, const emlrtMsgIdentifier *c73_parentId);
static void c73_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c73_mxArrayInData, const char_T *c73_varName, void *c73_outData);
static uint8_T c73_d_emlrt_marshallIn(SFc73_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c73_b_is_active_c73_ICARO3_Onda_bipe_yaw, const
  char_T *c73_identifier);
static uint8_T c73_e_emlrt_marshallIn(SFc73_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance, const mxArray *c73_u, const emlrtMsgIdentifier *c73_parentId);
static void init_dsm_address_info(SFc73_ICARO3_Onda_bipe_yawInstanceStruct
  *chartInstance);
  ...
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance)
{
  ...
  chartInstance->c73_is_active_c73_ICARO3_Onda_bipe_yaw = 0U;
}
  ...
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance)
{
  ...
  c73_b_hoistedGlobal = chartInstance->c73_is_active_c73_ICARO3_Onda_bipe_yaw;
   ...
   *c73_st)
{
  ...
  *c73_y = c73_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c73_u,
    0)), "y");
  chartInstance->c73_is_active_c73_ICARO3_Onda_bipe_yaw = c73_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c73_u, 1)),
     "is_active_c73_ICARO3_Onda_bipe_yaw");
  sf_mex_destroy(&c73_u);
  c73_update_debugger_state_c73_ICARO3_Onda_bipe_yaw(chartInstance);
  ...
  (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 7U, chartInstance->c73_sfEvent);
  for (c73_i0 = 0; c73_i0 < 2; c73_i0++) {
    _SFD_DATA_RANGE_CHECK((*c73_b_u)[c73_i0], 0U);
  }

  chartInstance->c73_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 7U, chartInstance->c73_sfEvent);
  ...
  *c73_b_y = c73_y;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 7U, chartInstance->c73_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c73_inData)
{
  ...
  const mxArray *c73_y = NULL;
  SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance;
  chartInstance = (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c73_ICARO3_Onda_bipe_yaw_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c73_identifier)
{
  ...
  c73_y = c73_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c73_b_is_active_c73_ICARO3_Onda_bipe_yaw), &c73_thisId);
  sf_mex_destroy(&c73_b_is_active_c73_ICARO3_Onda_bipe_yaw);
  return c73_y;
}
...
void sf_c73_ICARO3_Onda_bipe_yaw_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c73_ICARO3_Onda_bipe_yaw_get_autoinheritance_info(void)
{
...
mxArray *sf_c73_ICARO3_Onda_bipe_yaw_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c73_ICARO3_Onda_bipe_yaw_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c73_ICARO3_Onda_bipe_yaw(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c73_ICARO3_Onda_bipe_yaw\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c73_ICARO3_Onda_bipe_yaw_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *)
...
static void sf_opaque_initialize_c73_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c73_ICARO3_Onda_bipe_yaw
    ((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
  initialize_c73_ICARO3_Onda_bipe_yaw((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c73_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  enable_c73_ICARO3_Onda_bipe_yaw((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c73_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  disable_c73_ICARO3_Onda_bipe_yaw((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c73_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  sf_gateway_c73_ICARO3_Onda_bipe_yaw((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c73_ICARO3_Onda_bipe_yaw
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c73_ICARO3_Onda_bipe_yaw
    ((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c73_ICARO3_Onda_bipe_yaw();/* state var info */
...
extern void sf_internal_set_sim_state_c73_ICARO3_Onda_bipe_yaw(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c73_ICARO3_Onda_bipe_yaw();/* state var info */
  ...
  set_sim_state_c73_ICARO3_Onda_bipe_yaw
    ((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c73_ICARO3_Onda_bipe_yaw(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c73_ICARO3_Onda_bipe_yaw(S);
}

static void sf_opaque_set_sim_state_c73_ICARO3_Onda_bipe_yaw(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c73_ICARO3_Onda_bipe_yaw(S, st);
}

static void sf_opaque_terminate_c73_ICARO3_Onda_bipe_yaw(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c73_ICARO3_Onda_bipe_yaw((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc73_ICARO3_Onda_bipe_yaw
    ((SFc73_ICARO3_Onda_bipe_yawInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c73_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c73_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c73_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c73_ICARO3_Onda_bipe_yaw(SimStruct *S)
{
  SFc73_ICARO3_Onda_bipe_yawInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc73_ICARO3_Onda_bipe_yawInstanceStruct *)utMalloc(sizeof
    (SFc73_ICARO3_Onda_bipe_yawInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc73_ICARO3_Onda_bipe_yawInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.mdlStart = mdlStart_c73_ICARO3_Onda_bipe_yaw;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c73_ICARO3_Onda_bipe_yaw;
...
void c73_ICARO3_Onda_bipe_yaw_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c73_ICARO3_Onda_bipe_yaw(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c73_ICARO3_Onda_bipe_yaw(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c73_ICARO3_Onda_bipe_yaw(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c73_ICARO3_Onda_bipe_yaw_method_dispatcher.\n"
