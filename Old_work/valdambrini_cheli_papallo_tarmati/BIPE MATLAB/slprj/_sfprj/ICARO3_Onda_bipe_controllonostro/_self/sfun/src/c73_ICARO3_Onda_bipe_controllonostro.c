...
static void initialize_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void initialize_params_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void enable_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void disable_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void c73_update_debugger_state_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void set_sim_state_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance, const
   mxArray *c73_st);
static void finalize_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void sf_gateway_c73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void initSimStructsc73_ICARO3_Onda_bipe_controllonostro
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
...
static real_T c73_eml_xnrm2(SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct
...
static uint8_T c73_d_emlrt_marshallIn
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance, const
   mxArray *c73_b_is_active_c73_ICARO3_Onda_bipe_controllonostro, const char_T
   *c73_identifier);
  ...
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance)
{
  ...
  chartInstance->c73_is_active_c73_ICARO3_Onda_bipe_controllonostro = 0U;
}
  ...
  (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance)
{
  ...
  c73_b_hoistedGlobal =
    chartInstance->c73_is_active_c73_ICARO3_Onda_bipe_controllonostro;
   ...
   mxArray *c73_st)
{
  ...
  *c73_y = c73_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c73_u,
  ...
  chartInstance->c73_is_active_c73_ICARO3_Onda_bipe_controllonostro =
    ...
    "is_active_c73_ICARO3_Onda_bipe_controllonostro");
  sf_mex_destroy(&c73_u);
  c73_update_debugger_state_c73_ICARO3_Onda_bipe_controllonostro(chartInstance);
  ...
  *c73_inData)
{
  ...
  const mxArray *c73_y = NULL;
  SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance;
  chartInstance = (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c73_ICARO3_Onda_bipe_controllonostro_get_eml_resolved_functions_info(void)
{
   ...
   *c73_identifier)
{
  ...
  c73_y = c73_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c73_b_is_active_c73_ICARO3_Onda_bipe_controllonostro), &c73_thisId);
  sf_mex_destroy(&c73_b_is_active_c73_ICARO3_Onda_bipe_controllonostro);
  return c73_y;
}
...
void sf_c73_ICARO3_Onda_bipe_controllonostro_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c73_ICARO3_Onda_bipe_controllonostro_get_autoinheritance_info(void)
{
...
mxArray *sf_c73_ICARO3_Onda_bipe_controllonostro_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c73_ICARO3_Onda_bipe_controllonostro_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c73_ICARO3_Onda_bipe_controllonostro
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c73_ICARO3_Onda_bipe_controllonostro\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c73_ICARO3_Onda_bipe_controllonostro_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c73_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
  initialize_c73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c73_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  enable_c73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c73_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  disable_c73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c73_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  sf_gateway_c73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c73_ICARO3_Onda_bipe_controllonostro(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c73_ICARO3_Onda_bipe_controllonostro();/* state var info */
...
extern void sf_internal_set_sim_state_c73_ICARO3_Onda_bipe_controllonostro
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c73_ICARO3_Onda_bipe_controllonostro(SimStruct* S)
{
  return sf_internal_get_sim_state_c73_ICARO3_Onda_bipe_controllonostro(S);
}

static void sf_opaque_set_sim_state_c73_ICARO3_Onda_bipe_controllonostro
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c73_ICARO3_Onda_bipe_controllonostro(S, st);
}

static void sf_opaque_terminate_c73_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c73_ICARO3_Onda_bipe_controllonostro
      ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc73_ICARO3_Onda_bipe_controllonostro
    ((SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c73_ICARO3_Onda_bipe_controllonostro(SimStruct *
  S)
{
  int i;
...
static void mdlSetWorkWidths_c73_ICARO3_Onda_bipe_controllonostro(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c73_ICARO3_Onda_bipe_controllonostro(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c73_ICARO3_Onda_bipe_controllonostro(SimStruct *S)
{
  SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct *)
    utMalloc(sizeof(SFc73_ICARO3_Onda_bipe_controllonostroInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c73_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c73_ICARO3_Onda_bipe_controllonostro;
...
void c73_ICARO3_Onda_bipe_controllonostro_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c73_ICARO3_Onda_bipe_controllonostro(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c73_ICARO3_Onda_bipe_controllonostro(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c73_ICARO3_Onda_bipe_controllonostro(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c73_ICARO3_Onda_bipe_controllonostro_method_dispatcher.\n"
