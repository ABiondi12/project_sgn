...
static void initialize_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void initialize_params_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void enable_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void disable_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void c133_update_debugger_state_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void set_sim_state_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance, const
   mxArray *c133_st);
static void finalize_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void sf_gateway_c133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
static void initSimStructsc133_ICARO3_Onda_bipe_controllonostro
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance);
...
static uint8_T c133_e_emlrt_marshallIn
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance, const
   mxArray *c133_b_is_active_c133_ICARO3_Onda_bipe_controllonostro, const char_T
   *c133_identifier);
  ...
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance)
{
  ...
  chartInstance->c133_is_active_c133_ICARO3_Onda_bipe_controllonostro = 0U;
}
  ...
  (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance)
{
  ...
  c133_hoistedGlobal =
    chartInstance->c133_is_active_c133_ICARO3_Onda_bipe_controllonostro;
   ...
   mxArray *c133_st)
{
  ...
  chartInstance->c133_is_active_c133_ICARO3_Onda_bipe_controllonostro =
    ...
    "is_active_c133_ICARO3_Onda_bipe_controllonostro");
  ...
  *c133_inData)
{
  ...
  const mxArray *c133_y = NULL;
  SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance;
  chartInstance = (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c133_ICARO3_Onda_bipe_controllonostro_get_eml_resolved_functions_info(void)
{
   ...
   *c133_identifier)
{
  ...
  c133_y = c133_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c133_b_is_active_c133_ICARO3_Onda_bipe_controllonostro), &c133_thisId);
  sf_mex_destroy(&c133_b_is_active_c133_ICARO3_Onda_bipe_controllonostro);
  return c133_y;
}
...
void sf_c133_ICARO3_Onda_bipe_controllonostro_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c133_ICARO3_Onda_bipe_controllonostro_get_autoinheritance_info(void)
{
...
mxArray *sf_c133_ICARO3_Onda_bipe_controllonostro_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c133_ICARO3_Onda_bipe_controllonostro_updateBuildInfo_args_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c133_ICARO3_Onda_bipe_controllonostro(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c133_ICARO3_Onda_bipe_controllonostro\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c133_ICARO3_Onda_bipe_controllonostro_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c133_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
  initialize_c133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c133_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  enable_c133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c133_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  disable_c133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c133_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  sf_gateway_c133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c133_ICARO3_Onda_bipe_controllonostro();/* state var info */
...
extern void sf_internal_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro(SimStruct* S)
{
  return sf_internal_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro(S);
}

static void sf_opaque_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro(S, st);
}

static void sf_opaque_terminate_c133_ICARO3_Onda_bipe_controllonostro(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c133_ICARO3_Onda_bipe_controllonostro
      ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc133_ICARO3_Onda_bipe_controllonostro
    ((SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c133_ICARO3_Onda_bipe_controllonostro(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c133_ICARO3_Onda_bipe_controllonostro(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c133_ICARO3_Onda_bipe_controllonostro(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c133_ICARO3_Onda_bipe_controllonostro(SimStruct *S)
{
  SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct *)
    utMalloc(sizeof(SFc133_ICARO3_Onda_bipe_controllonostroInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c133_ICARO3_Onda_bipe_controllonostro;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c133_ICARO3_Onda_bipe_controllonostro;
...
void c133_ICARO3_Onda_bipe_controllonostro_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c133_ICARO3_Onda_bipe_controllonostro(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c133_ICARO3_Onda_bipe_controllonostro(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c133_ICARO3_Onda_bipe_controllonostro(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c133_ICARO3_Onda_bipe_controllonostro_method_dispatcher.\n"
