  ...
  nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1791225744U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1274668891U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(535834158U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(815719089U);
  }
  ...
  SfDebugInstanceStruct* debugInstance)
{
  _ICARO3_Onda_bipe_controllonostroMachineNumber_ = sf_debug_initialize_machine
    (debugInstance,"ICARO3_Onda_bipe_controllonostro","sfun",0,49,0,0,0);
