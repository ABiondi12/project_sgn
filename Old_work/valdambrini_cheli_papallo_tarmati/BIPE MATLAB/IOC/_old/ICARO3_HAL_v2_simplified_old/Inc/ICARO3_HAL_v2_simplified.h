/*
 * File: ICARO3_HAL_v2_simplified.h
 *
...
#ifndef RTW_HEADER_ICARO3_HAL_v2_simplified_h_
#define RTW_HEADER_ICARO3_HAL_v2_simplified_h_
#include <string.h>
#include <float.h>
#include <math.h>
#include "ICARO3_HAL_v2_simplified_STM32.h"
#ifndef ICARO3_HAL_v2_simplified_COMMON_INCLUDES_
# define ICARO3_HAL_v2_simplified_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* ICARO3_HAL_v2_simplified_COMMON_INCLUDES_ */

#include "ICARO3_HAL_v2_simplified_types.h"
...
} rtB_MATLABFunction1_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S47>/MATLAB Function2' */
typedef struct {
  real_T y;                            /* '<S47>/MATLAB Function2' */
} rtB_MATLABFunction2_ICARO3_HAL_v2_simplified;
...
} rtDW_MATLABFunction2_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S108>/MATLAB Function6' */
typedef struct {
  real_T x;                            /* '<S108>/MATLAB Function6' */
  real_T y;                            /* '<S108>/MATLAB Function6' */
} rtB_MATLABFunction6_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S183>/h latch' */
typedef struct {
  real_T In1;                          /* '<S195>/In1' */
} rtB_hlatch_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S183>/lat lon latch' */
typedef struct {
  real_T In1[2];                       /* '<S196>/In1' */
} rtB_latlonlatch_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S267>/clock latch' */
typedef struct {
  real_T In;                           /* '<S270>/In' */
} rtB_clocklatch_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S338>/Subsystem' */
typedef struct {
  real_T Product1;                     /* '<S341>/Product1' */
} rtB_Subsystem_ICARO3_HAL_v2_simplified;

/* Block states (auto storage) for system '<S338>/Subsystem' */
typedef struct {
  real_T DiscreteTimeIntegrator_DSTATE;/* '<S341>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator1_DSTATE;/* '<S341>/Discrete-Time Integrator1' */
} rtDW_Subsystem_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S339>/Subsystem' */
typedef struct {
  real_T Product1;                     /* '<S342>/Product1' */
} rtB_Subsystem_ICARO3_HAL_v2_simplified_n;

/* Block states (auto storage) for system '<S339>/Subsystem' */
typedef struct {
  real_T DiscreteTimeIntegrator_DSTATE;/* '<S342>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator1_DSTATE;/* '<S342>/Discrete-Time Integrator1' */
} rtDW_Subsystem_ICARO3_HAL_v2_simplified_h;

/* Block signals for system '<S350>/ChangeAsset2' */
typedef struct {
  real32_T y[3];                       /* '<S350>/ChangeAsset2' */
} rtB_ChangeAsset2_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S377>/MATLAB Function compute gyroxyz1' */
typedef struct {
  uint16_T y;                          /* '<S377>/MATLAB Function compute gyroxyz1' */
} rtB_MATLABFunctioncomputegyroxyz1_ICARO3_HAL_v2_simplified;

/* Block signals for system '<S378>/MATLAB Function compute gyroxyz1' */
typedef struct {
  uint32_T y;                          /* '<S378>/MATLAB Function compute gyroxyz1' */
} rtB_MATLABFunctioncomputegyroxyz1_ICARO3_HAL_v2_simplified_g;

/* Block signals for system '<S397>/MATLAB Function compute gyroxyz1' */
typedef struct {
  uint8_T y[2];                        /* '<S397>/MATLAB Function compute gyroxyz1' */
} rtB_MATLABFunctioncomputegyroxyz1_ICARO3_HAL_v2_simplified_a;

/* Block signals for system '<S397>/MATLAB Function compute gyroxyz4' */
typedef struct {
  uint8_T y[8];                        /* '<S397>/MATLAB Function compute gyroxyz4' */
} rtB_MATLABFunctioncomputegyroxyz4_ICARO3_HAL_v2_simplified;
...
typedef struct {
  ...
  real32_T euler_out[3];               /* '<S334>/dcm_marg' */
  real32_T a_ned[3];                   /* '<S334>/dcm_marg' */
  ...
  rtB_Subsystem_ICARO3_HAL_v2_simplified Subsystem_a;/* '<S479>/Subsystem' */
  rtB_MATLABFunctioncomputegyroxyz1_ICARO3_HAL_v2_simplified_a
  ...
  rtB_ChangeAsset2_ICARO3_HAL_v2_simplified sf_ChangeAsset3;/* '<S350>/ChangeAsset3' */
  rtB_ChangeAsset2_ICARO3_HAL_v2_simplified sf_ChangeAsset2;/* '<S350>/ChangeAsset2' */
  rtB_Subsystem_ICARO3_HAL_v2_simplified_n Subsystem_i;/* '<S346>/Subsystem' */
  rtB_Subsystem_ICARO3_HAL_v2_simplified_n Subsystem_e5;/* '<S345>/Subsystem' */
  rtB_Subsystem_ICARO3_HAL_v2_simplified_n Subsystem_m;/* '<S344>/Subsystem' */
  rtB_Subsystem_ICARO3_HAL_v2_simplified_n Subsystem_e;/* '<S340>/Subsystem' */
  rtB_Subsystem_ICARO3_HAL_v2_simplified_n Subsystem_h;/* '<S339>/Subsystem' */
  rtB_Subsystem_ICARO3_HAL_v2_simplified Subsystem;/* '<S338>/Subsystem' */
  rtB_clocklatch_ICARO3_HAL_v2_simplified clocklatch_a;/* '<S278>/clock latch' */
  rtB_clocklatch_ICARO3_HAL_v2_simplified clocklatch_m;/* '<S267>/clock latch' */
  rtB_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction2_j;/* '<S240>/MATLAB Function2' */
  rtB_hlatch_ICARO3_HAL_v2_simplified yawlatch_l;/* '<S219>/yaw latch' */
  rtB_hlatch_ICARO3_HAL_v2_simplified rolllatch;/* '<S219>/roll latch' */
  rtB_hlatch_ICARO3_HAL_v2_simplified pitchlatch;/* '<S219>/pitch latch' */
  rtB_latlonlatch_ICARO3_HAL_v2_simplified latlonlatch_a;/* '<S219>/lat lon latch' */
  rtB_hlatch_ICARO3_HAL_v2_simplified hlatch_n;/* '<S219>/h latch' */
  rtB_MATLABFunction6_ICARO3_HAL_v2_simplified sf_MATLABFunction6_a4;/* '<S221>/MATLAB Function6' */
  rtB_MATLABFunction6_ICARO3_HAL_v2_simplified sf_MATLABFunction6_l;/* '<S220>/MATLAB Function6' */
  rtB_hlatch_ICARO3_HAL_v2_simplified yawlatch_g;/* '<S186>/yaw latch' */
  rtB_latlonlatch_ICARO3_HAL_v2_simplified latlonlatch;/* '<S186>/lat lon latch' */
  rtB_hlatch_ICARO3_HAL_v2_simplified hlatch_a;/* '<S186>/h latch' */
  rtB_hlatch_ICARO3_HAL_v2_simplified yawlatch;/* '<S183>/yaw latch' */
  rtB_latlonlatch_ICARO3_HAL_v2_simplified latlonlatch_j;/* '<S183>/lat lon latch' */
  rtB_hlatch_ICARO3_HAL_v2_simplified hlatch;/* '<S183>/h latch' */
  rtB_MATLABFunction6_ICARO3_HAL_v2_simplified sf_MATLABFunction6_m;/* '<S191>/MATLAB Function6' */
  rtB_MATLABFunction6_ICARO3_HAL_v2_simplified sf_MATLABFunction6_k;/* '<S190>/MATLAB Function6' */
  rtB_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction4;/* '<S49>/MATLAB Function4' */
  rtB_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction2;/* '<S160>/MATLAB Function2' */
  rtB_MATLABFunction6_ICARO3_HAL_v2_simplified sf_MATLABFunction6_a;/* '<S169>/MATLAB Function6' */
  rtB_MATLABFunction6_ICARO3_HAL_v2_simplified sf_MATLABFunction6_au;/* '<S109>/MATLAB Function6' */
  rtB_MATLABFunction6_ICARO3_HAL_v2_simplified sf_MATLABFunction6_hx;/* '<S108>/MATLAB Function6' */
  rtB_MATLABFunction1_ICARO3_HAL_v2_simplified sf_MATLABFunction3_j;/* '<S47>/MATLAB Function3' */
  rtB_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction2_l;/* '<S47>/MATLAB Function2' */
  rtB_MATLABFunction1_ICARO3_HAL_v2_simplified sf_MATLABFunction1_i;/* '<S47>/MATLAB Function1' */
} BlockIO_ICARO3_HAL_v2_simplified;
...
typedef struct {
  ...
  real_T Internal_DSTATE;              /* '<S466>/Internal' */
  real_T Internal_DSTATE_h;            /* '<S467>/Internal' */
  ...
  real32_T UnitDelay1_DSTATE[4];       /* '<S334>/Unit Delay1' */
  real32_T UnitDelay2_DSTATE[3];       /* '<S334>/Unit Delay2' */
  real32_T UnitDelay3_DSTATE[3];       /* '<S334>/Unit Delay3' */
  real32_T RateTransition2_Buffer0_f[11];/* '<S350>/Rate Transition2' */
  int32_T clockTickCounter;            /* '<S465>/Pulse Generator1' */
  int32_T clockTickCounter_n;          /* '<S465>/Pulse Generator2' */
  ...
  uint8_T Output_DSTATE;               /* '<S462>/Output' */
  uint8_T Output_DSTATE_k;             /* '<S405>/Output' */
  boolean_T UnitDelay_DSTATE_c4;       /* '<S294>/Unit Delay' */
  boolean_T UnitDelay1_DSTATE_p;       /* '<S294>/Unit Delay1' */
  boolean_T UnitDelay2_DSTATE_i;       /* '<S294>/Unit Delay2' */
  boolean_T UnitDelay3_DSTATE_o;       /* '<S294>/Unit Delay3' */
  ...
  boolean_T UnitDelay3_DSTATE_ov;      /* '<S293>/Unit Delay3' */
  ...
  boolean_T ini_not_empty;             /* '<S334>/dcm_marg' */
  ...
  boolean_T AttitudeFilterMPU_MODE;    /* '<S17>/Attitude Filter MPU' */
  ...
  rtDW_Subsystem_ICARO3_HAL_v2_simplified Subsystem_a;/* '<S479>/Subsystem' */
  rtDW_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_i;/* '<S346>/Subsystem' */
  rtDW_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_e5;/* '<S345>/Subsystem' */
  rtDW_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_m;/* '<S344>/Subsystem' */
  rtDW_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_e;/* '<S340>/Subsystem' */
  rtDW_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_h;/* '<S339>/Subsystem' */
  rtDW_Subsystem_ICARO3_HAL_v2_simplified Subsystem;/* '<S338>/Subsystem' */
  rtDW_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction2_j;/* '<S240>/MATLAB Function2' */
  rtDW_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction4;/* '<S49>/MATLAB Function4' */
  rtDW_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction2;/* '<S160>/MATLAB Function2' */
  rtDW_MATLABFunction2_ICARO3_HAL_v2_simplified sf_MATLABFunction2_l;/* '<S47>/MATLAB Function2' */
} D_Work_ICARO3_HAL_v2_simplified;

/* Parameters for system: '<S267>/clock latch' */
struct rtP_clocklatch_ICARO3_HAL_v2_simplified_ {
  real_T Out_Y0;                       /* Expression: -1000
                                        * Referenced by: '<S270>/Out'
                                        */
};

/* Parameters for system: '<S338>/Subsystem' */
struct rtP_Subsystem_ICARO3_HAL_v2_simplified_ {
  ...
  real_T DiscreteTimeIntegrator1_gainval;/* Computed Parameter: DiscreteTimeIntegrator1_gainval
                                          * Referenced by: '<S341>/Discrete-Time Integrator1'
                                          */
...
/* Parameters for system: '<S339>/Subsystem' */
struct rtP_Subsystem_ICARO3_HAL_v2_simplified_h_ {
  real_T Constant_Value;               /* Expression: 1
...
struct Parameters_ICARO3_HAL_v2_simplified_ {
  ...
  real_T pinvM[16];                    /* Variable: pinvM
                                        * Referenced by: '<S476>/allocation matrix'
                                        */
  ...
  uint8_T LimitedCounter_uplimit_b;    /* Mask Parameter: LimitedCounter_uplimit_b
                                        * Referenced by: '<S464>/FixPt Switch'
                                        */
  ...
  real_T PulseGenerator2_Amp;          /* Expression: 1
                                        * Referenced by: '<S465>/Pulse Generator2'
                                        */
  ...
  uint8_T FixPtConstant_Value_o;       /* Computed Parameter: FixPtConstant_Value_o
                                        * Referenced by: '<S463>/FixPt Constant'
                                        */
  ...
  boolean_T UnitDelay1_InitialCondition_l;/* Computed Parameter: UnitDelay1_InitialCondition_l
                                           ...
                                           */
  boolean_T UnitDelay2_InitialCondition_o;/* Computed Parameter: UnitDelay2_InitialCondition_o
                                           * Referenced by: '<S294>/Unit Delay2'
                                           */
  boolean_T UnitDelay3_InitialCondition_m;/* Computed Parameter: UnitDelay3_InitialCondition_m
  ...
  boolean_T notifyONLYafterstoringinitialLLHfordataprojection_InitialConditi;/* Computed Parameter: notifyONLYafterstoringinitialLLHfordataprojection_InitialConditi
                                                                      ...
                                                                      */
  rtP_Subsystem_ICARO3_HAL_v2_simplified Subsystem_a;/* '<S479>/Subsystem' */
  rtP_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_i;/* '<S346>/Subsystem' */
  rtP_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_e5;/* '<S345>/Subsystem' */
  rtP_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_m;/* '<S344>/Subsystem' */
  rtP_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_e;/* '<S340>/Subsystem' */
  rtP_Subsystem_ICARO3_HAL_v2_simplified_h Subsystem_h;/* '<S339>/Subsystem' */
  rtP_Subsystem_ICARO3_HAL_v2_simplified Subsystem;/* '<S338>/Subsystem' */
  rtP_clocklatch_ICARO3_HAL_v2_simplified clocklatch_a;/* '<S278>/clock latch' */
  rtP_clocklatch_ICARO3_HAL_v2_simplified clocklatch_m;/* '<S267>/clock latch' */
};

/* Real-time Model Data Structure */
struct tag_RTM_ICARO3_HAL_v2_simplified {
...
extern Parameters_ICARO3_HAL_v2_simplified ICARO3_HAL_v2_simplified_P;

/* Block signals (auto storage) */
extern BlockIO_ICARO3_HAL_v2_simplified ICARO3_HAL_v2_simplified_B;

/* Block states (auto storage) */
extern D_Work_ICARO3_HAL_v2_simplified ICARO3_HAL_v2_simplified_DWork;

/* External function called from main */
extern void ICARO3_HAL_v2_simplified_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void ICARO3_HAL_v2_simplified_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void ICARO3_HAL_v2_simplified_initialize(void);
extern void ICARO3_HAL_v2_simplified_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_ICARO3_HAL_v2_simplified *const ICARO3_HAL_v2_simplified_M;
 ...
 *
 * '<Root>' : 'ICARO3_HAL_v2_simplified'
 * '<S1>'   : 'ICARO3_HAL_v2_simplified/ADC1'
 * '<S2>'   : 'ICARO3_HAL_v2_simplified/ADIS AHRS1'
 * '<S3>'   : 'ICARO3_HAL_v2_simplified/Altitude Complementary Filter with 9dof ACC1'
 * '<S4>'   : 'ICARO3_HAL_v2_simplified/Altitude Complementary Filter with H_DATA_'
 * '<S5>'   : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY'
 * '<S6>'   : 'ICARO3_HAL_v2_simplified/DocBlock1'
 * '<S7>'   : 'ICARO3_HAL_v2_simplified/GPS UBLOX'
 * '<S8>'   : 'ICARO3_HAL_v2_simplified/GPS receiver VENUS'
 * '<S9>'   : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1'
 * '<S10>'  : 'ICARO3_HAL_v2_simplified/MATLAB Function'
 * '<S11>'  : 'ICARO3_HAL_v2_simplified/MATLAB Function6'
 * '<S12>'  : 'ICARO3_HAL_v2_simplified/MATLAB Function7'
 * '<S13>'  : 'ICARO3_HAL_v2_simplified/MATLAB Function8'
 * '<S14>'  : 'ICARO3_HAL_v2_simplified/MATLAB Function9'
 * '<S15>'  : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1'
 * '<S16>'  : 'ICARO3_HAL_v2_simplified/MODE manager1'
 * '<S17>'  : 'ICARO3_HAL_v2_simplified/MPU AHRS'
 * '<S18>'  : 'ICARO3_HAL_v2_simplified/NUOVO1'
 * '<S19>'  : 'ICARO3_HAL_v2_simplified/SS AHRS'
 * '<S20>'  : 'ICARO3_HAL_v2_simplified/Scheme Running'
 * '<S21>'  : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST'
 * '<S22>'  : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST'
 * '<S23>'  : 'ICARO3_HAL_v2_simplified/flashing LED notifier slow: filters debiasing fast: filter running'
 * '<S24>'  : 'ICARO3_HAL_v2_simplified/power computations1'
 * '<S25>'  : 'ICARO3_HAL_v2_simplified/quadrotor  control allocation1'
 * '<S26>'  : 'ICARO3_HAL_v2_simplified/set initial altitude to 1'
 * '<S27>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/Attitude Filter ADIS'
 * '<S28>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS'
 * '<S29>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/Attitude Filter ADIS/DCM_MARG_QUAT'
 * '<S30>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/Attitude Filter ADIS/DCM_MARG_QUAT/dcm_marg'
 * '<S31>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Acceleration Detrend '
 * '<S32>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Gyros Detrend'
 * '<S33>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Acceleration Detrend /Detrend'
 * '<S34>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Acceleration Detrend /Detrend1'
 * '<S35>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Acceleration Detrend /Detrend3'
 * '<S36>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Acceleration Detrend /Detrend/Subsystem'
 * '<S37>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Acceleration Detrend /Detrend1/Subsystem'
 * '<S38>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Acceleration Detrend /Detrend3/Subsystem'
 * '<S39>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Gyros Detrend/Detrend'
 * '<S40>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Gyros Detrend/Detrend1'
 * '<S41>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Gyros Detrend/Detrend2'
 * '<S42>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Gyros Detrend/Detrend/Subsystem'
 * '<S43>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Gyros Detrend/Detrend1/Subsystem'
 * '<S44>'  : 'ICARO3_HAL_v2_simplified/ADIS AHRS1/debias ADIS/Gyros Detrend/Detrend2/Subsystem'
 * '<S45>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller'
 * '<S46>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller'
 * '<S47>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller'
 * '<S48>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance'
 * '<S49>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator'
 * '<S50>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Off'
 * '<S51>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref'
 * '<S52>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/controller 1'
 * '<S53>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/controller 2'
 * '<S54>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/controller 3: hover'
 * '<S55>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/controller 4:Ret to Home'
 * '<S56>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/controller 5: waypoint'
 * '<S57>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/controller 6: fuzzy guidance'
 * '<S58>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/controller 7'
 * '<S59>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/detect first take off'
 * '<S60>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller'
 * '<S61>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/go back to hover when  waypoint list is empty (fuzzy guidance only : mode = 6)'
 * '<S62>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/manual'
 * '<S63>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/step 2 pulse generate trigger  for take off latch'
 * '<S64>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID'
 * '<S65>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS'
 * '<S66>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/H ref vario generation'
 * '<S67>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/MATLAB Function1'
 * '<S68>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/MATLAB Function4'
 * '<S69>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/PID altitude'
 * '<S70>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/Resetable slew rate limiter H'
 * '<S71>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/H ref vario generation/H vario'
 * '<S72>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/H ref vario generation/detect ref change and reset vario'
 * '<S73>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System'
 * '<S74>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System/IO Delay'
 * '<S75>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System/Input Delay'
 * '<S76>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System/Output Delay'
 * '<S77>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch'
 * '<S78>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch1'
 * '<S79>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System'
 * '<S80>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/IO Delay'
 * '<S81>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/Input Delay'
 * '<S82>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/Output Delay'
 * '<S83>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System'
 * '<S84>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System/IO Delay'
 * '<S85>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System/Input Delay'
 * '<S86>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System/Output Delay'
 * '<S87>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS'
 * '<S88>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch'
 * '<S89>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch1'
 * '<S90>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch/LTI System'
 * '<S91>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch/LTI System/IO Delay'
 * '<S92>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch/LTI System/Input Delay'
 * '<S93>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch/LTI System/Output Delay'
 * '<S94>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch1/LTI System'
 * '<S95>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch1/LTI System/IO Delay'
 * '<S96>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch1/LTI System/Input Delay'
 * '<S97>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Attitude Controller/Attitude PIDS/PID Pitch1/LTI System/Output Delay'
 * '<S98>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Altitude PID'
 * '<S99>'  : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS'
 * '<S100>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter2'
 * '<S101>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter3'
 * '<S102>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/MATLAB Function1'
 * '<S103>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/MATLAB Function2'
 * '<S104>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/MATLAB Function3'
 * '<S105>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PI Yaw'
 * '<S106>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x'
 * '<S107>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y'
 * '<S108>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/geo2ned'
 * '<S109>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/geo2ned1'
 * '<S110>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Altitude PID/PID altitude'
 * '<S111>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Altitude PID/PID altitude/LTI System'
 * '<S112>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Altitude PID/PID altitude/LTI System/IO Delay'
 * '<S113>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Altitude PID/PID altitude/LTI System/Input Delay'
 * '<S114>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Altitude PID/PID altitude/LTI System/Output Delay'
 * '<S115>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch'
 * '<S116>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch1'
 * '<S117>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch/LTI System'
 * '<S118>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/IO Delay'
 * '<S119>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/Input Delay'
 * '<S120>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/Output Delay'
 * '<S121>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System'
 * '<S122>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System/IO Delay'
 * '<S123>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System/Input Delay'
 * '<S124>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/Attitude PIDS/PID Pitch1/LTI System/Output Delay'
 * '<S125>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter2/IO Delay'
 * '<S126>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter2/Input Delay'
 * '<S127>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter2/Output Delay'
 * '<S128>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter3/IO Delay'
 * '<S129>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter3/Input Delay'
 * '<S130>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/LP Filter3/Output Delay'
 * '<S131>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PI Yaw/ensure that  -PI < y < PI'
 * '<S132>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/Discrete Derivative'
 * '<S133>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System'
 * '<S134>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System1'
 * '<S135>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System2'
 * '<S136>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System/IO Delay'
 * '<S137>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System/Input Delay'
 * '<S138>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System/Output Delay'
 * '<S139>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System1/IO Delay'
 * '<S140>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System1/Input Delay'
 * '<S141>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System1/Output Delay'
 * '<S142>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System2/IO Delay'
 * '<S143>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System2/Input Delay'
 * '<S144>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID x/LTI System2/Output Delay'
 * '<S145>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System'
 * '<S146>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System1'
 * '<S147>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System2'
 * '<S148>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System/IO Delay'
 * '<S149>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System/Input Delay'
 * '<S150>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System/Output Delay'
 * '<S151>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System1/IO Delay'
 * '<S152>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System1/Input Delay'
 * '<S153>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System1/Output Delay'
 * '<S154>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System2/IO Delay'
 * '<S155>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System2/Input Delay'
 * '<S156>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/PID y/LTI System2/Output Delay'
 * '<S157>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/geo2ned/MATLAB Function6'
 * '<S158>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/DP + Altitude Controller/geo2ned1/MATLAB Function6'
 * '<S159>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Compare To Constant'
 * '<S160>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance'
 * '<S161>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/FG Telemetry'
 * '<S162>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/GPS to NED'
 * '<S163>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/Guidance'
 * '<S164>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/MATLAB Function2'
 * '<S165>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/Resetable slew rate limiter YAW with ext reset value'
 * '<S166>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/WP Manager'
 * '<S167>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/pitch regulator'
 * '<S168>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/reset slew rate limiter when enabling FG'
 * '<S169>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/GPS to NED/geo2ned'
 * '<S170>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/GPS to NED/geo2ned/MATLAB Function6'
 * '<S171>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/WP Manager/LatLon to NED'
 * '<S172>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/WP Manager/WP Manager'
 * '<S173>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/WP Manager/LatLon to NED/geo2ned'
 * '<S174>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/WP Manager/LatLon to NED/geo2ned/MATLAB Function6'
 * '<S175>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/reset slew rate limiter when enabling FG/Compare To Constant'
 * '<S176>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/GUidance/Guidance/reset slew rate limiter when enabling FG/Compare To Constant1'
 * '<S177>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/H ref vario generation'
 * '<S178>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/MATLAB Function4'
 * '<S179>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/Ref manager'
 * '<S180>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/Resetable slew rate limiter H'
 * '<S181>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/Resetable slew rate limiter YAW'
 * '<S182>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/compute position error'
 * '<S183>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/hover'
 * '<S184>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/pulse when entering Hover or RTH '
 * '<S185>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/reset slew rate limiter when enabling hover, RTH or waypoints'
 * '<S186>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/take off point'
 * '<S187>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/yaw ref vario generation'
 * '<S188>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/H ref vario generation/H vario'
 * '<S189>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/H ref vario generation/detect ref change and reset vario'
 * '<S190>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/compute position error/geo2ned1'
 * '<S191>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/compute position error/geo2ned2'
 * '<S192>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/compute position error/geo2ned1/MATLAB Function6'
 * '<S193>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/compute position error/geo2ned2/MATLAB Function6'
 * '<S194>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/hover/detect rising edge: transform rising edge to positive pulse1'
 * '<S195>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/hover/h latch'
 * '<S196>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/hover/lat lon latch'
 * '<S197>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/hover/yaw latch'
 * '<S198>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/hover/detect rising edge: transform rising edge to positive pulse1/detect positive values'
 * '<S199>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/pulse when entering Hover or RTH /Compare To Constant'
 * '<S200>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/pulse when entering Hover or RTH /Compare To Constant1'
 * '<S201>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/pulse when entering Hover or RTH /Compare To Constant2'
 * '<S202>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/pulse when entering Hover or RTH /Compare To Constant3'
 * '<S203>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/reset slew rate limiter when enabling hover, RTH or waypoints/Compare To Constant'
 * '<S204>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/reset slew rate limiter when enabling hover, RTH or waypoints/Compare To Constant1'
 * '<S205>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/reset slew rate limiter when enabling hover, RTH or waypoints/Compare To Constant4'
 * '<S206>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/reset slew rate limiter when enabling hover, RTH or waypoints/Compare To Constant5'
 * '<S207>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/reset slew rate limiter when enabling hover, RTH or waypoints/Compare To Constant6'
 * '<S208>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/reset slew rate limiter when enabling hover, RTH or waypoints/Compare To Constant7'
 * '<S209>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/take off point/detect rising edge: transform rising edge to positive pulse1'
 * '<S210>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/take off point/h latch'
 * '<S211>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/take off point/lat lon latch'
 * '<S212>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/take off point/yaw latch'
 * '<S213>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/take off point/detect rising edge: transform rising edge to positive pulse1/detect positive values'
 * '<S214>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/yaw ref vario generation/H vario'
 * '<S215>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/LLHY Reference Generator/yaw ref vario generation/detect ref change and reset vario'
 * '<S216>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/Compare To Constant'
 * '<S217>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/check request for next wayp'
 * '<S218>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/compute position error'
 * '<S219>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint'
 * '<S220>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/compute position error/geo2ned'
 * '<S221>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/compute position error/geo2ned1'
 * '<S222>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/compute position error/geo2ned/MATLAB Function6'
 * '<S223>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/compute position error/geo2ned1/MATLAB Function6'
 * '<S224>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/compute yaw, roll, pitch for wayp_guid'
 * '<S225>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/h latch'
 * '<S226>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/lat lon latch'
 * '<S227>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/pitch latch'
 * '<S228>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/roll latch'
 * '<S229>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/waypoint latch'
 * '<S230>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/yaw latch'
 * '<S231>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/compute yaw, roll, pitch for wayp_guid/MATLAB Function6'
 * '<S232>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/compute yaw, roll, pitch for wayp_guid/compute wayp bearing angle'
 * '<S233>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/compute yaw, roll, pitch for wayp_guid/compute wayp bearing angle/MATLAB Function6'
 * '<S234>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/Waypoint guidance ref/waypoint/waypoint latch/waypoint latch'
 * '<S235>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/detect first take off/Compare To Constant'
 * '<S236>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/detect first take off/Compare To Constant1'
 * '<S237>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/detect first take off/S-R Flip-Flop'
 * '<S238>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller'
 * '<S239>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Altitude PID'
 * '<S240>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS'
 * '<S241>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Altitude PID/PID altitude'
 * '<S242>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System'
 * '<S243>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System/IO Delay'
 * '<S244>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System/Input Delay'
 * '<S245>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Altitude PID/PID altitude/LTI System/Output Delay'
 * '<S246>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/MATLAB Function2'
 * '<S247>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Pitch'
 * '<S248>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Roll'
 * '<S249>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Yaw'
 * '<S250>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System'
 * '<S251>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/IO Delay'
 * '<S252>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/Input Delay'
 * '<S253>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Pitch/LTI System/Output Delay'
 * '<S254>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Roll/LTI System'
 * '<S255>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Roll/LTI System/IO Delay'
 * '<S256>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Roll/LTI System/Input Delay'
 * '<S257>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Roll/LTI System/Output Delay'
 * '<S258>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Yaw/LTI System'
 * '<S259>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Yaw/ensure that  -PI < y < PI'
 * '<S260>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Yaw/LTI System/IO Delay'
 * '<S261>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Yaw/LTI System/Input Delay'
 * '<S262>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/fuzzy guidance Controller/Attitude + Altitude Controller/Attitude PIDS/PID Yaw/LTI System/Output Delay'
 * '<S263>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/go back to hover when  waypoint list is empty (fuzzy guidance only : mode = 6)/Compare To Constant'
 * '<S264>' : 'ICARO3_HAL_v2_simplified/Controllers w// FUZZY/go back to hover when  waypoint list is empty (fuzzy guidance only : mode = 6)/Compare To Constant1'
 * '<S265>' : 'ICARO3_HAL_v2_simplified/GPS UBLOX/clock latch'
 * '<S266>' : 'ICARO3_HAL_v2_simplified/GPS receiver VENUS/compute 3d age'
 * '<S267>' : 'ICARO3_HAL_v2_simplified/GPS receiver VENUS/compute age'
 * '<S268>' : 'ICARO3_HAL_v2_simplified/GPS receiver VENUS/compute 3d age/Compare To Constant'
 * '<S269>' : 'ICARO3_HAL_v2_simplified/GPS receiver VENUS/compute 3d age/clock latch'
 * '<S270>' : 'ICARO3_HAL_v2_simplified/GPS receiver VENUS/compute age/clock latch'
 * '<S271>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input '
 * '<S272>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Compare To Constant'
 * '<S273>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Compare To Constant1'
 * '<S274>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Compare To Constant2'
 * '<S275>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Raw IMU data packer'
 * '<S276>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Subsystem4'
 * '<S277>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/WAYPOINT_MANAGER'
 * '<S278>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/recv from bs'
 * '<S279>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/step 2 pulse generate trigger  for take next waypoint'
 * '<S280>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/step 2 pulse generate trigger  to send gains to bs'
 * '<S281>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /Compare To Constant1'
 * '<S282>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /Subsystem'
 * '<S283>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /Subsystem1'
 * '<S284>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /Subsystem2'
 * '<S285>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /Subsystem4'
 * '<S286>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /Subsystem6'
 * '<S287>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /join enable flags'
 * '<S288>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/Assemble debug input /Subsystem6/Compare To Zero'
 * '<S289>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/WAYPOINT_MANAGER/Vehicle_DataBase_Manager'
 * '<S290>' : 'ICARO3_HAL_v2_simplified/MAIN TELEMETRY1/recv from bs/clock latch'
 * '<S291>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/ '
 * '<S292>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 0//1-value qualification'
 * '<S293>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 0//1-value qualification1'
 * '<S294>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 1-value qualification 1'
 * '<S295>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 1-value qualification 2'
 * '<S296>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 1-value qualification 3'
 * '<S297>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 1-value qualification 4'
 * '<S298>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 1-value qualification 5'
 * '<S299>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/MATLAB Function3'
 * '<S300>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/RC is ok '
 * '<S301>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/S-R Flip-Flop'
 * '<S302>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect ARM REQUEST'
 * '<S303>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DISARM REQUEST'
 * '<S304>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DP status'
 * '<S305>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect H'
 * '<S306>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect IMU selection'
 * '<S307>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 0//1-value qualification/S-R Flip-Flop'
 * '<S308>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/6 samples 0//1-value qualification1/S-R Flip-Flop'
 * '<S309>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect ARM REQUEST/throttle low'
 * '<S310>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect ARM REQUEST/throttle valid'
 * '<S311>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect ARM REQUEST/yaw RIGHT'
 * '<S312>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect ARM REQUEST/yaw valid'
 * '<S313>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DISARM REQUEST/throttle low'
 * '<S314>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DISARM REQUEST/throttle valid'
 * '<S315>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DISARM REQUEST/yaw LEFT'
 * '<S316>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DISARM REQUEST/yaw valid'
 * '<S317>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DP status/HOVER'
 * '<S318>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DP status/MAN'
 * '<S319>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DP status/RTH'
 * '<S320>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DP status/RTH1'
 * '<S321>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect DP status/throttle valid'
 * '<S322>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect H/h control valid'
 * '<S323>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect H/throttle low2'
 * '<S324>' : 'ICARO3_HAL_v2_simplified/MK stick commands decoder1/detect IMU selection/posizione 1'
 * '<S325>' : 'ICARO3_HAL_v2_simplified/MODE manager1/MATLAB Function'
 * '<S326>' : 'ICARO3_HAL_v2_simplified/MODE manager1/detect valid 3d fix'
 * '<S327>' : 'ICARO3_HAL_v2_simplified/MODE manager1/store ref system'
 * '<S328>' : 'ICARO3_HAL_v2_simplified/MODE manager1/detect valid 3d fix/Compare To Constant'
 * '<S329>' : 'ICARO3_HAL_v2_simplified/MODE manager1/detect valid 3d fix/Compare To Constant1'
 * '<S330>' : 'ICARO3_HAL_v2_simplified/MODE manager1/detect valid 3d fix/S-R Flip-Flop'
 * '<S331>' : 'ICARO3_HAL_v2_simplified/MODE manager1/store ref system/MATLAB Function1'
 * '<S332>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/Attitude Filter MPU'
 * '<S333>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU'
 * '<S334>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/Attitude Filter MPU/DCM_MARG_QUAT'
 * '<S335>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/Attitude Filter MPU/DCM_MARG_QUAT/dcm_marg'
 * '<S336>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Acceleration Detrend '
 * '<S337>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Gyros Detrend'
 * '<S338>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Acceleration Detrend /Detrend'
 * '<S339>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Acceleration Detrend /Detrend1'
 * '<S340>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Acceleration Detrend /Detrend3'
 * '<S341>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Acceleration Detrend /Detrend/Subsystem'
 * '<S342>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Acceleration Detrend /Detrend1/Subsystem'
 * '<S343>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Acceleration Detrend /Detrend3/Subsystem'
 * '<S344>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Gyros Detrend/Detrend'
 * '<S345>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Gyros Detrend/Detrend1'
 * '<S346>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Gyros Detrend/Detrend2'
 * '<S347>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Gyros Detrend/Detrend/Subsystem'
 * '<S348>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Gyros Detrend/Detrend1/Subsystem'
 * '<S349>' : 'ICARO3_HAL_v2_simplified/MPU AHRS/debias MPU/Gyros Detrend/Detrend2/Subsystem'
 * '<S350>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing'
 * '<S351>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager'
 * '<S352>' : 'ICARO3_HAL_v2_simplified/NUOVO1/motors_cmd on PWM'
 * '<S353>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/ChangeAsset2'
 * '<S354>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/ChangeAsset3'
 * '<S355>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/Compute Temperature (T) and Altitude (H)'
 * '<S356>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/MATLAB Function'
 * '<S357>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/MATLAB Function compute accxyz'
 * '<S358>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/MATLAB Function compute accxyz1'
 * '<S359>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/MATLAB Function compute gyroxyz'
 * '<S360>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/MATLAB Function compute magxyz'
 * '<S361>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/MATLAB Function compute magxyz1'
 * '<S362>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/MATLAB Function compute magxyz2'
 * '<S363>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/compute_parameters'
 * '<S364>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/spi_data_processing'
 * '<S365>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/Compute Temperature (T) and Altitude (H)/MATLAB Function'
 * '<S366>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/Compute Temperature (T) and Altitude (H)/MATLAB Function1'
 * '<S367>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/compute_parameters/MATLAB Function1'
 * '<S368>' : 'ICARO3_HAL_v2_simplified/NUOVO1/Processing/spi_data_processing/MATLAB Function compute magxyz1'
 * '<S369>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/Arrange pwms'
 * '<S370>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX'
 * '<S371>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/I2C1 sensors loop'
 * '<S372>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/Subsystem1'
 * '<S373>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/Subsystem2'
 * '<S374>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/compose data from canbus'
 * '<S375>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus'
 * '<S376>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/Arrange pwms/clock latch'
 * '<S377>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem1'
 * '<S378>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem2'
 * '<S379>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem3'
 * '<S380>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz1'
 * '<S381>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz2'
 * '<S382>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz3'
 * '<S383>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz5'
 * '<S384>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem2/MATLAB Function compute gyroxyz1'
 * '<S385>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem2/MATLAB Function compute gyroxyz5'
 * '<S386>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz1'
 * '<S387>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz2'
 * '<S388>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz3'
 * '<S389>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz5'
 * '<S390>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/compose data from canbus/H'
 * '<S391>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/compose data from canbus/typecast uin32 to single'
 * '<S392>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/compose data from canbus/typecast uin32 to single1'
 * '<S393>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/compose data from canbus/H/typecast uin32 to single'
 * '<S394>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Repeating Sequence Stair'
 * '<S395>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem'
 * '<S396>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem1'
 * '<S397>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem10'
 * '<S398>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem2'
 * '<S399>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem3'
 * '<S400>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem4'
 * '<S401>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem5'
 * '<S402>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem6'
 * '<S403>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem7'
 * '<S404>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem8'
 * '<S405>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter'
 * '<S406>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S407>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 * '<S408>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz1'
 * '<S409>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz2'
 * '<S410>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz3'
 * '<S411>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz4'
 * '<S412>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz5'
 * '<S413>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz1'
 * '<S414>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz2'
 * '<S415>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz3'
 * '<S416>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz4'
 * '<S417>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz5'
 * '<S418>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz1'
 * '<S419>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz2'
 * '<S420>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz3'
 * '<S421>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz4'
 * '<S422>' : 'ICARO3_HAL_v2_simplified/NUOVO1/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz5'
 * '<S423>' : 'ICARO3_HAL_v2_simplified/NUOVO1/motors_cmd on PWM/MATLAB Function'
 * '<S424>' : 'ICARO3_HAL_v2_simplified/NUOVO1/motors_cmd on PWM/calibrate SIMONK ESC'
 * '<S425>' : 'ICARO3_HAL_v2_simplified/NUOVO1/motors_cmd on PWM/calibrate SIMONK ESC/discrete time RAMP'
 * '<S426>' : 'ICARO3_HAL_v2_simplified/SS AHRS/Attitude Filter SS'
 * '<S427>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS'
 * '<S428>' : 'ICARO3_HAL_v2_simplified/SS AHRS/Attitude Filter SS/DCM_MARG_QUAT'
 * '<S429>' : 'ICARO3_HAL_v2_simplified/SS AHRS/Attitude Filter SS/DCM_MARG_QUAT/dcm_marg'
 * '<S430>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Acceleration Detrend '
 * '<S431>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Gyros Detrend'
 * '<S432>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Acceleration Detrend /Detrend'
 * '<S433>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Acceleration Detrend /Detrend1'
 * '<S434>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Acceleration Detrend /Detrend3'
 * '<S435>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Acceleration Detrend /Detrend/Subsystem'
 * '<S436>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Acceleration Detrend /Detrend1/Subsystem'
 * '<S437>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Acceleration Detrend /Detrend3/Subsystem'
 * '<S438>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Gyros Detrend/Detrend'
 * '<S439>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Gyros Detrend/Detrend1'
 * '<S440>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Gyros Detrend/Detrend2'
 * '<S441>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Gyros Detrend/Detrend/Subsystem'
 * '<S442>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Gyros Detrend/Detrend1/Subsystem'
 * '<S443>' : 'ICARO3_HAL_v2_simplified/SS AHRS/debias SS/Gyros Detrend/Detrend2/Subsystem'
 * '<S444>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/ADC_filt'
 * '<S445>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/ADC_raw'
 * '<S446>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/Ages'
 * '<S447>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/GPS'
 * '<S448>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/GPS ECEF'
 * '<S449>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/MATLAB Function2'
 * '<S450>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/MODIFIED Raw IMU data MPU only  + RPY AHRS + ALTITUDE (H Hd 0) to be used for AHRS online tuning'
 * '<S451>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/Raw IMU data MPU + HMC + ADC'
 * '<S452>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/Raw IMU data MPU only + ADC'
 * '<S453>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/Raw IMU data packer'
 * '<S454>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/join enable flags'
 * '<S455>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/recupero di mpu9150 data'
 * '<S456>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/test solo RC_all_channel_usec + RSSI + ....'
 * '<S457>' : 'ICARO3_HAL_v2_simplified/debug telemtry FLIGHT TEST/GPS/detect if was 1 in the last 10 samples'
 * '<S458>' : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST/Raw IMU data packer: MPU + MAG_HMC'
 * '<S459>' : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST/Subsystem'
 * '<S460>' : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST/join enable flags'
 * '<S461>' : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST/muxer'
 * '<S462>' : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST/muxer/LimitedCounter'
 * '<S463>' : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST/muxer/LimitedCounter/Increment Real World'
 * '<S464>' : 'ICARO3_HAL_v2_simplified/debug telemtry STATIC TEST/muxer/LimitedCounter/Wrap To Zero'
 * '<S465>' : 'ICARO3_HAL_v2_simplified/flashing LED notifier slow: filters debiasing fast: filter running/LED'
 * '<S466>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter'
 * '<S467>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter1'
 * '<S468>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter/IO Delay'
 * '<S469>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter/Input Delay'
 * '<S470>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter/Output Delay'
 * '<S471>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter1/IO Delay'
 * '<S472>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter1/Input Delay'
 * '<S473>' : 'ICARO3_HAL_v2_simplified/power computations1/low pass filter1/Output Delay'
 * '<S474>' : 'ICARO3_HAL_v2_simplified/quadrotor  control allocation1/Saturation Dynamic'
 * '<S475>' : 'ICARO3_HAL_v2_simplified/quadrotor  control allocation1/low_sat'
 * '<S476>' : 'ICARO3_HAL_v2_simplified/quadrotor  control allocation1/new re-allocation matrix (X flight_mode)'
 * '<S477>' : 'ICARO3_HAL_v2_simplified/quadrotor  control allocation1/reallocate (+ flight_mode)'
 * '<S478>' : 'ICARO3_HAL_v2_simplified/set initial altitude to 1/Altitude Detrend '
 * '<S479>' : 'ICARO3_HAL_v2_simplified/set initial altitude to 1/Altitude Detrend /Detrend'
 * '<S480>' : 'ICARO3_HAL_v2_simplified/set initial altitude to 1/Altitude Detrend /Detrend/Subsystem'
 */
#endif                                 /* RTW_HEADER_ICARO3_HAL_v2_simplified_h_ */

/* File trailer for Real-Time Workshop generated code.
 *
 * [EOF] ICARO3_HAL_v2_simplified.h
 */
