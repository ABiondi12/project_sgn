...
//// Modifica da verificare se serve !!!!
  // Disabilito l'interrupt di ricezione per rendere la trasmissione atomica
  //	perchè l'handler di ricezione chiama due volte la HAL_CAN_Init
