...
//Variabili temporanee contenenti la posizione del tag1 filtrate
double x1_mean ;
double y1_mean ;
double z1_mean;
...
int parseFcn(unsigned char* receivedCharFromSerial){
  ...
  union DATA{
   ...
   //union DATA d;
    ...
    d.s[0]=receivedCharFromSerial[52];d.s[1]=receivedCharFromSerial[53];d.s[2]=receivedCharFromSerial[54];d.s[3]=receivedCharFromSerial[55];
    x1_mean=(double)d.n;
    
     d.s[0]=receivedCharFromSerial[56];d.s[1]=receivedCharFromSerial[57];d.s[2]=receivedCharFromSerial[58];d.s[3]=receivedCharFromSerial[59];
     y1_mean=(double)d.n;
    
     d.s[0]=receivedCharFromSerial[60];d.s[1]=receivedCharFromSerial[61];d.s[2]=receivedCharFromSerial[62];d.s[3]=receivedCharFromSerial[63];
     z1_mean=(double)d.n;
