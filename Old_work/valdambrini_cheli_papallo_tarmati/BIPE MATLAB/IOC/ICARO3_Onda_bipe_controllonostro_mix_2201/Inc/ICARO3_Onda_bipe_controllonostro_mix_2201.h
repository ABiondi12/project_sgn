/*
 * File: ICARO3_Onda_bipe_controllonostro_mix_2201.h
 *
...
#ifndef RTW_HEADER_ICARO3_Onda_bipe_controllonostro_mix_2201_h_
#define RTW_HEADER_ICARO3_Onda_bipe_controllonostro_mix_2201_h_
#include <math.h>
#include <string.h>
#include "ICARO3_Onda_bipe_controllonostro_mix_2201_STM32.h"
#ifndef ICARO3_Onda_bipe_controllonostro_mix_2201_COMMON_INCLUDES_
# define ICARO3_Onda_bipe_controllonostro_mix_2201_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* ICARO3_Onda_bipe_controllonostro_mix_2201_COMMON_INCLUDES_ */

#include "ICARO3_Onda_bipe_controllonostro_mix_2201_types.h"
...
} rtB_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201;
...
} rtDW_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201;

/* Block signals for system '<S80>/clock latch' */
typedef struct {
  real_T In;                           /* '<S95>/In' */
} rtB_clocklatch_ICARO3_Onda_bipe_controllonostro_mix_2201;
...
typedef struct {
  ...
  rtB_clocklatch_ICARO3_Onda_bipe_controllonostro_mix_2201 clocklatch_h;/* '<Root>/clock latch' */
  rtB_clocklatch_ICARO3_Onda_bipe_controllonostro_mix_2201 clocklatch_m;/* '<S80>/clock latch' */
  rtB_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_o;/* '<S42>/Subsystem' */
  rtB_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_l;/* '<S41>/Subsystem' */
  rtB_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_p;/* '<S36>/Subsystem' */
  rtB_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_g;/* '<S35>/Subsystem' */
...
typedef struct {
  ...
  rtDW_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_o;/* '<S42>/Subsystem' */
  rtDW_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_l;/* '<S41>/Subsystem' */
  rtDW_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_p;/* '<S36>/Subsystem' */
  rtDW_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_g;/* '<S35>/Subsystem' */
} D_Work_ICARO3_Onda_bipe_controllonostro_mix_2201;

/* Parameters for system: '<S35>/Subsystem' */
struct rtP_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201_ {
...
struct rtP_clocklatch_ICARO3_Onda_bipe_controllonostro_mix_2201_ {
...
struct Parameters_ICARO3_Onda_bipe_controllonostro_mix_2201_ {
  ...
  real_T Saturation1_UpperSat;         /* Expression: 0
                                        ...
                                        */
  real_T Saturation1_LowerSat;         /* Expression: -0.15
                                        * Referenced by: '<S70>/Saturation1'
                                        */
  ...
  uint8_T gpsselector1_CurrentSetting; /* Computed Parameter: gpsselector1_CurrentSetting
                                        ...
                                        */
  rtP_clocklatch_ICARO3_Onda_bipe_controllonostro_mix_2201 clocklatch_h;/* '<Root>/clock latch' */
  rtP_clocklatch_ICARO3_Onda_bipe_controllonostro_mix_2201 clocklatch_m;/* '<S80>/clock latch' */
  rtP_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_o;/* '<S42>/Subsystem' */
  rtP_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_l;/* '<S41>/Subsystem' */
  rtP_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_p;/* '<S36>/Subsystem' */
  rtP_Subsystem_ICARO3_Onda_bipe_controllonostro_mix_2201 Subsystem_g;/* '<S35>/Subsystem' */
};

/* Real-time Model Data Structure */
struct tag_RTM_ICARO3_Onda_bipe_controllonostro_mix_2201 {
...
extern Parameters_ICARO3_Onda_bipe_controllonostro_mix_2201
  ICARO3_Onda_bipe_controllonostro_mix_2201_P;

/* Block signals (auto storage) */
extern BlockIO_ICARO3_Onda_bipe_controllonostro_mix_2201
  ICARO3_Onda_bipe_controllonostro_mix_2201_B;

/* Block states (auto storage) */
extern D_Work_ICARO3_Onda_bipe_controllonostro_mix_2201
  ICARO3_Onda_bipe_controllonostro_mix_2201_DWork;

/* External function called from main */
extern void ICARO3_Onda_bipe_controllonostro_mix_2201_SetEventsForThisBaseStep
  (boolean_T *eventFlags);

/* Model entry point functions */
extern void ICARO3_Onda_bipe_controllonostro_mix_2201_SetEventsForThisBaseStep
  (boolean_T *eventFlags);
extern void ICARO3_Onda_bipe_controllonostro_mix_2201_initialize(void);
extern void ICARO3_Onda_bipe_controllonostro_mix_2201_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_ICARO3_Onda_bipe_controllonostro_mix_2201 *const
 ...
 *
 * '<Root>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201'
 * '<S1>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ generatore di riferimenti'
 * '<S2>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADC1'
 * '<S3>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2'
 * '<S4>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Compensate for sensor mount _acc'
 * '<S5>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Compensate for sensor mount _acc1'
 * '<S6>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control '
 * '<S7>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GET PPS'
 * '<S8>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver'
 * '<S9>'   : 'ICARO3_Onda_bipe_controllonostro_mix_2201/PI Controller'
 * '<S10>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Posca_Zocco Steer Map '
 * '<S11>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Prescaler'
 * '<S12>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS'
 * '<S13>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Scheme Running'
 * '<S14>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/blocco motori se non arrivano pacchetti'
 * '<S15>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/clock latch'
 * '<S16>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/configurazione relativa seeker//target'
 * '<S17>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST'
 * '<S18>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST1'
 * '<S19>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry STATIC TEST'
 * '<S20>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug_telemetry_minimal'
 * '<S21>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/latch1'
 * '<S22>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1'
 * '<S23>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/pwm & pi cmds'
 * '<S24>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/send gps to bs'
 * '<S25>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface'
 * '<S26>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ generatore di riferimenti/fcn'
 * '<S27>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/Attitude Filter ADIS'
 * '<S28>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS'
 * '<S29>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1'
 * '<S30>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/Attitude Filter ADIS/DCM_MARG_QUAT'
 * '<S31>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/Attitude Filter ADIS/DCM_MARG_QUAT/dcm_marg'
 * '<S32>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Acceleration Detrend '
 * '<S33>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Gyros Detrend'
 * '<S34>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Acceleration Detrend /Detrend'
 * '<S35>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Acceleration Detrend /Detrend1'
 * '<S36>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Acceleration Detrend /Detrend3'
 * '<S37>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Acceleration Detrend /Detrend/Subsystem'
 * '<S38>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Acceleration Detrend /Detrend1/Subsystem'
 * '<S39>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Acceleration Detrend /Detrend3/Subsystem'
 * '<S40>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Gyros Detrend/Detrend'
 * '<S41>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Gyros Detrend/Detrend1'
 * '<S42>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Gyros Detrend/Detrend2'
 * '<S43>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Gyros Detrend/Detrend/Subsystem'
 * '<S44>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Gyros Detrend/Detrend1/Subsystem'
 * '<S45>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS/Gyros Detrend/Detrend2/Subsystem'
 * '<S46>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend '
 * '<S47>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend 1'
 * '<S48>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Gyros Detrend'
 * '<S49>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend /Detrend'
 * '<S50>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend /Detrend1'
 * '<S51>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend /Detrend3'
 * '<S52>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend /Detrend/Subsystem'
 * '<S53>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend /Detrend1/Subsystem'
 * '<S54>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend /Detrend3/Subsystem'
 * '<S55>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend 1/Detrend'
 * '<S56>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend 1/Detrend1'
 * '<S57>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend 1/Detrend3'
 * '<S58>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend 1/Detrend/Subsystem'
 * '<S59>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend 1/Detrend1/Subsystem'
 * '<S60>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Acceleration Detrend 1/Detrend3/Subsystem'
 * '<S61>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Gyros Detrend/Detrend'
 * '<S62>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Gyros Detrend/Detrend1'
 * '<S63>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Gyros Detrend/Detrend2'
 * '<S64>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Gyros Detrend/Detrend/Subsystem'
 * '<S65>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Gyros Detrend/Detrend1/Subsystem'
 * '<S66>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/ADIS AHRS2/debias ADIS1/Gyros Detrend/Detrend2/Subsystem'
 * '<S67>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control /VectorNorm'
 * '<S68>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control /atan2'
 * '<S69>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control /steer_control'
 * '<S70>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control /throttle_control '
 * '<S71>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control /steer_control/Control Manager'
 * '<S72>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control /throttle_control /Control Manager'
 * '<S73>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Control /throttle_control /MATLAB Function'
 * '<S74>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GET PPS/clock latch'
 * '<S75>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GET PPS/step 2 pulse'
 * '<S76>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GET PPS/uint16 to vector'
 * '<S77>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS'
 * '<S78>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/VENUS GPS'
 * '<S79>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/compute 3d age'
 * '<S80>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/compute age'
 * '<S81>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA'
 * '<S82>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/MAP ublox fix type to standard status'
 * '<S83>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/Angle Conversion1'
 * '<S84>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/Subsystem2'
 * '<S85>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/Subsystem3'
 * '<S86>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem'
 * '<S87>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/e^1'
 * '<S88>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/e^2'
 * '<S89>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/e^3'
 * '<S90>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem/Subsystem2'
 * '<S91>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem/Subsystem3'
 * '<S92>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem/Subsystem4'
 * '<S93>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/compute 3d age/Compare To Constant'
 * '<S94>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/compute 3d age/clock latch'
 * '<S95>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/GPS receiver/compute age/clock latch'
 * '<S96>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Prescaler/find send time'
 * '<S97>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/Prescaler/latch'
 * '<S98>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/Attitude Filter SS'
 * '<S99>'  : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS'
 * '<S100>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/Attitude Filter SS/DCM_MARG_QUAT'
 * '<S101>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/Attitude Filter SS/DCM_MARG_QUAT/dcm_marg'
 * '<S102>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Acceleration Detrend '
 * '<S103>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Gyros Detrend'
 * '<S104>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Acceleration Detrend /Detrend'
 * '<S105>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Acceleration Detrend /Detrend1'
 * '<S106>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Acceleration Detrend /Detrend3'
 * '<S107>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Acceleration Detrend /Detrend/Subsystem'
 * '<S108>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Acceleration Detrend /Detrend1/Subsystem'
 * '<S109>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Acceleration Detrend /Detrend3/Subsystem'
 * '<S110>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Gyros Detrend/Detrend'
 * '<S111>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Gyros Detrend/Detrend1'
 * '<S112>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Gyros Detrend/Detrend2'
 * '<S113>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Gyros Detrend/Detrend/Subsystem'
 * '<S114>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Gyros Detrend/Detrend1/Subsystem'
 * '<S115>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/SS AHRS/debias SS/Gyros Detrend/Detrend2/Subsystem'
 * '<S116>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/blocco motori se non arrivano pacchetti/Enabled Subsystem'
 * '<S117>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/configurazione relativa seeker//target/engagement'
 * '<S118>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/configurazione relativa seeker//target/engagement 2'
 * '<S119>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/configurazione relativa seeker//target/pure PNG '
 * '<S120>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/configurazione relativa seeker//target/engagement/Fading filter del II ordine'
 * '<S121>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/ADC_filt'
 * '<S122>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/ADC_raw'
 * '<S123>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/Ages'
 * '<S124>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/GPS'
 * '<S125>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/GPS ECEF'
 * '<S126>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/MATLAB Function2'
 * '<S127>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/MODIFIED Raw IMU data MPU only  + RPY AHRS + ALTITUDE (H Hd 0) to be used for AHRS online tuning'
 * '<S128>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/Raw IMU data MPU + HMC + ADC'
 * '<S129>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/Raw IMU data MPU only + ADC'
 * '<S130>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/Raw IMU data packer'
 * '<S131>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/To be used for ADAPT NN online tuning'
 * '<S132>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/To be used for H PID online tuning'
 * '<S133>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/join enable flags'
 * '<S134>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/recupero di mpu9150 data'
 * '<S135>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/test solo RC_all_channel_usec + RSSI + ....'
 * '<S136>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST/GPS/detect if was 1 in the last 10 samples'
 * '<S137>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry FLIGHT TEST1/MODIFIED Raw IMU data MPU only  + RPY AHRS + ALTITUDE (H Hd 0) to be used for AHRS online tuning'
 * '<S138>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry STATIC TEST/Raw IMU data packer: MPU + MAG_HMC'
 * '<S139>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry STATIC TEST/Subsystem'
 * '<S140>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/debug telemtry STATIC TEST/join enable flags'
 * '<S141>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter'
 * '<S142>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter1'
 * '<S143>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter/IO Delay'
 * '<S144>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter/Input Delay'
 * '<S145>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter/Output Delay'
 * '<S146>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter1/IO Delay'
 * '<S147>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter1/Input Delay'
 * '<S148>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/power computations1/low pass filter1/Output Delay'
 * '<S149>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing'
 * '<S150>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager'
 * '<S151>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/Compensate for sensor mount _acc'
 * '<S152>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/Compensate for sensor mount _gyro'
 * '<S153>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/Compute Temperature (T) and Altitude (H)'
 * '<S154>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/MATLAB Function'
 * '<S155>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/MATLAB Function compute accxyz'
 * '<S156>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/MATLAB Function compute accxyz1'
 * '<S157>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/MATLAB Function compute gyroxyz'
 * '<S158>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/MATLAB Function compute magxyz'
 * '<S159>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/MATLAB Function compute magxyz2'
 * '<S160>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/compute_parameters'
 * '<S161>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/spi_data_processing'
 * '<S162>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/Compute Temperature (T) and Altitude (H)/MATLAB Function'
 * '<S163>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/Compute Temperature (T) and Altitude (H)/MATLAB Function1'
 * '<S164>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/compute_parameters/MATLAB Function1'
 * '<S165>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/Processing/spi_data_processing/MATLAB Function compute magxyz1'
 * '<S166>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/Arrange pwms'
 * '<S167>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX'
 * '<S168>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/I2C1 sensors loop'
 * '<S169>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/Subsystem1'
 * '<S170>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/Subsystem2'
 * '<S171>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/compose data from canbus'
 * '<S172>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus'
 * '<S173>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/Arrange pwms/clock latch'
 * '<S174>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1'
 * '<S175>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem2'
 * '<S176>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3'
 * '<S177>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz1'
 * '<S178>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz2'
 * '<S179>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz3'
 * '<S180>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz5'
 * '<S181>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem2/MATLAB Function compute gyroxyz1'
 * '<S182>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem2/MATLAB Function compute gyroxyz5'
 * '<S183>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz1'
 * '<S184>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz2'
 * '<S185>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz3'
 * '<S186>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz5'
 * '<S187>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/compose data from canbus/H'
 * '<S188>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/compose data from canbus/typecast uin32 to single'
 * '<S189>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/compose data from canbus/typecast uin32 to single1'
 * '<S190>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/compose data from canbus/H/typecast uin32 to single'
 * '<S191>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair'
 * '<S192>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem'
 * '<S193>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem1'
 * '<S194>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10'
 * '<S195>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem2'
 * '<S196>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem3'
 * '<S197>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem4'
 * '<S198>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem5'
 * '<S199>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem6'
 * '<S200>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7'
 * '<S201>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8'
 * '<S202>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter'
 * '<S203>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S204>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 * '<S205>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz1'
 * '<S206>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz2'
 * '<S207>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz3'
 * '<S208>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz4'
 * '<S209>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz5'
 * '<S210>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz1'
 * '<S211>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz2'
 * '<S212>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz3'
 * '<S213>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz4'
 * '<S214>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz5'
 * '<S215>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz1'
 * '<S216>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz2'
 * '<S217>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz3'
 * '<S218>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz4'
 * '<S219>' : 'ICARO3_Onda_bipe_controllonostro_mix_2201/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz5'
 */
#endif                                 /* RTW_HEADER_ICARO3_Onda_bipe_controllonostro_mix_2201_h_ */

/* File trailer for Real-Time Workshop generated code.
 *
 * [EOF] ICARO3_Onda_bipe_controllonostro_mix_2201.h
 */
