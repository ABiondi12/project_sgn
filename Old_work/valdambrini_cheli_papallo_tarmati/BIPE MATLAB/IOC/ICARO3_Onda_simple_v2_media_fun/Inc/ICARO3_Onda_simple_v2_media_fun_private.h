/*
 * File: ICARO3_Onda_simple_v2_media_fun_private.h
 *
...
#ifndef RTW_HEADER_ICARO3_Onda_simple_v2_media_fun_private_h_
#define RTW_HEADER_ICARO3_Onda_simple_v2_media_fun_private_h_
#include "rtwtypes.h"
#include "rtwtypes.h"
#include "rtwtypes.h"
#include "rtwtypes.h"
...
extern void ICARO3_Onda_simple_v2_media_fun_Subsystem_Init
  (rtDW_Subsystem_ICARO3_Onda_simple_v2_media_fun *localDW,
   rtP_Subsystem_ICARO3_Onda_simple_v2_media_fun *localP);
extern void ICARO3_Onda_simple_v2_media_fun_Subsystem_Start
  (rtDW_Subsystem_ICARO3_Onda_simple_v2_media_fun *localDW,
   rtP_Subsystem_ICARO3_Onda_simple_v2_media_fun *localP);
extern void ICARO3_Onda_simple_v2_media_fun_Subsystem(real32_T rtu_Enable,
  real_T rtu_In1, rtB_Subsystem_ICARO3_Onda_simple_v2_media_fun *localB,
  rtDW_Subsystem_ICARO3_Onda_simple_v2_media_fun *localDW,
  rtP_Subsystem_ICARO3_Onda_simple_v2_media_fun *localP);
extern void ICARO3_Onda_simple_v2_media_fun_clocklatch_Start
  (rtB_clocklatch_ICARO3_Onda_simple_v2_media_fun *localB,
   rtP_clocklatch_ICARO3_Onda_simple_v2_media_fun *localP);
extern void ICARO3_Onda_simple_v2_media_fun_clocklatch(real_T rtu_Enable, real_T
  rtu_In, rtB_clocklatch_ICARO3_Onda_simple_v2_media_fun *localB);
extern void ICARO3_Onda_simple_v2_media_fun_Compensateforsensormount_acc(const
  real32_T rtu_u[3],
  rtB_Compensateforsensormount_acc_ICARO3_Onda_simple_v2_media_fun *localB);
extern void ICARO3_Onda_simple_v2_media_fu_MATLABFunctioncomputegyroxyz1(const
  uint16_T rtu_u[2],
  rtB_MATLABFunctioncomputegyroxyz1_ICARO3_Onda_simple_v2_media_fu *localB);
extern void ICARO3_Onda_simple_v2_media__MATLABFunctioncomputegyroxyz1_k(const
  uint32_T rtu_u[4],
  rtB_MATLABFunctioncomputegyroxyz1_ICARO3_Onda_simple_v2_media__f *localB);
extern void ICARO3_Onda_simple_v2_media__MATLABFunctioncomputegyroxyz1_b
  (uint16_T rtu_u,
   rtB_MATLABFunctioncomputegyroxyz1_ICARO3_Onda_simple_v2_media__j *localB);
extern void ICARO3_Onda_simple_v2_media_fu_MATLABFunctioncomputegyroxyz4(const
  uint8_T rtu_u[2], const uint8_T rtu_u_j[2], const uint8_T rtu_u_g[2], const
  uint8_T rtu_u_b[2],
  rtB_MATLABFunctioncomputegyroxyz4_ICARO3_Onda_simple_v2_media_fu *localB);
extern void ICARO3_Onda_simple_v2_media_fun_step0(void);
extern void ICARO3_Onda_simple_v2_media_fun_step1(void);
extern void ICARO3_Onda_simple_v2_media_fun_step2(void);
extern void ICARO3_Onda_simple_v2_media_fun_step3(void);

#endif                                 /* RTW_HEADER_ICARO3_Onda_simple_v2_media_fun_private_h_ */

/* File trailer for Real-Time Workshop generated code.
 *
 * [EOF] ICARO3_Onda_simple_v2_media_fun_private.h
 */
