...
#define BasicPWM_TIMx_ARR          20000//2500 //AutoReloadRegister. This value must be minor or less than 65536 (2e16)
#define TIMx                       TIM8
...
void wrap_PWM_start_fcn(double ch1,double ch2,double ch3, double ch4)
{
...
void wrap_PWM_output_fcn(real_T* time,double ch1,double ch2,double ch3,double ch4)
{
