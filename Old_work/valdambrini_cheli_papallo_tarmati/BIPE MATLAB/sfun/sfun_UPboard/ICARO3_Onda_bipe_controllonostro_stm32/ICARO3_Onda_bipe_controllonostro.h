...
typedef struct {
  ...
  real32_T TmpSignalConversionAtSavedatatodataloggerthemicroSDcard2Inport1[25];
  ...
  rtB_clocklatch_ICARO3_Onda_bipe_controllonostro clocklatch_m;/* '<S81>/clock latch' */
...
struct Parameters_ICARO3_Onda_bipe_controllonostro_ {
  ...
  rtP_clocklatch_ICARO3_Onda_bipe_controllonostro clocklatch_m;/* '<S81>/clock latch' */
 ...
 * '<S69>'  : 'ICARO3_Onda_bipe_controllonostro/Control /atan2'
 * '<S70>'  : 'ICARO3_Onda_bipe_controllonostro/Control /steer_control'
 * '<S71>'  : 'ICARO3_Onda_bipe_controllonostro/Control /throttle_control '
 * '<S72>'  : 'ICARO3_Onda_bipe_controllonostro/Control /steer_control/Control Manager'
 * '<S73>'  : 'ICARO3_Onda_bipe_controllonostro/Control /throttle_control /Control Manager'
 * '<S74>'  : 'ICARO3_Onda_bipe_controllonostro/Control /throttle_control /MATLAB Function'
 * '<S75>'  : 'ICARO3_Onda_bipe_controllonostro/GET PPS/clock latch'
 * '<S76>'  : 'ICARO3_Onda_bipe_controllonostro/GET PPS/step 2 pulse'
 * '<S77>'  : 'ICARO3_Onda_bipe_controllonostro/GET PPS/uint16 to vector'
 * '<S78>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS'
 * '<S79>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/VENUS GPS'
 * '<S80>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/compute 3d age'
 * '<S81>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/compute age'
 * '<S82>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA'
 * '<S83>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/MAP ublox fix type to standard status'
 * '<S84>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/Angle Conversion1'
 * '<S85>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/Subsystem2'
 * '<S86>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/Subsystem3'
 * '<S87>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem'
 * '<S88>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/e^1'
 * '<S89>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/e^2'
 * '<S90>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/e^3'
 * '<S91>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem/Subsystem2'
 * '<S92>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem/Subsystem3'
 * '<S93>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/UBLOX LEA 6 GPS/ECEF Position to LLA/While Iterator Subsystem/Subsystem4'
 * '<S94>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/compute 3d age/Compare To Constant'
 * '<S95>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/compute 3d age/clock latch'
 * '<S96>'  : 'ICARO3_Onda_bipe_controllonostro/GPS receiver/compute age/clock latch'
 * '<S97>'  : 'ICARO3_Onda_bipe_controllonostro/Prescaler/find send time'
 * '<S98>'  : 'ICARO3_Onda_bipe_controllonostro/Prescaler/latch'
 * '<S99>'  : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/Attitude Filter SS'
 * '<S100>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS'
 * '<S101>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/Attitude Filter SS/DCM_MARG_QUAT'
 * '<S102>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/Attitude Filter SS/DCM_MARG_QUAT/dcm_marg'
 * '<S103>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Acceleration Detrend '
 * '<S104>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Gyros Detrend'
 * '<S105>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Acceleration Detrend /Detrend'
 * '<S106>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Acceleration Detrend /Detrend1'
 * '<S107>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Acceleration Detrend /Detrend3'
 * '<S108>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Acceleration Detrend /Detrend/Subsystem'
 * '<S109>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Acceleration Detrend /Detrend1/Subsystem'
 * '<S110>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Acceleration Detrend /Detrend3/Subsystem'
 * '<S111>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Gyros Detrend/Detrend'
 * '<S112>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Gyros Detrend/Detrend1'
 * '<S113>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Gyros Detrend/Detrend2'
 * '<S114>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Gyros Detrend/Detrend/Subsystem'
 * '<S115>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Gyros Detrend/Detrend1/Subsystem'
 * '<S116>' : 'ICARO3_Onda_bipe_controllonostro/SS AHRS/debias SS/Gyros Detrend/Detrend2/Subsystem'
 * '<S117>' : 'ICARO3_Onda_bipe_controllonostro/blocco motori se non arrivano pacchetti/Enabled Subsystem'
 * '<S118>' : 'ICARO3_Onda_bipe_controllonostro/configurazione relativa seeker//target/engagement'
 * '<S119>' : 'ICARO3_Onda_bipe_controllonostro/configurazione relativa seeker//target/engagement 2'
 * '<S120>' : 'ICARO3_Onda_bipe_controllonostro/configurazione relativa seeker//target/pure PNG '
 * '<S121>' : 'ICARO3_Onda_bipe_controllonostro/configurazione relativa seeker//target/engagement/Fading filter del II ordine'
 * '<S122>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/ADC_filt'
 * '<S123>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/ADC_raw'
 * '<S124>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/Ages'
 * '<S125>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/GPS'
 * '<S126>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/GPS ECEF'
 * '<S127>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/MATLAB Function2'
 * '<S128>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/MODIFIED Raw IMU data MPU only  + RPY AHRS + ALTITUDE (H Hd 0) to be used for AHRS online tuning'
 * '<S129>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/Raw IMU data MPU + HMC + ADC'
 * '<S130>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/Raw IMU data MPU only + ADC'
 * '<S131>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/Raw IMU data packer'
 * '<S132>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/To be used for ADAPT NN online tuning'
 * '<S133>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/To be used for H PID online tuning'
 * '<S134>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/join enable flags'
 * '<S135>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/recupero di mpu9150 data'
 * '<S136>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/test solo RC_all_channel_usec + RSSI + ....'
 * '<S137>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST/GPS/detect if was 1 in the last 10 samples'
 * '<S138>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry FLIGHT TEST1/MODIFIED Raw IMU data MPU only  + RPY AHRS + ALTITUDE (H Hd 0) to be used for AHRS online tuning'
 * '<S139>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry STATIC TEST/Raw IMU data packer: MPU + MAG_HMC'
 * '<S140>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry STATIC TEST/Subsystem'
 * '<S141>' : 'ICARO3_Onda_bipe_controllonostro/debug telemtry STATIC TEST/join enable flags'
 * '<S142>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter'
 * '<S143>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter1'
 * '<S144>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter/IO Delay'
 * '<S145>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter/Input Delay'
 * '<S146>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter/Output Delay'
 * '<S147>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter1/IO Delay'
 * '<S148>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter1/Input Delay'
 * '<S149>' : 'ICARO3_Onda_bipe_controllonostro/power computations1/low pass filter1/Output Delay'
 * '<S150>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing'
 * '<S151>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager'
 * '<S152>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/Compensate for sensor mount _acc'
 * '<S153>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/Compensate for sensor mount _gyro'
 * '<S154>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/Compute Temperature (T) and Altitude (H)'
 * '<S155>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/MATLAB Function'
 * '<S156>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/MATLAB Function compute accxyz'
 * '<S157>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/MATLAB Function compute accxyz1'
 * '<S158>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/MATLAB Function compute gyroxyz'
 * '<S159>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/MATLAB Function compute magxyz'
 * '<S160>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/MATLAB Function compute magxyz2'
 * '<S161>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/compute_parameters'
 * '<S162>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/spi_data_processing'
 * '<S163>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/Compute Temperature (T) and Altitude (H)/MATLAB Function'
 * '<S164>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/Compute Temperature (T) and Altitude (H)/MATLAB Function1'
 * '<S165>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/compute_parameters/MATLAB Function1'
 * '<S166>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/Processing/spi_data_processing/MATLAB Function compute magxyz1'
 * '<S167>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/Arrange pwms'
 * '<S168>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX'
 * '<S169>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/I2C1 sensors loop'
 * '<S170>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/Subsystem1'
 * '<S171>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/Subsystem2'
 * '<S172>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/compose data from canbus'
 * '<S173>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus'
 * '<S174>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/Arrange pwms/clock latch'
 * '<S175>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1'
 * '<S176>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem2'
 * '<S177>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3'
 * '<S178>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz1'
 * '<S179>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz2'
 * '<S180>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz3'
 * '<S181>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem1/MATLAB Function compute gyroxyz5'
 * '<S182>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem2/MATLAB Function compute gyroxyz1'
 * '<S183>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem2/MATLAB Function compute gyroxyz5'
 * '<S184>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz1'
 * '<S185>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz2'
 * '<S186>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz3'
 * '<S187>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/CANbus data RX/Subsystem3/MATLAB Function compute gyroxyz5'
 * '<S188>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/compose data from canbus/H'
 * '<S189>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/compose data from canbus/typecast uin32 to single'
 * '<S190>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/compose data from canbus/typecast uin32 to single1'
 * '<S191>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/compose data from canbus/H/typecast uin32 to single'
 * '<S192>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair'
 * '<S193>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem'
 * '<S194>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem1'
 * '<S195>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10'
 * '<S196>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem2'
 * '<S197>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem3'
 * '<S198>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem4'
 * '<S199>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem5'
 * '<S200>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem6'
 * '<S201>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7'
 * '<S202>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8'
 * '<S203>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter'
 * '<S204>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S205>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 * '<S206>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz1'
 * '<S207>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz2'
 * '<S208>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz3'
 * '<S209>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz4'
 * '<S210>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem10/MATLAB Function compute gyroxyz5'
 * '<S211>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz1'
 * '<S212>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz2'
 * '<S213>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz3'
 * '<S214>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz4'
 * '<S215>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem7/MATLAB Function compute gyroxyz5'
 * '<S216>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz1'
 * '<S217>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz2'
 * '<S218>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz3'
 * '<S219>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz4'
 * '<S220>' : 'ICARO3_Onda_bipe_controllonostro/sensor and actuators interface/interrupt manager/send motor commands via canbus/Subsystem8/MATLAB Function compute gyroxyz5'
 */
