# 
# File    : ICARO3_Onda_bipe_controllonostro.mk
#
# $ ICARO3_Onda_bipe_controllonostro.mk 2011-10-03 dlange $
#
#
# Abstract:
...
MODELLIB             = ICARO3_Onda_bipe_controllonostrolib.lib
MODELREF_LINK_LIBS   = 
MODELREF_LINK_RSPFILE     = ICARO3_Onda_bipe_controllonostro_ref.rsp
MODELREF_INC_PATH         =  
...
# Additional includes 
ADD_INCLUDES = \
	-IC:/Users/ivald/Desktop/LAVORI_BARBARA/FREERtos_Tools/ICARO_III_RTOS/sfun/sfun_UPboard/ICARO3_Onda_bipe_controllonostro_stm32 \
	-IC:/Users/ivald/Desktop/LAVORI_BARBARA/FREERtos_Tools/ICARO_III_RTOS/sfun/sfun_UPboard \
...
%.o: $(subst ",,C:/Users/ivald/Desktop/LAVORI_BARBARA/FREERtos_Tools/ICARO_III_RTOS/sfun/sfun_UPboard_downlink)/%.cpp
	@$(CC) $(CFLAGS) $< 
	@echo ### Successfully compiled source $<
...
%.o: $(subst ",,C:/Users/ivald/Desktop/LAVORI_BARBARA/FREERtos_Tools/ICARO_III_RTOS/sfun/sfun_UPboard_downlink)/%$(SRC_FILE_EXT)
	@echo ### Start compile EXPAND $(SRC_FILE_EXT) source $<
	@echo ### Successfully compiled source $<
...
%.o: $(subst ",,C:/Users/ivald/Desktop/LAVORI_BARBARA/FREERtos_Tools/ICARO_III_RTOS/sfun/sfun_UPboard_downlink)/%$(ASM_FILE_EXT)
	@echo ### Start compile EXPAND $(ASM_FILE_EXT) source $<
	@echo ### Successfully compiled source $<
