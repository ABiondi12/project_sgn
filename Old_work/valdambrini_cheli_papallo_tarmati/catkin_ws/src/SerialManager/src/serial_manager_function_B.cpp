...
//void manual_or_automatic_cb(const std_msgs::Float64::ConstPtr& msg)   //aggiunta callback per controllo automatico o manuale : 1->controllo automatico 2->controllo manuale
//{
     //controllo_manuale_automatico=double(msg->data);
//}  
