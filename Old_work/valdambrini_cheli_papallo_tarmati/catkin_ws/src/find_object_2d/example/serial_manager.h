...
double way_z ;
double orient_;
//double tag_mean0_x=0;
//double tag_mean0_y=0;
//double tag_mean0_z=0;
//double tag_mean1_x=0;
//double tag_mean1_y=0;
//double tag_mean1_z=0; 
double robot_pose_x=0;
double robot_pose_y=0;
double robot_pose_z=0; 
...
double startstop=0;
//double controllo_manuale_automatico=0; //aggiunto ottobre_2019 per controllo automatico o manuale 
int serial;
...
//void manual_or_automatic_cb(const std_msgs::Float64::ConstPtr& msg); //aggiunta per controllo manuale e automatico_ottobre_2019
//void Mean_forward(const geometry_msgs::Point::ConstPtr& msg);
//void Mean_back(const geometry_msgs::Point::ConstPtr& msg);
