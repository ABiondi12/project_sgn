...
filename = './dati/PosTag_automatico.txt';
...
hist(x_tag_2,50)
save_as('istogramma_x_aut','IMMAGINI')
figure('name','istogramma y ')
hist(y_tag_2,50)
save_as('istogramma_y_aut','IMMAGINI')
figure('name','istogramma z ')
hist(z_tag_2,50)
save_as('istogramma_z_aut','IMMAGINI')
...
%% ISTOGRAMMA DEL DT
figure('name','istogramma Dt automatico')
hist(dt_pulito,30)
save_as('istogramma_dt_aut','IMMAGINI')

%% SALVATAGGIO DATI
save ('PosTag_automatico.mat','x_tag','y_tag','z_tag','ancora0','ancora1',...
...
movefile('PosTag_automatico.mat', './dati/')
