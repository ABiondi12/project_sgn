...
if __name__ == "__main__":
    ...
    anchor_ids = [0x6939, 0x6e7a, 0x6e44, 0x6e6c]
    anchors = [DeviceCoordinates(anchor_ids[0], 1, Coordinates(0, 0, 0)),
               DeviceCoordinates(anchor_ids[1], 1, Coordinates(0,5514 , 0)),
               DeviceCoordinates(anchor_ids[2], 1, Coordinates(3900, 4544, 0)),
               DeviceCoordinates(anchor_ids[3], 1, Coordinates(1957, 3138, 1113))]
