...
if __name__ == "__main__":
	...
	anchor_ids = [0x6e44, 0x6939, 0x6e7a, 0x6e6c]
	anchors = [DeviceCoordinates(anchor_ids[0], 1, Coordinates(0, 0, 0)),
		       DeviceCoordinates(anchor_ids[1], 1, Coordinates(0,3672 , 0)),
		       DeviceCoordinates(anchor_ids[2], 1, Coordinates(1546, 1218, 0)),
		       DeviceCoordinates(anchor_ids[3], 1, Coordinates(455, 1993, 2144-1658))]
	...
	#Acquisizioni
	N = 500  #Number of acquisitions
	dist = 35e3 #Distanza in millimetri della prova
