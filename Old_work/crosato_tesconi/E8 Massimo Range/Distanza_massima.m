...
%**************************************************************************
% Questo script importa il file.txt relativo a un test di positioning del tag
% effettuato facendo variare la distanza di questo dal centro della configurazione
% tetraedrica delle ancore.
% Vengono calcolati gli indici statistici e realizzati gli istogrammi
% relativi alle coordinate del tag.
%**************************************************************************

%% CARICAMENTO E SALVATAGGIO DATI

filename = './Dati/PosTag_6.txt';
file = fopen(filename);
...
hist(x_tag_clear,30)
save_as('istogramma_x_30m','Immagini')
...
hist(y_tag_clear,30)
save_as('istogramma_y_30m','Immagini')
...
hist(z_tag_clear,30)
save_as('istogramma_z_30m','Immagini')
